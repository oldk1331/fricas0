...
(SDEFUN |PREASSOC;makeMonic|
        ...
        (SPROG
         ((#1=#:G469 NIL) (|u| (|Union| R "failed")) (#2=#:G470 NIL)
          (#3=#:G461 NIL) (|i| NIL) (|a| (|PrimitiveArray| R))
                ...
                (SEQ (LETT |i| 0)
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #4=#:G468)))
                        ('T
                         (QSETAREF1 |a| |i|
...
(DEFUN |PrecomputedAssociatedEquations| (&REST #1=#:G494)
  (SPROG NIL
         (PROG (#2=#:G495)
           (RETURN
            (COND
