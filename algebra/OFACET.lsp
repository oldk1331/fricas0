...
(SDEFUN |OFACET;orientedFacet;IL%;1|
        ...
        (SPROG
         ((|mul2| (|Integer|)) (|diff| (|NonNegativeInteger|)) (#1=#:G484 NIL)
          (|x| NIL) (#2=#:G485 NIL) (|y| NIL)
...
(SDEFUN |OFACET;orientedFacetUnsigned;L%;2|
        ((|fac1| (|List| (|Integer|))) (% (%)))
        (SPROG
         ((|lst| (|List| (|NonNegativeInteger|))) (#1=#:G487 NIL)
          (#2=#:G492 NIL) (|x| NIL) (#3=#:G491 NIL))
         (SEQ
          (LETT |lst|
                (PROGN
                 (LETT #3# NIL)
...
(SDEFUN |OFACET;orientedFacetSigned;L%;3|
        ...
        (SPROG
         ((|sig| (|Integer|)) (|lst| (|List| (|NonNegativeInteger|)))
          (#1=#:G494 NIL) (#2=#:G502 NIL) (|x| NIL) (#3=#:G501 NIL))
         (SEQ
          (LETT |lst|
                (PROGN
                 (LETT #3# NIL)
...
(SDEFUN |OFACET;orientedFacetIfCan;LU;5|
        ...
        (SPROG
         ((#1=#:G525 NIL) (|mm| (|Integer|)) (#2=#:G529 NIL) (|e| NIL)
          (#3=#:G528 NIL) (|expected| (|List| %)) (|res| (%))
          (|indexes| (|List| (|NonNegativeInteger|))) (#4=#:G527 NIL) (|i| NIL)
          (|indexLst| (|List| (|List| (|NonNegativeInteger|)))) (#5=#:G526 NIL)
          (|subFacet| NIL) (|b| (|List| %)))
         (SEQ
          (EXIT
           (SEQ (LETT |indexLst| NIL)
                (COND
                 ((< (SPADCALL |boundary| (QREFELT % 22)) 1)
                  (PROGN (LETT #1# (CONS 1 "failed")) (GO #6=#:G524))))
...
(SDEFUN |OFACET;minIndex;%Nni;8| ((|orf| (%)) (% (|NonNegativeInteger|)))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G537 NIL) (|i| NIL)
...
(SDEFUN |OFACET;maxIndex;%Nni;9| ((|orf| (%)) (% (|NonNegativeInteger|)))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G542 NIL) (|i| NIL)
          (|inds| (|List| (|NonNegativeInteger|))))
         (SEQ (LETT |m| 0) (LETT |inds| (SPADCALL |orf| (QREFELT % 24)))
              (SEQ (LETT |i| NIL) (LETT #1# |inds|) G190
                   (COND
...
(SDEFUN |OFACET;allSubsets;%NniL;16|
        ...
        (SPROG
         ((|res| (|List| %)) (|sub| (|List| %)) (|r1| (%))
          (|r| (|List| (|NonNegativeInteger|))) (#1=#:G582 NIL) (|x| NIL)
          (#2=#:G581 NIL) (|facet| (|List| (|NonNegativeInteger|))))
         (SEQ
          (EXIT
           (SEQ (LETT |facet| (QCDR |orf|)) (LETT |res| NIL)
                (COND
                 ((<= (SPADCALL |orf| (QREFELT % 35)) |minDim|)
                  (PROGN (LETT #2# |res|) (GO #3=#:G580))))
...
(SDEFUN |OFACET;allSubsets;%2NniL;17|
        ...
        (SPROG
         ((|res2| (|List| %)) (#1=#:G589 NIL) (|y| NIL) (|res| (|List| %)))
...
(SDEFUN |OFACET;isSubsetOf?;2%B;18| ((|sa| (%)) (|sb| (%)) (% (|Boolean|)))
        (SPROG
         ((#1=#:G594 NIL) (#2=#:G595 NIL) (|vertex| NIL) (|all| (|List| %)))
         (SEQ
          (EXIT
...
(SDEFUN |OFACET;reindex;2%;21| ((|sa| (%)) (% (%)))
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (|ptr| (|Integer|))
          (#1=#:G609 NIL) (|v| NIL) (|i| (|NonNegativeInteger|))
          (|newval| (|List| (|NonNegativeInteger|)))
          (|oldval| (|List| (|NonNegativeInteger|))) (#2=#:G608 NIL)
          (|facet| (|List| (|NonNegativeInteger|))))
...
(SDEFUN |OFACET;boolWordPermute;L2NniL;23|
        ...
        (SPROG
         ((|res| (|List| (|List| (|Boolean|))))
          ...
          (|subWord| (|List| (|Boolean|))) (#1=#:G628 NIL) (|x| NIL)
          (|z| (|NonNegativeInteger|)) (#2=#:G612 NIL)
          (|word0| (|List| (|List| (|Boolean|)))) (#3=#:G627 NIL)
          (#4=#:G626 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((< |numZeros| 1)
              (COND
               ((< |numOnes| 1) (PROGN (LETT #4# |wordIn|) (GO #5=#:G625))))))
            (LETT |res| NIL)
            (COND
             ((> |numZeros| 0)
              (SEQ
...
(SDEFUN |OFACET;product;2%L;24|
        ...
        (SPROG
         ((|res| (|List| (|ProductFacet|))) (|pf| (|ProductFacet|))
          ...
          (#3=#:G645 NIL) (#4=#:G644 NIL) (|perm| NIL)
          (|perms| (|List| (|List| (|Boolean|))))
          (|lenB| (|NonNegativeInteger|)) (#5=#:G630 NIL)
...
(SDEFUN |OFACET;position;%LI;25| ((|e| (%)) (|lst| (|List| %)) (% (|Integer|)))
        (SPROG ((#1=#:G655 NIL) (|res| (|Integer|)) (#2=#:G656 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |res| 1)
...
(SDEFUN |OFACET;refactorIndexes;%Nni%;27|
        ...
        (SPROG
         ((|newval| (|List| (|NonNegativeInteger|))) (#1=#:G663 NIL) (|v| NIL)
          (|facet| (|List| (|NonNegativeInteger|))))
...
(SDEFUN |OFACET;ltLocal|
        ...
        (SPROG ((#1=#:G673 NIL) (|b1| #2=(|NonNegativeInteger|)) (|a1| #2#))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((SPADCALL |a| |b| (QREFELT % 77))
                    (PROGN (LETT #1# NIL) (GO #3=#:G672))))
                  (COND
...
(SDEFUN |OFACET;<=;2%B;31| ((|ain| (%)) (|bin| (%)) (% (|Boolean|)))
        (SPROG
         ((#1=#:G678 NIL) (|b| #2=(|List| (|NonNegativeInteger|))) (|a| #2#))
         (SEQ
          (EXIT
           (SEQ (LETT |a| (QCDR |ain|)) (LETT |b| (QCDR |bin|))
                (COND
                 ((SPADCALL |a| |b| (QREFELT % 77))
                  (PROGN (LETT #1# 'T) (GO #3=#:G677))))
                (EXIT (|OFACET;ltLocal| |a| |b| %))))
          #3# (EXIT #1#)))) 
...
(SDEFUN |OFACET;coerce;%Of;33| ((|s| (%)) (% (|OutputForm|)))
        (SPROG
         ((|body| (|OutputForm|)) (|elements| (|List| (|OutputForm|)))
          (#1=#:G692 NIL) (|x| NIL) (#2=#:G691 NIL) (|prefix| (|OutputForm|))
          (|m| (|Integer|)))
