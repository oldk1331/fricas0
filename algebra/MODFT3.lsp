                         ...
                         (COND
                          ((NULL
                            (SPADCALL (QAREF1 |pol| |i|) (|spadConstant| % 14)
                                      (QREFELT % 16)))
                           (PROGN
                            (LETT #1# (PROGN (LETT #2# |i|) (GO #3=#:G478)))
                            (GO #4=#:G476))))))
...
(SDEFUN |MODFT3;sub_poly;2PaRPa;9|
        ((|pol1| #1=(|PrimitiveArray| K)) (|pol2| #1#)
         ...
         (% #1#))
        (SPROG
         ((#2=#:G490 NIL) (|i| NIL) (|res| (|PrimitiveArray| K))
...
(SDEFUN |MODFT3;trim_pol|
        ...
        (SPROG
         ((#1=#:G496 NIL) (|i| NIL) (|res| (|PrimitiveArray| K))
...
(SDEFUN |MODFT3;copy_poly;PaIRPa;14|
        ((|pol| (|PrimitiveArray| K)) (|n| (|Integer|))
         ...
         (% (|PrimitiveArray| K)))
        (SPROG
         ((#1=#:G515 NIL) (|i| NIL) (|res| (|PrimitiveArray| K))
          (|n0| (|Integer|)))
...
(SDEFUN |MODFT3;random_poly;IRPa;15|
        ((|n| (|Integer|))
         (|p| (|Record| (|:| |i_mod| (|Integer|)) (|:| |deg| (|Integer|))))
         (% (|PrimitiveArray| K)))
        (SPROG ((#1=#:G521 NIL) (|i| NIL) (|res| (|PrimitiveArray| K)))
...
(SDEFUN |MODFT3;vector_combination|
        ...
        (SPROG
         ((#1=#:G537 NIL) (|i| NIL) (#2=#:G536 NIL) (#3=#:G535 NIL)
          (#4=#:G534 NIL) (|ds| #5=(|SingleInteger|)) (|ns| #5#))
...
(SDEFUN |MODFT3;divide!;2PaRPa;18|
        ((|r0| #1=(|PrimitiveArray| K)) (|r1| #1#)
         ...
         (% (|PrimitiveArray| K)))
        (SPROG
         ((#2=#:G557 NIL) (|dr0| #3=(|SingleInteger|)) (#4=#:G558 NIL)
          (|c1| (K)) (|delta| (|SingleInteger|)) (|c0| (K)) (#5=#:G559 NIL)
...
(SDEFUN |MODFT3;red_pol!;PaRPa;20|
        ((|pol| (|PrimitiveArray| K))
         ...
         (% (|PrimitiveArray| K)))
        (SPROG
         ((|k| (|Integer|)) (|i| NIL) (|c| (K)) (#1=#:G606 NIL) (|j| NIL)
          (#2=#:G605 NIL) (#3=#:G604 NIL) (|m| (|Integer|))
...
(SDEFUN |MODFT3;mul_and_red|
        ((|pol1| (|PrimitiveArray| K)) (|pol2| (|PrimitiveArray| K))
         ...
         (% (|PrimitiveArray| K)))
        (SPROG
         ((#1=#:G619 NIL) (|j| NIL) (|c| (K)) (#2=#:G618 NIL) (|i| NIL)
          (#3=#:G617 NIL) (|n0| (|NonNegativeInteger|)))
...
(SDEFUN |MODFT3;mod_exp;PaIRPa;22|
        ((|pol| (|PrimitiveArray| K)) (|n| (|Integer|))
         ...
         (% (|PrimitiveArray| K)))
        (SPROG
         ((|pow| (|PrimitiveArray| K)) (#1=#:G628 NIL) (|has_res| (|Boolean|))
                ...
                (SEQ G190 (COND ((NULL (> |n| 0)) (GO G191)))
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((EQL |n| 0)
                         (PROGN (LETT #1# |$NoValue|) (GO #2=#:G625)))
                        ('T
                         (LETT |pow|
...
(SDEFUN |MODFT3;power_matrix;PaNniRR;23|
        ...
        (SPROG
         ((|pow| (|PrimitiveArray| K)) (#1=#:G641 NIL) (|k| NIL)
          (#2=#:G640 NIL) (|j| NIL) (|n1| (|SingleInteger|)) (|l1| (|Integer|))
          (|work| (|PrimitiveArray| K))
...
(SDEFUN |MODFT3;shift_mat!;Ptda2IV;25|
        ((|m| (|PrimitiveTwoDimensionalArray| K)) (|sa| #1=(|Integer|))
         (|nr| #1#) (% (|Void|)))
        (SPROG
         ((#2=#:G657 NIL) (|j| NIL) (#3=#:G656 NIL) (|i| NIL)
          (|nc| (|Integer|)))
         (SEQ (LETT |nc| (MIN (ANCOLS |m|) |nr|))
              (EXIT
...
(SDEFUN |MODFT3;trim_mat!;Ptda2IRV;26|
        ((|m| (|PrimitiveTwoDimensionalArray| K)) (|nr0| #1=(|Integer|))
         ...
         (% (|Void|)))
        (SPROG
         ((#2=#:G671 NIL) (|i| NIL) (|tmp1| (|PrimitiveArray| K))
          (#3=#:G670 NIL) (#4=#:G669 NIL) (|j| NIL)
...
(SDEFUN |MODFT3;split_mat!;Ptda3I2RV;27|
        ((|m| (|PrimitiveTwoDimensionalArray| K)) (|nr0| #1=(|Integer|))
         ...
         (|rdata2| #2#) (% (|Void|)))
        (SPROG
         ((#3=#:G690 NIL) (|i| NIL) (|rtmp| (|PrimitiveArray| K))
          (#4=#:G689 NIL) (#5=#:G688 NIL) (#6=#:G687 NIL) (|j| NIL)
...
(SDEFUN |MODFT3;mmul|
        ((|m1| (|PrimitiveTwoDimensionalArray| K))
         ...
         (% (|PrimitiveTwoDimensionalArray| K)))
        (SPROG
         ((|ss| (K)) (#1=#:G704 NIL) (|k| NIL) (#2=#:G703 NIL) (|j| NIL)
          (#3=#:G702 NIL) (|i| NIL) (|res| (|PrimitiveTwoDimensionalArray| K))
...
(SDEFUN |MODFT3;modular_compose;PaPtdaPaNniRPa;29|
        ((|pol| #1=(|PrimitiveArray| K))
         ...
         (% (|PrimitiveArray| K)))
        (SPROG
         ((#2=#:G725 NIL) (|i| (|SingleInteger|))
          (|res| #3=(|PrimitiveArray| K)) (#4=#:G724 NIL) (|k| NIL)
          (|ns1| (|SingleInteger|)) (|work| #3#) (|p1| #3#)
          (|m2| (|PrimitiveTwoDimensionalArray| K)) (#5=#:G723 NIL)
          (#6=#:G722 NIL) (|j| NIL) (|k1| #7=(|SingleInteger|)) (|l1s| #7#)
          (|m1| (|PrimitiveTwoDimensionalArray| K))
...
(DEFUN |ModularFactorizationTools3| (#1=#:G738)
  (SPROG NIL
         (PROG (#2=#:G739)
           (RETURN
            (COND
