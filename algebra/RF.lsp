...
(SDEFUN |RF;eval;FLF;9|
        ((|x| (|Fraction| (|Polynomial| R)))
         ...
         (% (|Fraction| (|Polynomial| R))))
        (SPROG
         ((#1=#:G31 NIL) (|eq| NIL) (#2=#:G30 NIL) (#3=#:G29 NIL)
          (#4=#:G28 NIL))
         (SEQ
          (SPADCALL |x|
                    (PROGN
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 44
                                            '(1 7 0 6 8 1 9 0 7 10 1 13 12 9 14
                                              ...
                                              19 20 24 1 0 16 9 18 2 0 9 9 28
                                              29 2 0 9 9 30 31 3 0 9 9 20 9 27
                                              3 0 9 9 12 25 26 1 0 9 6 11)))))
           '|lookupComplete|)) 
