...
(SDEFUN |RSETCAT-;purelyAlgebraic?;SB;5| ((|ts| (S)) (% (|Boolean|)))
        (SPROG
         ((#1=#:G94 NIL) (|i| (|NonNegativeInteger|)) (#2=#:G83 NIL) (|v| (V))
          (#3=#:G95 NIL) (|p| NIL) (|lp| (|List| P)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |RSETCAT-;intersect;L2L;13|
        ...
        (SPROG
         ((|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| S))))
          (#1=#:G177 NIL) (|us| NIL) (#2=#:G176 NIL) (|lus| (|List| S))
          (|p| (P)) (|toSave| (|List| S)) (|ts| (S))
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| S)))
          (#3=#:G175 NIL) (#4=#:G174 NIL) (#5=#:G173 NIL) (#6=#:G172 NIL))
         (SEQ
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 77
                                            '(1 10 11 0 12 1 10 9 0 13 2 6 11 9
                                              ...
                                              23 2 0 11 10 0 16 1 0 11 0 44 2 0
                                              49 31 49 74 2 0 49 31 0 76 2 0 49
                                              10 49 77 2 0 49 10 49 59 2 0 49
                                              31 49 63 2 0 49 31 0 61 2 0 49 10
                                              49 53 2 0 49 31 49 57 2 0 49 31 0
                                              55 2 0 11 10 0 26)))))
           '|lookupComplete|)) 
