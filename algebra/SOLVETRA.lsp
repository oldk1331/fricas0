...
(SDEFUN |SOLVETRA;solve;ESL;5|
        ((|lside| (|Expression| R)) (|x| (|Symbol|))
         (% (|List| (|Equation| (|Expression| R)))))
        (SPROG ((#1=#:G558 NIL) (|sol| NIL) (#2=#:G557 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |sol| NIL)
...
(SDEFUN |SOLVETRA;solveInner|
        ((|lside| (|Expression| R)) (|x| (|Symbol|))
         (% (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((#1=#:G592 NIL) (|sols| (|List| (|Equation| (|Expression| R))))
          (#2=#:G599 NIL) (|frec| NIL)
          (|lfacts|
           (|List|
            (|Record|
          ...
          (|newlist| (|List| (|Equation| (|Expression| R)))) (#8=#:G598 NIL)
          (|j| NIL) (|secondsol| #9=(|List| (|Expression| R))) (#10=#:G576 NIL)
          (#11=#:G575 #9#) (#12=#:G577 #9#) (#13=#:G597 NIL) (|ff| NIL)
          (|lfatt|
           (|List|
          ...
          (|elR| (|Expression| R)) (#14=#:G596 NIL) (|i| NIL) (#15=#:G570 NIL)
          (#16=#:G569 #17=(|List| (|Equation| (|Expression| R))))
          (#18=#:G571 #17#) (#19=#:G595 NIL) (|ri| NIL)
          (|bigX_back| (|Expression| R)) (#20=#:G565 NIL)
          (|r1| (|List| (|Expression| R)))
          (|finv| (|Union| (|Expression| R) #21="failed")) (#22=#:G594 NIL)
          (|lr| #9#) (#23=#:G561 NIL) (#24=#:G560 #9#) (#25=#:G562 #9#)
          (#26=#:G593 NIL) (|fatt| NIL) (|eq1| (|Expression| R))
...
(SDEFUN |SOLVETRA;solveRetract|
        ...
        (SPROG
         ((|nlexpr| (|List| (|Fraction| (|Polynomial| R)))) (#1=#:G623 NIL)
...
(SDEFUN |SOLVETRA;subsTan|
        ...
        (SPROG
         ((#1=#:G643 NIL) (|resultnew| #2=(|Expression| R))
           ...
           (SEQ (LETT Z (SPADCALL (QREFELT % 31)))
                ...
                (COND
                 ((EQL (LENGTH |listofkern|) 1)
                  (COND
                   ((NULL |test|)
                    (PROGN (LETT #1# |exprvar|) (GO #5=#:G642)))))
...
(SDEFUN |SOLVETRA;logsumtolog| ((|var| (|Expression| R)) (% (|Expression| R)))
        (SPROG
         ((|var2| (|Expression| R)) (#1=#:G682 NIL) (|i| NIL)
          (|kernelofvar| (|List| (|Kernel| (|Expression| R))))
          (|newexpr| (|Expression| R)) (|exprlist| (|List| (|Expression| R)))
          (#2=#:G681 NIL) (|gcdcoeff| (|Expression| R))
          (|listforgcd| (|List| R)) (|exprcoeff| (R)) (#3=#:G680 NIL)
...
(SDEFUN |SOLVETRA;buildnexpr|
        ...
        (SPROG
         ((|ansmant| (|Expression| R)) (|anscoeff| (|Expression| R))
          (#1=#:G707 NIL) (|i| NIL) (|n2list| (|List| (|Expression| R)))
...
(SDEFUN |SOLVETRA;combineLog|
        ...
        (SPROG
         ((|ansexpr| #1=(|Expression| R)) (#2=#:G727 NIL) (|i| NIL) (|ans| #1#)
...
(SDEFUN |SOLVETRA;tableXkernels|
        ((|evar| (|Expression| R)) (Z (|Symbol|))
         (% (|List| (|Expression| R))))
        (SPROG
         ((|listkOfvar| (|List| (|Expression| R))) (#1=#:G741 NIL) (|i| NIL)
...
(SDEFUN |SOLVETRA;dropfun| ((|x| (|Expression| R)) (% (|Expression| R)))
        (SPROG
         ((#1=#:G769 NIL) (|k| (|Union| (|Kernel| (|Expression| R)) "failed")))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |SOLVETRA;makeREpol|
        ...
        (SPROG
         ((|lval| (|List| (|Expression| R))) (#1=#:G833 NIL) (|v| NIL)
          (#2=#:G832 NIL) (|lvar| (|List| (|Symbol|))))
...
(SDEFUN |SOLVETRA;solve1Pol|
        ...
        (SPROG
         ((#1=#:G840 NIL) (|vsol| NIL) (#2=#:G839 NIL)
...
(SDEFUN |SOLVETRA;solve1Sys|
        ...
        (SPROG
         ((|sols| (|List| (|List| (|Equation| (|Expression| R)))))
          (#1=#:G843 NIL)
          (#2=#:G842 #3=(|List| (|List| (|Equation| (|Expression| R)))))
          (#4=#:G844 #3#) (#5=#:G850 NIL) (|sol| NIL) (#6=#:G848 NIL) (|p| NIL)
          (#7=#:G849 NIL) (|v| NIL) (|rlvar| (|List| (|Symbol|)))
...
(SDEFUN |SOLVETRA;tryLinear|
        ((|lexpr| (|List| (|Expression| R))) (|lvar| (|List| (|Symbol|)))
         (%
          (|Union| (|List| (|List| (|Equation| (|Expression| R)))) "failed")))
        (SPROG
         ((|eqs| (|List| (|Equation| (|Expression| R)))) (#1=#:G926 NIL)
          (|i| NIL) (#2=#:G925 NIL) (|sym| (|Expression| R)) (#3=#:G924 NIL)
          (|p| NIL) (|zeron| (|Vector| (|Expression| R)))
          (|rhs| (|Vector| (|Expression| R))) (#4=#:G893 NIL)
          (|sol|
           (|Record|
            (|:| |particular|
                 (|Union| (|Vector| (|Expression| R)) #5="failed"))
            (|:| |basis| (|List| (|Vector| (|Expression| R))))))
          (|vece| (|Vector| (|Expression| R))) (#6=#:G923 NIL) (|q| NIL)
          (#7=#:G922 NIL) (|mate| (|Matrix| (|Expression| R))) (#8=#:G921 NIL)
          (#9=#:G920 NIL) (#10=#:G919 NIL) (|row| NIL) (#11=#:G918 NIL)
          (|r|
           (|Record|
            (|:| |mat|
                 (|Matrix|
          ...
          (|ps|
           (|List|
            (|SparseMultivariatePolynomial| R (|Kernel| (|Expression| R)))))
          (#12=#:G917 NIL) (|expr| NIL) (#13=#:G916 NIL) (#14=#:G908 NIL)
          (#15=#:G907 NIL) (#16=#:G915 NIL) (|ker| NIL)
          (|kers| (|List| (|Kernel| (|Expression| R))))
          (|llk| (|List| (|List| (|Kernel| (|Expression| R)))))
          (#17=#:G914 NIL) (#18=#:G913 NIL) (#19=#:G858 NIL)
          (#20=#:G857 #21=(|Boolean|)) (#22=#:G859 #21#) (#23=#:G912 NIL)
          (#24=#:G855 NIL) (#25=#:G854 #26=(|Boolean|)) (#27=#:G856 #26#)
          (#28=#:G911 NIL) (|lvk| (|List| (|Kernel| (|Expression| R))))
          (#29=#:G910 NIL) (|v| NIL) (#30=#:G909 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |lvk|
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR (SPADCALL |ker| (QREFELT % 226)) 0)
                         (PROGN (LETT #15# |$NoValue|) (GO #32=#:G875)))
                        ((NULL
                          (NULL
                           (SPADCALL |lvar|
...
(SDEFUN |SOLVETRA;solve;LLL;37|
        ((|leqs| (|List| (|Equation| (|Expression| R))))
         ...
         (% (|List| (|List| (|Equation| (|Expression| R))))))
        (SPROG
         ((|lexpr| (|List| (|Expression| R))) (#1=#:G946 NIL) (|eq| NIL)
          (#2=#:G945 NIL))
         (SEQ
          (LETT |lexpr|
                (PROGN
...
(SDEFUN |SOLVETRA;solve;LLL;38|
        ((|leqs| (|List| (|Equation| (|Expression| R))))
         ...
         (% (|List| (|List| (|Equation| (|Expression| R))))))
        (SPROG
         ((#1=#:G981 NIL) (|neq| NIL) (#2=#:G980 NIL) (#3=#:G979 NIL)
          (|sol| NIL) (#4=#:G978 NIL) (|lval2| (|List| (|Expression| R)))
          (#5=#:G977 NIL) (|k| NIL) (#6=#:G976 NIL)
          (|lker2| (|List| (|Kernel| (|Expression| R)))) (#7=#:G975 NIL)
          (|v| NIL) (#8=#:G974 NIL)
          (|ans| (|List| (|List| (|Equation| (|Expression| R)))))
          (|nlexpr| (|List| (|Expression| R))) (#9=#:G973 NIL) (|expr| NIL)
          (#10=#:G972 NIL) (|lval| (|List| (|Expression| R))) (#11=#:G971 NIL)
          (#12=#:G970 NIL) (|lvar| (|List| (|Symbol|))) (#13=#:G969 NIL)
          (#14=#:G968 NIL) (|lexpr| (|List| (|Expression| R))) (#15=#:G967 NIL)
          (|eq| NIL) (#16=#:G966 NIL))
         (SEQ
          (LETT |lexpr|
                (PROGN
...
(SDEFUN |SOLVETRA;solve;LLL;40|
        ((|leqs| (|List| (|Equation| (|Expression| R))))
         ...
         (% (|List| (|List| (|Equation| (|Expression| R))))))
        (SPROG
         ((|lker| (|List| (|Kernel| (|Expression| R)))) (#1=#:G992 NIL)
          (|e| NIL) (#2=#:G991 NIL))
         (SEQ
          (LETT |lker|
                (PROGN
...
(DEFUN |TransSolvePackage| (#1=#:G993)
  (SPROG NIL
         (PROG (#2=#:G994)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 266
                                            '(1 8 7 0 9 1 8 10 0 11 0 6 0 12 1
                                              ...
                                              91 50 262 2 17 0 263 0 264 1 0 13
                                              8 16 2 0 13 17 14 22 1 0 13 17 21
                                              2 0 82 13 10 261 2 0 13 8 14 15 2
                                              0 82 13 53 266 2 0 82 13 215
                                              265)))))
           '|lookupComplete|)) 
