...
(SDEFUN |ODEINT;mkprod|
        ((|l|
         ...
         (% (F)))
        (SPROG
         ((#1=#:G468 NIL) (#2=#:G467 (F)) (#3=#:G469 (F)) (#4=#:G474 NIL)
          (|r| NIL)
          (|ll|
           (|List|
            (|Record| (|:| |coef| (|Fraction| (|Integer|))) (|:| |logand| F))))
...
(SDEFUN |ODEINT;isQ|
        ...
        (SPROG
         ((|prod| (|Fraction| (|Integer|))) (#1=#:G501 NIL)
          (|u| (|Union| (|Fraction| (|Integer|)) "failed")) (#2=#:G502 NIL)
          (|x| NIL))
         (SEQ
          (EXIT
...
(DEFUN |ODEIntegration| (&REST #1=#:G525)
  (SPROG NIL
         (PROG (#2=#:G526)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 62
                                            '(2 7 0 0 8 9 2 13 12 7 8 14 0 7 0
                                              ...
                                              18 0 48 1 7 49 0 50 2 18 0 18 0
