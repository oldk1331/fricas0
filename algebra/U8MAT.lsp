...
(DEFUN |U8Matrix;| ()
  (SPROG
   ((|dv$| NIL) (% NIL) (#1=#:G2473 NIL) (#2=#:G2474 NIL) (#3=#:G2472 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|U8Matrix|))
    (LETT % (GETREFV 46))
...
(MAKEPROP '|U8Matrix| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|Integer|) |U8MAT;minRowIndex;%I;1|
              ...
              (|Boolean|) (|OutputForm|) (|List| 30) (|Union| % '"failed")
              (|SingleInteger|) (|HashState|) (|U8Vector|) (|List| %)
              (|String|) (|Mapping| 24 6 6) (|Mapping| 24 6) (|Void|)
              (|List| 43) (|Union| 6 '"one") (|Mapping| 6 6 6) (|List| 21)
              (|Mapping| 6 6) (|List| 31) (|PositiveInteger|) (|List| 9)
              (|List| 45) (|Segment| 6))
