...
(SDEFUN |RECOP;getShiftRec|
        ...
        (SPROG
         ((#1=#:G508 NIL) (|num| (|SparseUnivariatePolynomial| F))
           ...
           (SEQ (LETT |a| (SPADCALL |f| (QREFELT % 20)))
                (COND
                 ((SPADCALL (CONS #'|RECOP;getShiftRec!0| (VECTOR % |n|)) |a|
                            (QREFELT % 25))
                  (PROGN (LETT #1# (CONS 0 0)) (GO #2=#:G507))))
                (COND
        ...
        ((|op| (|BasicOperator|)) (|argsym| (|Symbol|)) (|eq| (F))
         (%
          (|Union|
           ...
           "failed")))
        (SPROG
         ((#1=#:G521 NIL) (#2=#:G524 NIL) (|minShift| (|Integer|))
...
(SDEFUN |RECOP;makeRec;BoSFLSF;7|
        ...
        (SPROG
         ((#1=#:G575 NIL) (|info| (|BasicOperator|))
          (|fn| (|Mapping| (|List| F) (|List| F))) (|fl| (|List| F))
          (#2=#:G579 NIL) (|i| NIL) (#3=#:G578 NIL) (|ord1| (|Integer|))
          (|max1| (|Integer|)) (|next| (F)) (#4=#:G577 NIL) (#5=#:G576 NIL)
...
(SDEFUN |RECOP;irecur| ((|l| (|List| F)) (% (F)))
        (SPROG
         ((#1=#:G603 NIL) (|s| (|Stream| F)) (|ll| (|List| F)) (#2=#:G605 NIL)
          (|i| NIL) (#3=#:G604 NIL) (|o| (|NonNegativeInteger|))
          (#4=#:G591 NIL) (|g| (|Mapping| (|List| F) (|List| F)))
          (#5=#:G587 NIL) (N (|NonNegativeInteger|)) (#6=#:G585 NIL)
          (|info|
           (|Record| (|:| |eqn| F) (|:| |idx| (|Symbol|))
                     (|:| |fnc| (|BasicOperator|)) (|:| |par| (|List| F))
                     (|:| |val| (|Stream| F))
...
(SDEFUN |RECOP;ddrec| ((|l| (|List| F)) (% (|OutputForm|)))
        (SPROG
         ((|RecList| (|List| (|OutputForm|))) (#1=#:G616 NIL) (|i| NIL)
          (#2=#:G615 NIL) (|RecEq| #3=(|OutputForm|)) (|RecCoeff| #3#)
          (|v| (|NonNegativeInteger|)) (#4=#:G608 NIL) (|e| (F))
...
(SDEFUN |RECOP;makeFEq;Bo2SFLSF;11|
        ...
        (SPROG
         ((#1=#:G661 NIL) (|fn| (|Mapping| (|Stream| F)))
...
(SDEFUN |RECOP;iADE| ((|l| (|List| F)) (% (F)))
        (SPROG
         ((#1=#:G677 NIL) (|g| (|Mapping| (|Stream| F))) (#2=#:G669 NIL)
          (#3=#:G667 NIL)
          (|info|
           (|Record| (|:| |eqn| F) (|:| |idx| (|Symbol|))
                     (|:| |fnc| (|BasicOperator|)) (|:| |var| (|Symbol|))
...
(SDEFUN |RECOP;getEq;2F;13| ((|f| (F)) (% (F)))
        (SPROG
         ((#1=#:G686 NIL) (|info| #2=(|BasicOperator|)) (|arg| (|List| F))
...
(SDEFUN |RECOP;eltable?;FB;14| ((|f| (F)) (% (|Boolean|)))
        (SPROG
         ((#1=#:G702 NIL) (|info| #2=(|BasicOperator|)) (|arg| (|List| F))
          (|op| #2#) (|kl| (|List| (|Kernel| F))))
         (SEQ
          (EXIT
           (SEQ (LETT |kl| (SPADCALL |f| (QREFELT % 50)))
...
(SDEFUN |RECOP;ddADE| ((|l| (|List| F)) (% (|OutputForm|)))
        (SPROG
         ((|TaylorPoly| (|OutputForm|)) (|TaylorO| (|OutputForm|))
          (|TaylorList| (|List| (|OutputForm|))) (#1=#:G719 NIL) (|i| NIL)
          (#2=#:G718 NIL) (|v| (|NonNegativeInteger|)) (#3=#:G707 NIL)
...
(DEFUN |RecurrenceOperator| (&REST #1=#:G728)
  (SPROG NIL
         (PROG (#2=#:G729)
           (RETURN
            (COND
