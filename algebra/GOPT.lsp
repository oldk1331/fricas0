...
(SDEFUN |GOPT;option;LSU;23|
        ...
        (SPROG ((#1=#:G536 NIL) (#2=#:G537 NIL) (#3=#:G538 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(MAKEPROP '|GuessOption| '|infovec|
          (LIST
           ...
           '#(~= 62 |variableName| 68 |safety| 73 |option| 78 |one| 84
              ...
              |indexName| 129 |homogeneous| 134 |functionNames| 139
              |functionName| 144 |displayKind| 149 |debug| 154 |coerce| 159
              |checkExtraValues| 164 |check| 169 |allDegrees| 174 |Somos| 179 =
              184)
           'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 62
                                            '(1 9 7 8 10 1 18 7 17 19 1 22 7 21
                                              ...
                                              1 0 0 45 48 1 0 0 41 44 1 0 0 41
                                              51 1 0 0 21 34 1 0 52 0 56 1 0 0
