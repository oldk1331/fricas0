...
(SDEFUN |SUBSPACE;deepCopy;2%;11| ((|space| (%)) (% (%)))
        (SPROG ((|cc| (%)) (#1=#:G511 NIL) (|c| NIL) (|node| (%)))
...
(SDEFUN |SUBSPACE;merge;L%;13| ((|listOfSpaces| (|List| %)) (% (%)))
        (SPROG
         ((#1=#:G523 NIL) (|c| NIL) (#2=#:G522 NIL) (#3=#:G521 NIL) (|s| NIL)
          (|space| (%)))
         (SEQ
          (COND
...
(SDEFUN |SUBSPACE;separate;%L;14| ((|space| (%)) (% (|List| %)))
        (SPROG ((|spaceList| (|List| %)) (|spc| (%)) (#1=#:G529 NIL) (|s| NIL))
...
(SDEFUN |SUBSPACE;addPoint;%LP%;15|
        ((|space| (%)) (|path| (|List| (|NonNegativeInteger|)))
         (|point| (|Point| R)) (% (%)))
        (SPROG
         ((|node| (%)) (#1=#:G543 NIL) (|more| NIL)
          (|depth| (|NonNegativeInteger|)) (#2=#:G542 NIL) (|i| NIL)
...
(SDEFUN |SUBSPACE;addPoint2;%P%;16|
        ((|space| (%)) (|point| (|Point| R)) (% (%)))
        (SPROG
         ((|node| (%)) (#1=#:G553 NIL) (|more| NIL) (|first| (%))
          (|which| (|NonNegativeInteger|)) (|lastPt| (|List| (|Point| R))))
         (SEQ
          (COND
           ((NULL (NULL (LETT |lastPt| (QVELT |space| 7))))
...
(SDEFUN |SUBSPACE;addPointLast;2%PNni%;17|
        ...
        (SPROG
         ((#1=#:G563 NIL) (|more| NIL) (|which| (|NonNegativeInteger|))
          (|lastPt| (|List| (|Point| R))))
         (SEQ
          (COND
           ((NULL (NULL (LETT |lastPt| (QVELT |space| 7))))
...
(SDEFUN |SUBSPACE;addPoint;%LNni%;18|
        ...
        (SPROG
         ((|node| (%)) (#1=#:G573 NIL) (|more| NIL)
          (|depth| (|NonNegativeInteger|)) (#2=#:G572 NIL) (|i| NIL))
...
(SDEFUN |SUBSPACE;=;2%B;33| ((|s1| (%)) (|s2| (%)) (% (|Boolean|)))
        (SPROG
         ((#1=#:G636 NIL) (#2=#:G635 #3=(|Boolean|)) (#4=#:G637 #3#)
          (#5=#:G642 NIL) (|c1| NIL) (#6=#:G643 NIL) (|c2| NIL))
         (SEQ
          (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 84
                                            '(1 13 12 0 14 1 19 0 18 20 0 21 0
                                              ...
                                              0 48 19 55 1 0 0 10 45 2 0 0 0 0
                                              43 1 0 30 0 70 1 0 12 0 15 1 0 79
                                              ...
                                              0 19 30 51 2 0 0 0 19 50 2 0 30 0
                                              19 54 3 0 0 0 48 30 53 3 0 0 0 48
                                              19 49 2 0 12 0 0 75)))))
           '|lookupComplete|)) 
