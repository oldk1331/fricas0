...
(SDEFUN |IBPTOOLS;mapMatrixIfCan;MMU;4|
        ...
        (SPROG
         ((#1=#:G507 NIL) (|poly| (|Union| R "failed")) (#2=#:G509 NIL)
          (|j| NIL) (#3=#:G508 NIL) (|i| NIL) (|matOut| (|Matrix| R))
...
(DEFUN |IntegralBasisPolynomialTools| (&REST #1=#:G517)
  (SPROG NIL
         (PROG (#2=#:G518)
           (RETURN
            (COND
