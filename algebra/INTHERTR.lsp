        ...
        ((|f| (|Fraction| UP)) (|derivation| (|Mapping| UP UP)) (|d0| (UP))
         (%
          (|Record| (|:| |answer| (|Fraction| UP)) (|:| |lognum| UP)
                    (|:| |logden| UP))))
        (SPROG
         ((|mult| (UP)) (|p| (UP)) (|a| (UP)) (#1=#:G14 NIL) (|qr_rem| (UP))
          (|qr| (|Record| (|:| |quotient| UP) (|:| |remainder| UP)))
          (|bc| (|Record| (|:| |coef1| UP) (|:| |coef2| UP))) (#2=#:G19 NIL)
...
(DEFUN |TranscendentalHermiteIntegration| (&REST #1=#:G26)
  (SPROG NIL
         (PROG (#2=#:G27)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 36
                                            '(2 11 8 9 10 12 2 7 13 0 0 14 2 9
                                              ...
                                              0 0 0 36 2 0 17 9 10 21 3 0 17 9
                                              10 7 18)))))
           '|lookupComplete|)) 
