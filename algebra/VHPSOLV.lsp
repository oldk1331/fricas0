        ...
        ((|lv|
         ...
         (%
          (|Matrix|
           (|SparseUnivariatePolynomial| (|Expression| (|Integer|))))))
        (SPROG
         ((#1=#:G490 NIL) (|j| NIL) (|i1| #2=(|NonNegativeInteger|))
          (#3=#:G489 NIL) (|i| NIL)
          (|res|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (|n1| #2#) (#4=#:G488 NIL) (|n| (|NonNegativeInteger|))
          (|res1|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (C (|List| (|Expression| (|Integer|)))) (#5=#:G487 NIL)
          (#6=#:G486 NIL) (|vd| (|Vector| (|Integer|))) (#7=#:G485 NIL)
          (|ei| NIL) (#8=#:G484 NIL)
          (|lpp|
