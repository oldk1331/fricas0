...
(SDEFUN |SCONF;Pnan?;%B;9| ((|p| (%)) (% (|Boolean|)))
        (SPROG ((#1=#:G481 NIL) (#2=#:G482 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |SCONF;normalisePoint;2%;23| ((|pt| (%)) (% (%)))
        (SPROG
         ((|infin| (|DoubleFloat|)) (|index| (|PositiveInteger|))
          (#1=#:G518 NIL) (|x| NIL) (|pt2| (%)) (#2=#:G517 NIL)
                    ...
                    (SEQ
                     (SPADCALL
                      (SPADCALL "can't apply normalisePoint to a vector"
                                (QREFELT % 42))
                      (QREFELT % 44))
                     (EXIT (PROGN (LETT #2# |pt|) (GO #3=#:G516))))))))
                (COND
...
(SDEFUN |SCONF;=;2%B;29| ((|x| (%)) (|y| (%)) (% (|Boolean|)))
        (SPROG ((#1=#:G537 NIL) (#2=#:G538 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |i| 0) (LETT #2# (- (QREFELT % 7) 1)) G190
...
(SDEFUN |SCONF;coerce;%Of;31| ((|pt| (%)) (% (|OutputForm|)))
        (SPROG
         ((|eles| (|List| (|OutputForm|))) (#1=#:G545 NIL) (|i| NIL)
          (#2=#:G544 NIL))
         (SEQ
          (LETT |eles|
                (PROGN
                 ...
                 (SEQ (LETT |i| 0) (LETT #1# (- (QREFELT % 7) 1)) G190
                      ...
                      (SEQ
                       (EXIT
                        (LETT #2#
                              (CONS (SPADCALL (QAREF1 |pt| |i|) (QREFELT % 52))
                                    #2#))))
                      (LETT |i| (|inc_SI| |i|)) (GO G190) G191
                      (EXIT (NREVERSE #2#)))))
          (EXIT (SPADCALL |eles| (QREFELT % 54)))))) 

(DECLAIM (NOTINLINE |SConformal;|)) 

(DEFUN |SConformal| (#1=#:G546)
  (SPROG NIL
         (PROG (#2=#:G547)
           (RETURN
            (COND
...
(MAKEPROP '|SConformal| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) '|dim| '|Rep|
              ...
              |SCONF;isVector?;%B;27| |SCONF;=;2%B;29| |SCONF;~=;2%B;30|
              (38 . |coerce|) (|List| %) (43 . |paren|) |SCONF;coerce;%Of;31|)
           '#(~= 48 |unitVector| 54 |toVector| 59 |toPoint| 64 |svec| 69 |spnt|
              ...
              170 |isVector?| 175 |isPoint?| 180 |inBounds?| 185
              |extendedCoords| 192 |distanceSquared| 197 |distance| 203
              |dimension| 209 |colinearity| 214 |coerce| 220 |Pnan?| 225 = 230
              - 236 + 242 * 248)
           'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 55
                                            '(2 8 9 0 15 16 2 9 20 0 0 21 1 9 0
                                              ...
                                              0 0 32 1 0 36 0 39 2 0 9 0 0 25 2
                                              0 9 0 0 1 1 0 18 0 19 2 0 9 0 0 1
                                              1 0 41 0 55 1 0 20 0 22 2 0 20 0
                                              0 50 2 0 0 0 0 30 2 0 0 0 0 29 2
                                              0 0 9 0 28)))))
           '|lookupComplete|)) 
