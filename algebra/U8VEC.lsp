...
(DEFUN |U8Vector;| ()
  (SPROG
   ((|dv$| NIL) (% NIL) (#1=#:G2914 NIL) (#2=#:G2913 NIL) (#3=#:G2912 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|U8Vector|))
    (LETT % (GETREFV 34))
...
(MAKEPROP '|U8Vector| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|NonNegativeInteger|) |U8VEC;#;%Nni;1|
              ...
              (|Boolean|) (|SingleInteger|) (|HashState|) (|Mapping| 21 8 8)
              (|OutputForm|) (|String|) (|InputForm|) (|Mapping| 21 8)
