...
(SDEFUN |SPLTREE;construct;VCL%;5|
        ...
        (SPROG ((#1=#:G514 NIL) (|s| NIL) (#2=#:G513 NIL))
               (SEQ
                (|SPLTREE;per|
...
(SDEFUN |SPLTREE;map;M2%;17|
        ...
        (SPROG ((#2=#:G555 NIL) (|c| NIL) (#3=#:G554 NIL) (|b| (%)))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT % 22)) |a|)
                      (#4='T
                       (SEQ
...
(SDEFUN |SPLTREE;map!;M2%;18|
        ((|foo| (|Mapping| #1=(|SplittingNode| V C) #1#)) (|a| (%)) (% (%)))
        (SPROG ((#2=#:G563 NIL) (|c| NIL) (#3=#:G562 NIL))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT % 22)) |a|)
                      (#4='T
                       (SEQ
...
(SDEFUN |SPLTREE;nodes;%L;21| ((|a| (%)) (% (|List| %)))
        (SPROG ((#1=#:G573 NIL) (|c| NIL) (#2=#:G572 NIL))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT % 22)) NIL)
...
(SDEFUN |SPLTREE;leaves;%L;22| ((|a| (%)) (% (|List| (|SplittingNode| V C))))
        (SPROG ((#1=#:G580 NIL) (|c| NIL) (#2=#:G579 NIL))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT % 22)) NIL)
...
(SDEFUN |SPLTREE;members;%L;23| ((|a| (%)) (% (|List| (|SplittingNode| V C))))
        (SPROG ((#1=#:G587 NIL) (|c| NIL) (#2=#:G586 NIL))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT % 22)) NIL)
                      ((SPADCALL |a| (QREFELT % 41))
                       (LIST (SPADCALL |a| (QREFELT % 25))))
...
(SDEFUN |SPLTREE;localCoerce|
        ...
        (SPROG
         ((|lo| (|List| (|OutputForm|))) (#1=#:G614 NIL) (|c| NIL)
          (#2=#:G613 NIL) (|ro| (|OutputForm|)) (|s| (|String|))
          (#3=#:G612 NIL) (|i| NIL))
...
(SDEFUN |SPLTREE;extractSplittingLeaf;%U;28|
        ((|a| (%)) (% (|Union| % #1="failed")))
        (SPROG ((|la| (|List| %)) (#2=#:G629 NIL) (|esl| (|Union| % #1#)))
               (SEQ
                (EXIT
                 (COND
...
(DEFUN |SplittingTree| (&REST #1=#:G700)
  (SPROG NIL
         (PROG (#2=#:G701)
           (RETURN
            (COND
...
(DEFUN |SplittingTree;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G697 NIL) (#2=#:G698 NIL) (#3=#:G699 NIL) (% NIL)
...
(MAKEPROP '|SplittingTree| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|List| 92) (|Equation| 8) (|Mapping| 18 8 8) (|Mapping| 18 8)
              '"value" (|Integer|))
                  ...
                  (CONS
                   ...
                   (|makeByteWordVec2| 96
                                       '(2 8 0 6 7 10 2 8 11 6 15 16 1 8 18 0
                                         ...
                                         18 0 55 1 2 12 8 0 8 42 3 12 8 0 95 8
                                         ...
                                         18 8 0 1 1 9 8 0 1 2 8 8 93 0 1 2 12 0
                                         44 0 46 2 0 0 44 0 45 2 0 18 0 55 1 1
                                         0 13 0 52 1 0 18 0 41 1 1 64 0 1 1 0
                                         73 0 74 2 8 18 94 0 1 3 2 0 0 8 8 1 3
                                         2 0 0 13 13 1 2 2 0 0 91 1 2 2 0 0 92
                                         1 2 0 18 0 0 49 1 0 18 0 22 0 0 0 24 2
                                         0 8 0 95 1 2 0 96 0 0 1 1 0 18 0 43 2
                                         10 55 8 0 1 2 8 55 94 0 1 1 0 0 0 48 3
                                         0 0 6 7 13 14 4 0 0 6 7 6 15 17 1 0 0
                                         8 9 3 0 0 6 7 11 12 1 0 15 0 80 1 6 65
                                         0 72 1 0 11 0 28 2 4 18 0 0 1 2 8 18
                                         94 0 1 2 11 18 0 0 63 1 8 55 0 57)))))
           '|lookupComplete|)) 
