...
(SDEFUN |MAGCD2;algebraicGcd1a|
        ...
        (SPROG
         ((|yu| (MPT)) (|xu| (MPT)) (#1=#:G490 NIL) (|w1| (MPT))
...
(SDEFUN |MAGCD2;compare_coeff1|
        ...
        (SPROG
         ((#1=#:G497 NIL) (#2=#:G498 NIL) (#3=#:G499 NIL) (|i| NIL)
          (|nn| #4=(|Integer|)) (|ne| #4#))
         (SEQ
          (EXIT
...
(SDEFUN |MAGCD2;algebraicGcd2|
        ...
        (SPROG
         ((#9=#:G567 NIL) (#10=#:G566 NIL)
          ...
          (|jl| (|Integer|)) (|ndl| #11=(|List| (|Integer|))) (#12=#:G572 NIL)
          ...
          (|gtf|
           (|Record| (|:| |nvars| (|Integer|))
                     ...
                     (|:| |expdata| (|SortedExponentVector|))
                     (|:| |coeffdata| (|U32Vector|))))
          (#13=#:G563 NIL) (|gtfp| #8#) (#14=#:G564 NIL) (|bad_ev| (|Boolean|))
          (#15=#:G569 NIL) (|m| NIL) (#16=#:G570 NIL) (|deg| NIL)
          (#17=#:G571 NIL) (|z| NIL) (|lmt| (|List| MP))
          (|lmtu| #18=(|Union| MP #19="failed")) (#20=#:G568 NIL) (|yt| (MP))
          (#21=#:G523 NIL) (|ytu| #18#) (|xt| (MP)) (|xtu| #18#)
...
(SDEFUN |MAGCD2;algebraicGcd3a|
        ((|x| (MP)) (|y| (MP)) (|lm| (|List| MP)) (|lv| (|List| (|Symbol|)))
         ...
         (% (|Polynomial| (|Integer|))))
        (SPROG
         ((#8=#:G621 NIL) (|res| (|Polynomial| (|Integer|))) (#9=#:G620 NIL)
          (|pp| (|Union| (|PrimitiveArray| (|Integer|)) "failed"))
          (|coeffs| (|U32Vector|)) (|i| (|Integer|)) (|jl| (|Integer|))
          (|ndl| #10=(|List| (|Integer|))) (#11=#:G626 NIL) (|j| NIL)
          (|ncoeffs| (|U32Vector|)) (|n1| (|NonNegativeInteger|))
          (|nn| (|NonNegativeInteger|)) (|n0| (|NonNegativeInteger|))
          (|rstate| (|VectorIntegerReconstructor|)) (#12=#:G596 NIL)
          ...
          (|gtpp|
           (|Union|
            (|Record| (|:| |nvars| (|Integer|))
                      ...
                      (|:| |coeffdata| (|U32Vector|)))
            "failed"))
          (|bad_ev| (|Boolean|)) (#13=#:G623 NIL) (|m| NIL) (#14=#:G624 NIL)
          (|deg| NIL) (#15=#:G625 NIL) (|z| NIL) (|lmp| (|List| MP))
          (|lmp1| #16=(|Union| MP "failed")) (#17=#:G622 NIL) (|yp| (MP))
...
(SDEFUN |MAGCD2;algebraicGcd;2PTLLSLP;7|
        ((|x| (PT)) (|y| (PT)) (|lm| (|List| PT)) (|lv| (|List| (|Symbol|)))
         ...
         (% (|Polynomial| (|Integer|))))
        (SPROG
         ((|sval| (|List| (|Polynomial| (|Integer|)))) (#1=#:G654 NIL)
          (|v| NIL) (#2=#:G653 NIL) (|ress| (|Polynomial| (|Integer|)))
          (|pss|
           (|Record| (|:| |degx| (|Integer|)) (|:| |degy| (|Integer|))
                     ...
                     (|:| |pss1|
                          (|Record| (|:| |prime| (|Integer|))
                                    ...
                                    (|:| |eval1expbuf|
                                         (|SortedExponentVector|))))))
          (|msize| (|Integer|)) (|ldeg| (|List| (|Integer|))) (#3=#:G651 NIL)
          (|m| NIL) (#4=#:G652 NIL) (|vz| NIL) (#5=#:G650 NIL)
          (|nlm| (|List| MP)) (#6=#:G649 NIL) (#7=#:G648 NIL) (|ny| (MP))
...
(DEFUN |ModularAlgebraicGcd2| (&REST #1=#:G655)
  (SPROG NIL
         (PROG (#2=#:G656)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 84
                                            '(4 11 12 7 13 14 9 15 3 11 8 8 8 9
                                              ...
                                              13 75 2 22 0 0 22 76 3 30 22 77 0
