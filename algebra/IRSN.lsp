...
(SDEFUN |IRSN;aIdInverse| ((% (|Void|)))
        (SPROG
         ((#1=#:G585 NIL) (#2=#:G530 NIL) (#3=#:G507 NIL) (|i| NIL)
          (#4=#:G596 NIL) (|k| NIL) (#5=#:G493 NIL) (#6=#:G477 NIL) (|j| NIL)
          (#7=#:G595 NIL) (|l| NIL) (#8=#:G594 NIL)
          (|idperm| (|List| (|Integer|))) (#9=#:G592 NIL) (#10=#:G593 NIL))
         (SEQ
          (EXIT
           (SEQ (SETELT % 13 (MAKE_MATRIX1 (QREFELT % 7) (QREFELT % 7) 0))
                ...
                (COND
                 ((< (QREFELT % 10) 5)
                  (PROGN (LETT #9# (QREFELT % 13)) (GO #11=#:G591))))
                (LETT |idperm| NIL)
...
(SDEFUN |IRSN;alreadyComputed?|
        ...
        (SPROG
         ((#2=#:G605 NIL) (#3=#:G603 NIL) (#4=#:G602 #1#) (#5=#:G604 #1#)
          (#6=#:G608 NIL) (#7=#:G448 NIL) (#8=#:G598 NIL) (#9=#:G597 NIL))
         (SEQ
          (COND
...
(SDEFUN |IRSN;sumPartition|
        ...
        (SPROG
         ((#1=#:G638 NIL) (|prev| (|Integer|)) (|ok| (|Boolean|))
          (|sum| (|Integer|)) (#2=#:G641 NIL) (|x| NIL))
...
(SDEFUN |IRSN;testPermutation|
        ...
        (SPROG
         ((#1=#:G651 NIL) (#2=#:G655 NIL) (|i| NIL)
          (|test| (|Vector| (|Boolean|))) (#3=#:G647 NIL) (|ok| (|Boolean|))
          (#4=#:G654 NIL))
...
(SDEFUN |IRSN;dimensionOfIrreducibleRepresentation;LNni;7|
        ((|lambda| (|List| (|Integer|))) (% (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G660 NIL) (|dd| (|Integer|)) (#2=#:G664 NIL) (|j| NIL)
          (#3=#:G663 NIL) (|i| NIL) (|lambdaprime| (|List| (|Integer|)))
          (|nn| (|Integer|)))
...
(SDEFUN |IRSN;irreducibleRepresentation;LPM;8|
        ((|lambda| (|List| (|Integer|))) (|pi| (|Permutation| (|Integer|)))
         (% (|Matrix| (|Integer|))))
        (SPROG
         ((#1=#:G673 NIL) (|l| NIL) (#2=#:G672 NIL) (|k| NIL)
...
(SDEFUN |IRSN;irreducibleRepresentation;LLL;10|
        ((|lambda| (|List| (|Integer|)))
         (|listperm| (|List| (|Permutation| (|Integer|))))
         (% (|List| (|Matrix| (|Integer|)))))
        (SPROG ((#1=#:G684 NIL) (|pi| NIL) (#2=#:G683 NIL))
