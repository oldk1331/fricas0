...
(SDEFUN |IDPO;coerce;%Of;1| ((|x| (%)) (% (|OutputForm|)))
        (SPROG ((#1=#:G86 NIL) (|t| NIL) (#2=#:G85 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |IDPO;map;M2%;6| ((|f| (|Mapping| A A)) (|x| (%)) (% (%)))
        (SPROG ((|a| (A)) (#1=#:G107 NIL) (|tm| NIL) (#2=#:G106 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |IDPO;map;M2%;8| ((|f| (|Mapping| A A)) (|x| (%)) (% (%)))
        (SPROG ((#1=#:G115 NIL) (|tm| NIL) (#2=#:G114 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |tm| NIL) (LETT #1# |x|) G190
                      ...
                      (SEQ
                       (EXIT
                        (COND
                         ((NULL |y|)
                          (COND
                           ((NULL |x|) (PROGN (LETT #1# NIL) (GO #2=#:G140)))
                           ('T
                            (PROGN
                             (LETT #1#
                                   (SPADCALL (QCDR (|SPADfirst| |x|))
...
(SDEFUN |IDPO;add_gen| ((|x| (|Rep|)) (|y| (|Rep|)) (% (|Rep|)))
        (SPROG
         ((|res| (|Rep|)) (|end| (|Rep|)) (|endcell| (|Rep|))
          (|newcell| (|Rep|)) (|newcoef| (A))
          (|ty| #1=(|Record| (|:| |k| S) (|:| |c| A))) (|tx| #1#))
         (SEQ (LETT |endcell| NIL) (LETT |res| NIL)
              (SEQ G190
                   (COND
                    ((NULL (COND ((NULL |x|) NIL) ('T (NULL (NULL |y|)))))
                     (GO G191)))
                   (SEQ (LETT |tx| (|SPADfirst| |x|))
                        (LETT |ty| (|SPADfirst| |y|)) (LETT |newcell| NIL)
                        (COND
                         ((SPADCALL (QCAR |tx|) (QCAR |ty|) (QREFELT % 35))
                          (SEQ
                           (LETT |newcoef|
                                 (SPADCALL (QCDR |tx|) (QCDR |ty|)
                                           (QREFELT % 50)))
                           (COND
                            ((NULL (SPADCALL |newcoef| (QREFELT % 51)))
                             (LETT |newcell|
                                   (CONS (CONS (QCAR |tx|) |newcoef|) NIL))))
                           (LETT |x| (CDR |x|)) (EXIT (LETT |y| (CDR |y|)))))
                         ((SPADCALL (QCAR |ty|) (QCAR |tx|) (QREFELT % 36))
                          (SEQ (LETT |newcell| (CONS |tx| NIL))
                               (EXIT (LETT |x| (CDR |x|)))))
                         ('T
                          (SEQ (LETT |newcell| (CONS |ty| NIL))
                               (EXIT (LETT |y| (CDR |y|))))))
                        (EXIT
                         (COND
                          ((NULL (NULL |newcell|))
                   ...
                   NIL (GO G190) G191 (EXIT NIL))
              (COND ((NULL |x|) (LETT |end| |y|)) (#2='T (LETT |end| |x|)))
...
(SDEFUN |IDPO;add_si|
        ...
        (SPROG
         ((|res|
          ...
          (|end| #1#) (|endcell| #2#) (|newcell| #2#) (|newcoef| (A))
          (|ty| #3=(|Record| (|:| |k| (|SingleInteger|)) (|:| |c| A)))
          (|tx| #3#))
         (SEQ (LETT |endcell| NIL) (LETT |res| NIL)
              (SEQ G190
                   (COND
                           ...
                           (COND
                            ((NULL (SPADCALL |newcoef| (QREFELT % 51)))
                             (LETT |newcell|
                                   (CONS (CONS (QCAR |tx|) |newcoef|) NIL))))
                           (LETT |x| (CDR |x|)) (EXIT (LETT |y| (CDR |y|)))))
                         ((SPADCALL (QCAR |ty|) (QCAR |tx|) (QREFELT % 53))
                          (SEQ (LETT |newcell| (CONS |tx| NIL))
                               (EXIT (LETT |x| (CDR |x|)))))
                         ('T
                          (SEQ (LETT |newcell| (CONS |ty| NIL))
                           ...
                           (COND
                            ...
                            ('T
                             (SEQ (RPLACD |endcell| |newcell|)
                                  (EXIT (LETT |endcell| |newcell|)))))))))
                   NIL (GO G190) G191 (EXIT NIL))
              (COND ((NULL |x|) (LETT |end| |y|)) (#4='T (LETT |end| |x|)))
              (COND ((NULL |res|) (LETT |res| |end|))
...
(SDEFUN |IDPO;+;3%;27| ((|x| (%)) (|y| (%)) (% (%)))
        (SPROG
         ((|msi| (|SingleInteger|)) (|degy| (|Integer|)) (|degx| (|Integer|)))
         (SEQ
                ...
                ('T
                 (SEQ (LETT |degx| (QCAR (|SPADfirst| |x|)))
                      ...
                      (COND
                       ((< |degx| |msi|)
                        (COND
                         ((< |degy| |msi|) (EXIT (|IDPO;add_si| |x| |y| %))))))
                      (EXIT (|IDPO;add_gen| |x| |y| %)))))))) 

(SDEFUN |IDPO;+;3%;28| ((|x| (%)) (|y| (%)) (% (%)))
        (COND ((NULL |x|) |y|) ((NULL |y|) |x|)
              ('T (|IDPO;add_gen| |x| |y| %)))) 

(SDEFUN |IDPO;*;Nni2%;29| ((|n| (|NonNegativeInteger|)) (|x| (%)) (% (%)))
        (SPROG ((|a| (A)) (#1=#:G227 NIL) (|u| NIL) (#2=#:G226 NIL))
               (SEQ
...
(SDEFUN |IDPO;-;2%;30| ((|x| (%)) (% (%)))
        (SPROG ((#1=#:G232 NIL) (|u| NIL) (#2=#:G231 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |u| NIL) (LETT #1# |x|) G190
...
(SDEFUN |IDPO;*;I2%;31| ((|n| (|Integer|)) (|x| (%)) (% (%)))
        (SPROG ((|a| (A)) (#1=#:G237 NIL) (|u| NIL) (#2=#:G236 NIL))
               (SEQ
                (COND ((EQL |n| 0) (|spadConstant| % 23)) ((EQL |n| 1) |x|)
                      ('T
                       (PROGN
...
(SDEFUN |IDPO;+;3%;40| ((|x| (%)) (|y| (%)) (% (%)))
        (SPROG
         ((|xr| (|Rep|)) (|cxr| (|Rep|)) (|pxr| (|Rep|))
          ...
          (#2=#:G334 NIL) (|s| NIL) (|yr| (|Rep|)) (|xxr| (|Rep|)))
...
(SDEFUN |IDPO;=;2%B;41| ((|x| (%)) (|y| (%)) (% (|Boolean|)))
        (SPROG
         ((#1=#:G346 NIL) (|done| (|Boolean|)) (#2=#:G348 NIL) (|t| NIL)
          (|sc| (A)) (|sk| (S)) (#3=#:G347 NIL) (|s| NIL) (|yr| (|Rep|))
          (|xr| (|Rep|)))
         (SEQ
          (EXIT
...
(SDEFUN |IDPO;subtractIfCan;2%U;42|
        ((|x| (%)) (|y| (%)) (% (|Union| % #1="failed")))
        (SPROG
         ((|xr| (|Rep|)) (#2=#:G370 NIL) (|tcu| (|Union| A #1#))
          (|cxr| (|Rep|)) (|pxr| (|Rep|)) (|first_time| #3=(|Boolean|))
          (|done| #3#) (|nxr| (|Rep|)) (|tc| (A))
          (|t| (|Record| (|:| |k| S) (|:| |c| A))) (|sc| (A)) (|sk| (S))
          (#4=#:G371 NIL) (|s| NIL) (|yr| (|Rep|)))
         (SEQ
          (EXIT
           (SEQ (LETT |yr| |y|)
                (EXIT
...
(DEFUN |IndexedDirectProductObject| (&REST #1=#:G375)
  (SPROG NIL
         (PROG (#2=#:G376)
           (RETURN
            (COND
...
(DEFUN |IndexedDirectProductObject;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G374 NIL) (% NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
           ...
           (CONS
            ...
            (CONS
             '#(NIL NIL NIL NIL NIL NIL |AbelianGroup&| NIL NIL
                ...
                |SetCategory&| |Hashable&| |BasicType&| |PartialOrder&| NIL)
             (CONS
              '#((|IndexedDirectProductCategory| 6 7)
                 (|OrderedAbelianMonoidSup|) (|IndexedProductCategory| 6 7)
                 ...
                 (|Hashable|) (|BasicType|) (|PartialOrder|) (|CoercibleTo| 9))
              (|makeByteWordVec2| 76
