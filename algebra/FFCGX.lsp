...
(DEFUN |FiniteFieldCyclicGroupExtension| (&REST #1=#:G66)
  (SPROG NIL
         (PROG (#2=#:G67)
           (RETURN
            (COND
...
(MAKEPROP '|FiniteFieldCyclicGroupExtension| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|PrimitiveArray| 49) (|Union| 34 '#1="failed") (|Matrix| %)
              (|Union| 17 '"failed") (|InputForm|)
              (|Union| '"prime" '"polynomial" '"normal" '"cyclic")
              (|Union| 8 '"failed")
              (|Record| (|:| |factor| 15) (|:| |exponent| 17)) (|List| 42)
              (|Table| 9 17) (|Factored| 21) (|Union| 47 '#1#) (|List| 21)
            ...
            (CONS
             ...
             (CONS
              '#((|FiniteAlgebraicExtensionField| 6) (|FiniteFieldCategory|)
                 ...
                 (|RetractableTo| 6) (|ConvertibleTo| 39) (|CoercibleTo| 13)
