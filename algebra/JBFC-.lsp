...
(SDEFUN |JBFC-;dSubst;SJB2S;21| ((|f| (S)) (|jv| (JB)) (|exp| (S)) (% (S)))
        (SPROG
         ((|nf| (S)) (|dexp| (S)) (|d| (|List| (|NonNegativeInteger|)))
          (#1=#:G117 NIL) (|jvar| NIL) (#2=#:G118 NIL) (|JVar| (|List| JB))
          (|of| (S)))
...
(SDEFUN |JBFC-;jacobiMatrix;LSem;24|
        ...
        (SPROG ((#1=#:G127 NIL) (|fun| NIL) (#2=#:G126 NIL))
               (SEQ
                (SPADCALL |funs|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |JBFC-;jacobiMatrix;LLSem;25|
        ...
        (SPROG
         ((|inds| (|List| JB)) (|ents| (|List| S)) (|df| (S)) (#1=#:G148 NIL)
          (|jv| NIL) (#2=#:G146 NIL) (|f| NIL) (#3=#:G147 NIL) (|vars| NIL)
...
(SDEFUN |JBFC-;symbol;LSem;26|
        ((|funs| (|List| S)) (% (|SparseEchelonMatrix| JB S)))
        (SPROG
         ((|inds| (|List| JB)) (|ents| (|List| S)) (|df| (S)) (#1=#:G197 NIL)
          (|jv| NIL) (#2=#:G195 NIL) (|f| NIL) (#3=#:G196 NIL) (|i| NIL)
          (|symb| (|SparseEchelonMatrix| JB S)) (|oJV| (|List| (|List| JB)))
          (|allJV| (|List| JB)) (|ojl| (|List| JB)) (|jl| (|List| JB))
          (#4=#:G194 NIL) (|ord| (|NonNegativeInteger|))
          (|ol| (|List| (|NonNegativeInteger|))) (#5=#:G193 NIL)
          (#6=#:G192 NIL) (JVL (|List| (|List| JB))) (#7=#:G191 NIL)
          (|fun| NIL) (#8=#:G190 NIL))
         (SEQ
          (LETT JVL
                (PROGN
...
(SDEFUN |JBFC-;formalDiff;SLS;30|
        ...
        (SPROG
         ((JV (|List| JB)) (|df| (S))
          ...
          (#1=#:G211 NIL) (|jm| (|SparseEchelonMatrix| JB S)) (#2=#:G220 NIL)
          (|k| NIL) (#3=#:G218 NIL) (|i| NIL) (#4=#:G219 NIL) (|j| NIL))
...
(SDEFUN |JBFC-;formalDiff2;LPiSemR;31|
        ...
        (SPROG
         ((LJV (|List| (|List| JB))) (JV (|List| JB)) (|LRes| (|List| S))
          (|res| (S)) (|djv| (|Union| JB "0")) (#1=#:G255 NIL) (|df| NIL)
          (#2=#:G256 NIL) (|jv| NIL)
          (|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| S))))
          (#3=#:G254 NIL) (|l| NIL) (#4=#:G253 NIL) (|eq| NIL) (#5=#:G252 NIL)
          (#6=#:G251 NIL) (#7=#:G250 NIL) (|inds| (|List| JB)))
         (SEQ (LETT |inds| (SPADCALL JM (QREFELT % 94)))
              (EXIT
               (COND
                ((NULL |inds|)
...
(SDEFUN |JBFC-;sortLD;2L;34| ((|sys| (|List| S)) (% (|List| S)))
        (SPROG
         ((#1=#:G278 NIL) (|l| NIL) (#2=#:G277 NIL)
          (|sl|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                      (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| S))))
          (#3=#:G276 NIL) (|f| NIL) (#4=#:G275 NIL))
         (SEQ
          (LETT |sl|
                (PROGN
                 (LETT #4# NIL)
         ...
         ((|newL|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                      (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| S))))
          (|newld| (JB)) (#1=#:G332 NIL) (|eq| NIL) (#2=#:G333 NIL)
          (|sjv| (JB)) (#3=#:G330 NIL) (#4=#:G331 NIL)
          ...
          (|seq|
           (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                     (|:| |Dep| (|List| (|NonNegativeInteger|)))
                     (|:| |Fun| S)))
          (|len| #6#) (JV #5#) (#7=#:G329 NIL) (|neweq| (S)) (#8=#:G288 NIL)
          (#9=#:G328 NIL) (|solvable?| (|Boolean|))
          (|s| (|Union| S #10="failed")) (#11=#:G326 NIL) (#12=#:G327 NIL)
          (|eqLD|
           (|List|
...
(SDEFUN |JBFC-;simplify;LSemR;36|
        ...
        (SPROG
         ((|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| S))))
          (|tmp| (|SparseEchelonMatrix| JB S)) (#1=#:G374 NIL) (|eq| NIL)
          (#2=#:G375 NIL) (|dep| NIL) (|i| NIL)
          (|resJM| (|SparseEchelonMatrix| JB S)) (|inds| (|List| JB))
          (|resDep| (|List| #3=(|List| (|NonNegativeInteger|))))
          (#4=#:G373 NIL) (|l| NIL) (#5=#:G372 NIL) (|resSys| (|List| S))
          (#6=#:G371 NIL) (#7=#:G370 NIL)
          (|sl|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|)) (|:| |Dep| #3#)
                      (|:| |Fun| S))))
          (#8=#:G369 NIL) (|f| NIL) (#9=#:G368 NIL) (|newSys| (|List| S))
          (|jmi| (|SparseEchelonMatrix| JB S)) (|neq| (S)) (#10=#:G367 NIL))
         (SEQ (LETT |newSys| NIL)
...
(SDEFUN |JBFC-;simpMod;3L;38|
        ...
        (SPROG
         ((|res| (|List| S)) (|neq| (S)) (LS1 (|List| S)) (LD1 (|List| JB))
          (|ld| (JB)) (#1=#:G408 NIL) (#2=#:G407 NIL) (|eq1| NIL)
          (|newSys| (|List| S)) (LS (|List| S)) (LD (|List| JB))
          (|i| (|NonNegativeInteger|)) (#3=#:G406 NIL) (|jv| NIL)
          (|ls| (|Union| S "failed")) (#4=#:G405 NIL) (|eq2| NIL))
         (SEQ
          ...
          (|Record| (|:| |Sys| (|List| S))
                    ...
                    (|:| |Depend|
                         (|Union| "failed"
                                  (|List| (|List| (|NonNegativeInteger|))))))))
        (SPROG
         ((#1=#:G460 NIL) (|i| (|NonNegativeInteger|)) (#2=#:G459 NIL)
          (|resSys| (|List| S)) (|njm| (|SparseEchelonMatrix| JB S))
          (#3=#:G457 NIL) (#4=#:G458 NIL) (|oeq| NIL)
          (|resJM| (|SparseEchelonMatrix| JB S)) (|res| (|List| S)) (|neq| (S))
          (LS1 (|List| S)) (LD1 (|List| JB)) (|ld| (JB)) (#5=#:G456 NIL)
          (#6=#:G455 NIL) (|eq1| NIL) (|newSys| (|List| S)) (LS (|List| S))
          (LD (|List| JB)) (#7=#:G454 NIL) (|jv| NIL)
          (|ls| (|Union| S "failed")) (#8=#:G453 NIL) (|eq2| NIL)
          (|osys| (|List| S)) (#9=#:G452 NIL) (#10=#:G451 NIL))
         (SEQ
          (COND
...
(SDEFUN |JBFC-;reduceMod;3L;40|
        ...
        (SPROG
         ((|res| (|List| S)) (LS1 (|List| S)) (LD1 (|List| JB)) (|neq| (S))
          (|ld| (JB)) (#1=#:G493 NIL) (|oeq| (S)) (|eq| (S)) (#2=#:G492 NIL)
          (|eq1| NIL) (|newSys| (|List| S)) (LS (|List| S)) (LD (|List| JB))
          (|i| (|NonNegativeInteger|)) (#3=#:G491 NIL) (|jv| NIL)
          (|ls| (|Union| S "failed")) (#4=#:G490 NIL) (|eq2| NIL))
         (SEQ
          (COND ((OR (NULL |sys1|) (NULL |sys2|)) |sys1|)
                ('T
                 (SEQ (LETT LD NIL) (LETT LS NIL)
...
(SDEFUN |JBFC-;autoReduce;2L;41| ((|sys| (|List| S)) (% (|List| S)))
        (SPROG
         ((#1=#:G563 NIL) (#2=#:G562 NIL)
          (|tmp1|
           (|List|
            #3=(|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                         (|:| |Dep| (|List| (|NonNegativeInteger|)))
                         (|:| |Fun| S))))
          (|tmp2| (|List| #3#)) (#4=#:G561 NIL) (#5=#:G560 NIL) (#6=#:G559 NIL)
          (|eq| NIL) (#7=#:G558 NIL) (|nl| (|List| S)) (|ol| (|List| S))
          (|seq| (S)) (#8=#:G557 NIL) (#9=#:G556 NIL) (|nsl| (|List| S))
          (#10=#:G555 NIL) (#11=#:G554 NIL) (|sl| #12=(|List| #3#)) (|ic| (S))
          (|tmp|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                      (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| S))))
          (|d| (|List| (|NonNegativeInteger|))) (#13=#:G553 NIL)
          (#14=#:G551 NIL)
          (|rec|
