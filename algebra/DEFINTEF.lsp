...
(SDEFUN |DEFINTEF;checkForPole|
        ...
        (SPROG
         ((#1=#:G561 NIL) (|u| (|Union| (|Boolean|) "failed"))
...
(SDEFUN |DEFINTEF;checkFor0|
        ...
        (SPROG
         ((#2=#:G592 NIL) (|w| (|Union| (|Boolean|) #1#)) (|k| #3=(|Kernel| F))
          (|z|
           (|Union|
            (|Record| (|:| |var| #3#) (|:| |exponent| (|NonNegativeInteger|)))
            #4="failed"))
          (#5=#:G591 NIL) (#6=#:G593 NIL) (#7=#:G594 NIL) (|t| NIL)
          (|v|
...
(SDEFUN |DEFINTEF;checkSMP|
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| F))) (|x| (|Symbol|))
         ...
         (|b| (|OrderedCompletion| F)) (% (|Union| (|Boolean|) #1="failed")))
        (SPROG
         ((#2=#:G712 NIL) (|w| (|Union| (|Boolean|) #1#)) (|f2| (F))
          (#3=#:G713 NIL) (#4=#:G714 NIL) (#5=#:G711 NIL) (#6=#:G720 NIL)
          (|f| (F)) (|ak| (|List| F)) (|kk| #7=(|Kernel| F))
          (|z|
           (|Union|
            (|Record| (|:| |var| #7#) (|:| |exponent| (|NonNegativeInteger|)))
            #8="failed"))
          (|n| (R)) (#9=#:G723 NIL) (#10=#:G725 NIL) (|t| NIL)
          (|v|
           (|Union| (|List| (|SparseMultivariatePolynomial| R (|Kernel| F)))
                    #8#))
          (#11=#:G710 NIL) (#12=#:G724 NIL)
          (|u| (|Union| (|SparseUnivariatePolynomial| F) "failed")))
         (SEQ
          (EXIT
...
(SDEFUN |DEFINTEF;posit|
        ((|f| (F)) (|x| (|Symbol|)) (|k| (|Kernel| F))
         ...
         (% (|Union| (|Boolean|) "failed")))
        (SPROG
         ((#1=#:G744 NIL) (|w| (|Union| (|Boolean|) "failed")) (#2=#:G745 NIL)
          (#3=#:G733 NIL) (|b2| #4=(|Boolean|))
                     ...
                     ((>
                       (PROG2 (LETT #3# |z|)
                         ...
                         (|check_union2| (QEQCAR #3# 0) (|Integer|)
                                         (|Union| (|Integer|) #5#) #3#))
                       0)
                      (PROGN (LETT #2# (CONS 0 'T)) (GO #7=#:G742))))))))
            (LETT |z|
                   ...
                   (SEQ
                    (SEQ
                     ...
                     (EXIT
                      (COND
                       ((OR (QEQCAR |w| 1) (QCDR |w|))
                        (PROGN (LETT #1# (CONS 1 "failed")) (GO #8=#:G741))))))
                    (EXIT (CONS 0 NIL))))
                  #8# (EXIT #1#)))))))
            (EXIT (CONS 1 "failed"))))
          #7# (EXIT #2#)))) 
...
(SDEFUN |DEFINTEF;negat|
        ((|f| (F)) (|x| (|Symbol|)) (|k| (|Kernel| F))
         ...
         (% (|Union| (|Boolean|) "failed")))
        (SPROG
         ((#1=#:G764 NIL) (|w| (|Union| (|Boolean|) "failed")) (#2=#:G765 NIL)
          (#3=#:G753 NIL) (|b2| #4=(|Boolean|))
          (|z| (|Union| (|Integer|) #5="failed")) (|r| (|Union| F "failed"))
          (|b1| #4#))
         (SEQ
          (EXIT
                     ...
                     ((<
                       (PROG2 (LETT #3# |z|)
                         ...
                         (|check_union2| (QEQCAR #3# 0) (|Integer|)
                                         (|Union| (|Integer|) #5#) #3#))
                       0)
                      (PROGN (LETT #2# (CONS 0 'T)) (GO #7=#:G762))))))))
            (LETT |z|
                  (SEQ (LETT |r| (SPADCALL |b| (QREFELT % 51)))
                       (EXIT
                        (COND
                   ...
                   (SEQ
                    (SEQ
                     ...
                     (EXIT
                      (COND
                       ((OR (QEQCAR |w| 1) (QCDR |w|))
                        (PROGN (LETT #1# (CONS 1 "failed")) (GO #8=#:G761))))))
                    (EXIT (CONS 0 NIL))))
                  #8# (EXIT #1#)))))))
            (EXIT (CONS 1 "failed"))))
          #7# (EXIT #2#)))) 
...
(SDEFUN |DEFINTEF;polyIfCan|
        ...
        (SPROG
         ((|q|
          ...
          (|ans| (|SparseUnivariatePolynomial| F)) (#1=#:G775 NIL) (|c| (F)))
         (SEQ
          (EXIT
                       ...
                       (COND
                        ((SPADCALL |x|
                                   (SPADCALL
                                    ...
                                    (QREFELT % 87))
                                   (QREFELT % 89))
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G774)))
                        ('T
                         (SEQ
                          (LETT |ans|
                                (SPADCALL |ans|
...
(SDEFUN |DEFINTEF;nopole|
        ...
        (SPROG
         ((|ans| (|List| (|OrderedCompletion| F))) (#2=#:G793 NIL)
          (|v| (|Union| (|OrderedCompletion| F) "failed")) (#3=#:G794 NIL)
...
(DEFUN |ElementaryFunctionDefiniteIntegration| (&REST #1=#:G795)
  (SPROG NIL
         (PROG (#2=#:G796)
           (RETURN
            (COND
