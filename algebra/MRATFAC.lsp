...
(SDEFUN |MRATFAC;factor;PF;5| ((|p| (P)) (% (|Factored| P)))
        (SPROG
         ...
         (SEQ
          ...
          (EXIT
           (SPADCALL
            (SPADCALL (SPADCALL (|spadConstant| % 35) |pden| (QREFELT % 37))
                      (SPADCALL (ELT % 21)
                                (CONS (|function| |MRATFAC;coerce1|) %)
                                (SPADCALL |ffact| (QREFELT % 38))
                                (QREFELT % 25))
                      (QREFELT % 31))
            (PROGN
             (LETT #1# NIL)
...
(DEFUN |MRationalFactorize| (&REST #1=#:G473)
  (SPROG NIL
         (PROG (#2=#:G474)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 49
                                            '(1 10 8 0 11 1 12 0 8 13 1 12 0 7
                                              ...
                                              12 34 0 8 0 35 0 9 0 36 2 10 0 8
                                              8 37 1 32 12 0 38 1 32 41 0 42 2
                                              44 0 9 43 45 2 44 0 0 0 46 0 44 0
                                              47 2 44 0 9 0 48 1 0 44 9 49)))))
           '|lookupComplete|)) 
