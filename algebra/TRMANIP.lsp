...
(SDEFUN |TRMANIP;simplifyLog1| ((|e| (F)) (% (F)))
        (SPROG
         ((#1=#:G536 NIL) (#2=#:G535 (F)) (#3=#:G537 (F)) (#4=#:G548 NIL)
          (#5=#:G449 NIL) (|terms| (|List| F)) (|foundLog| (|Boolean|))
          (#6=#:G528 NIL) (#7=#:G527 (F)) (#8=#:G529 (F)) (#9=#:G547 NIL)
          (#10=#:G448 NIL) (|args| (|List| F)) (|i| (|NonNegativeInteger|))
          (|nterms| (|List| F)) (|exprs| (|List| F)) (#11=#:G546 NIL)
          (|term| NIL) (#12=#:G545 NIL) (#13=#:G544 NIL) (#14=#:G543 NIL)
          (|u| NIL) (#15=#:G542 NIL) (|kers| (|List| (|Kernel| F)))
          (|expt|
...
(SDEFUN |TRMANIP;termexp|
        ...
        (SPROG
         ((|coef| (|SparseMultivariatePolynomial| R (|Kernel| F)))
          (#1=#:G579 NIL) (|u| NIL) (#2=#:G578 NIL) (|exponent| (F))
          (|d| (|NonNegativeInteger|)) (#3=#:G577 NIL) (|k| NIL)
...
(SDEFUN |TRMANIP;simplifyExp;2F;48| ((|x| (F)) (% (F)))
        (SPROG
         ((#1=#:G677 NIL) (|term| (F)) (#2=#:G681 NIL) (|k1| NIL)
          (#3=#:G678 NIL) (#4=#:G680 NIL) (|h| (|NonNegativeInteger|))
          (|args| (|List| F)) (|op| (|BasicOperator|)) (#5=#:G679 NIL)
...
(SDEFUN |TRMANIP;htrigs;2F;49| ((|f| (F)) (% (F)))
        (SPROG
         ((|g1| (F)) (|b| (|Integer|)) (|g2| (F)) (|a| (F))
          ...
          (|num| #1#) (|arg| (|List| F)) (#2=#:G692 NIL) (|x| NIL)
          (#3=#:G691 NIL) (|op| (|BasicOperator|)) (|k| (|Kernel| F))
...
(SDEFUN |TRMANIP;exlog|
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| F))) (% (F)))
        (SPROG
         ((#1=#:G704 NIL) (#2=#:G703 (F)) (#3=#:G705 (F)) (#4=#:G707 NIL)
          (|r| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |TRMANIP;logexpand| ((|k| (|Kernel| F)) (% (F)))
        (SPROG
         ((#1=#:G714 NIL) (#2=#:G713 NIL) (|x| (F)) (|op| (|BasicOperator|)))
         (SEQ
          (COND
...
(SDEFUN |TRMANIP;kerexpand| ((|k| (|Kernel| F)) (% (F)))
        (SPROG
         ((#1=#:G737 NIL) (#2=#:G736 NIL) (#3=#:G735 NIL) (#4=#:G734 NIL)
...
(DEFUN |TranscendentalManipulations| (&REST #1=#:G782)
  (SPROG NIL
         (PROG (#2=#:G783)
           (RETURN
            (COND
