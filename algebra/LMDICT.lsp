...
(SDEFUN |LMDICT;coerce;%Of;1| ((|s| (%)) (% (|OutputForm|)))
        (SPROG ((#1=#:G470 NIL) (|x| NIL) (#2=#:G469 NIL))
               (SEQ
...
(SDEFUN |LMDICT;duplicates?;%B;18| ((|s| (%)) (% (|Boolean|)))
        (SPROG ((|q| (|List| S)) (|p| (|List| S)) (#1=#:G510 NIL))
               (SEQ
                (EXIT
...
(SDEFUN |LMDICT;duplicates;%L;21|
        ...
        (SPROG
         ((|ld|
           (|List|
            (|Record| (|:| |entry| S) (|:| |count| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (#1=#:G531 NIL) (|x| NIL))
         (SEQ (LETT |ld| NIL)
              (SEQ (LETT |x| NIL)
                   (LETT #1#
                         (SPADCALL (SPADCALL |lmd| (QREFELT % 12))
...
(DEFUN |ListMultiDictionary| (#1=#:G583)
  (SPROG NIL
         (PROG (#2=#:G584)
           (RETURN
            (COND
...
(DEFUN |ListMultiDictionary;| (|#1|)
  (SPROG
   ((#1=#:G582 NIL) (#2=#:G581 NIL) (|pv$| NIL) (#3=#:G578 NIL) (#4=#:G579 NIL)
    (#5=#:G580 NIL) (% NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|ListMultiDictionary| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) '|Rep| (|String|)
              ...
              (|Mapping| 6 6 6) (|Equation| 6) (|List| 67) (|Mapping| 22 6 6)
              (|Union| 6 '"failed"))
                  ...
                  (CONS
                   ...
                   (|makeByteWordVec2| 70
                                       '(1 9 0 8 10 1 6 9 0 13 2 9 0 0 14 15 1
                                         ...
                                         2 0 0 6 0 27 2 0 70 51 0 1 1 0 6 0 47
                                         2 10 22 51 0 1 3 2 0 0 6 6 1 3 2 0 0
                                         11 11 1 2 2 0 0 67 1 2 2 0 0 68 1 2 0
                                         22 0 0 1 1 0 22 0 23 0 0 0 26 1 0 22 0
                                         48 1 0 56 0 57 1 0 0 11 20 0 0 0 24 2
                                         12 17 6 0 54 2 10 17 51 0 1 1 0 0 0 21
                                         1 3 29 0 33 1 0 0 11 1 1 7 9 0 16 2 10
