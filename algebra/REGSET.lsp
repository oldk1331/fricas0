...
(SDEFUN |REGSET;coerce;%Of;12| ((|ts| (%)) (% (|OutputForm|)))
        (SPROG ((#1=#:G69 NIL) (|p| NIL) (#2=#:G68 NIL) (|lp| (|List| P)))
...
(SDEFUN |REGSET;removeZero;P%P;22| ((|p| (P)) (|ts| (%)) (% (P)))
        (SPROG
         ((|q| (P)) (#1=#:G147 NIL) (#2=#:G134 NIL) (|ts_v-| (%)) (|v| (V)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |REGSET;internalAugment;P%5BL;25|
        ((|p| (P)) (|ts| (%)) (|rem?| (|Boolean|)) (|red?| (|Boolean|))
         ...
         (% (|List| %)))
        (SPROG
         ((#1=#:G163 NIL) (|us| NIL) (#2=#:G162 NIL) (|lts| (|List| %))
          (#3=#:G161 NIL) (|f| NIL) (#4=#:G160 NIL) (|lsfp| (|List| P))
          (|ts_v+| (%)) (|ts_v-| (%)) (|v| (V)))
         (SEQ (LETT |v| (SPADCALL |p| (QREFELT % 32)))
              (LETT |ts_v-| (SPADCALL |ts| |v| (QREFELT % 44)))
...
(SDEFUN |REGSET;extend;P%L;27| ((|p| (P)) (|ts| (%)) (% (|List| %)))
        (SPROG
         ((|lts| (|List| %)) (#1=#:G181 NIL) (|us| NIL) (|split| (|List| %)))
         (SEQ
          (COND
           ((SPADCALL |p| (QREFELT % 49))
...
(SDEFUN |REGSET;internalZeroSetSplit;L3BL;39|
        ((|lp| (|List| P)) (|clos?| (|Boolean|)) (|info?| (|Boolean|))
         (|prep?| (|Boolean|)) (% (|List| %)))
        (SPROG
         ((|lts| #1=(|List| %)) (#2=#:G222 NIL) (|p| NIL) (|ts| (%))
...
(SDEFUN |REGSET;pre_process;L2BR;44|
        ...
        (SPROG
         ((#1=#:G284 NIL) (|lp2| (|List| P)) (|lts| (|List| %)) (#2=#:G297 NIL)
          (|p| NIL) (|lp3| (|List| P)) (#3=#:G296 NIL) (|lp4| (|List| P))
          (#4=#:G295 NIL) (#5=#:G294 NIL) (#6=#:G293 NIL) (#7=#:G292 NIL)
          (#8=#:G291 NIL) (#9=#:G290 NIL) (#10=#:G289 NIL) (#11=#:G288 NIL)
          (#12=#:G287 NIL) (#13=#:G286 NIL) (|lp1| (|List| P)) (#14=#:G285 NIL)
          (|ts| (%)))
         (SEQ
          (EXIT
           (SEQ (LETT |ts| (SPADCALL NIL (QREFELT % 20)))
...
(DEFUN |RegularTriangularSet| (&REST #1=#:G316)
  (SPROG NIL
         (PROG (#2=#:G317)
           (RETURN
            (COND
...
(DEFUN |RegularTriangularSet;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((#1=#:G315 NIL) (|pv$| NIL) (% NIL) (|dv$| NIL) (DV$4 NIL) (DV$3 NIL)
    (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|RegularTriangularSet| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|Record| (|:| |close| 10) (|:| |open| 10)) (|Mapping| 14 9 10)
              (|Mapping| 9 9 9) (|Record| (|:| |close| %) (|:| |open| 10))
              (|List| 135) (|Union| 14 29) (|Union| 9 29) (|Equation| 9)
              (|List| 139) (|InputForm|)
              (|Record| (|:| |num| 9) (|:| |den| 6)))
           '#(~= 296 |zeroSetSplitIntoTriangularSystems| 302 |zeroSetSplit| 307
              ...
              |headReduced?| 789 |headReduce| 800 |first| 806 |find| 811
              |extendIfCan| 817 |extend| 823 |every?| 853 |eval| 859 |eq?| 885
              |empty?| 891 |empty| 896 |degree| 900 |count| 905 |copy| 917
              |convert| 922 |construct| 927 |collectUpper| 932 |collectUnder|
              938 |collectQuasiMonic| 944 |collect| 949 |coerce| 955 |coHeight|
              965 |basicSet| 970 |autoReduced?| 983 |augment| 989 |any?| 1013
              |algebraicVariables| 1019 |algebraicCoefficients?| 1024
              |algebraic?| 1030 = 1036 |#| 1042)
           'NIL
                 ...
                 (CONS
                  ...
                  (CONS
                   '#((|RegularTriangularSetCategory| 6 7 8 9)
