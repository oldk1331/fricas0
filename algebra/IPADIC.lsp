...
(SDEFUN |IPADIC;=;2%B;15| ((|x| (%)) (|y| (%)) (% (|Boolean|)))
        (SPROG
         ((|st| (|Stream| (|Integer|))) (#1=#:G526 NIL) (#2=#:G527 NIL)
          (|i| NIL) (|n| (|Integer|)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |IPADIC;iRoot!0| (($$ NIL))
        (PROG (|f| |alpha| % |pPow| |invFpx0| |p|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G676 NIL) (|num| NIL) (|digit| NIL))
                   (SEQ
                    (LETT |num|
                          (SPADCALL
                           (PROG2
...
(SDEFUN |IPADIC;coerce;%Of;43| ((|x| (%)) (% (|OutputForm|)))
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|st| (%)) (|st1| (%)) (|n| NIL)
          (#1=#:G713 NIL) (|count| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(DEFUN |InnerPAdicInteger| (&REST #1=#:G725)
  (SPROG NIL
         (PROG (#2=#:G726)
           (RETURN
            (COND
             ...
             (CONS
              ...
              (|makeByteWordVec2| 97
                                  '(1 9 8 0 10 2 12 0 0 9 20 1 12 0 0 22 2 9 0
                                    ...
                                    0 1 1 0 26 0 1 1 0 96 0 1 1 0 0 0 1 1 0 26
