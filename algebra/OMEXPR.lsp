...
(SDEFUN |OMEXPR;outputOMExpr|
        ...
        (SPROG
         ((|k| (|Kernel| (|Expression| R))) (#1=#:G120 NIL)
          (|z|
           (|Union|
...
(DEFUN |ExpressionToOpenMath| (#1=#:G129)
  (SPROG NIL
         (PROG (#2=#:G130)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 72
                                            '(1 10 0 9 11 1 15 14 0 16 3 15 14
                                              ...
                                              14 0 69 1 15 14 0 70 2 0 14 15 19
                                              71 3 0 14 15 19 20 21 1 0 17 19
                                              72 2 0 17 19 20 68)))))
           '|lookupComplete|)) 
