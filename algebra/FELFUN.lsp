...
(SDEFUN |FELFUN;landen2;FLFL;4|
        ((|m| (|Float|)) (|res| (|List| (|Float|))) (|eps| (|Float|))
         (% (|List| (|Float|))))
        (SPROG
         ((|kn| (|Float|)) (|kp| (|Float|)) (#1=#:G510 NIL) (|am| (|Float|)))
         (SEQ
          (SEQ
           (EXIT
            (SEQ G190 NIL
                       ...
                       (COND
                        ((SPADCALL |am| |eps| (QREFELT % 17))
                         (SEQ
                          ...
                          (EXIT (PROGN (LETT #1# |$NoValue|) (GO #2=#:G507)))))
                        ('T
                         (SEQ
                          (LETT |kp|
                                (SPADCALL
...
(SDEFUN |FELFUN;kprod;LF;6| ((|ll| (|List| (|Float|))) (% (|Float|)))
        (SPROG ((#1=#:G521 NIL) (|k| NIL) (#2=#:G520 NIL))
               (SEQ
                (SPADCALL (ELT % 34)
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FELFUN;sn2;FLF;7|
        ...
        (SPROG ((|res| (|Float|)) (#1=#:G526 NIL) (|k| NIL))
                         ...
                         (SEQ
                          (LETT |kn|
                                (SPADCALL (SPADCALL 1 4 (QREFELT % 29)) |m|
                                          (QREFELT % 49)))
                          (LETT |res| (CONS |kn| |res|))
                          (EXIT (PROGN (LETT #1# |$NoValue|) (GO #2=#:G536)))))
                        ('T
                         (SEQ
                          (LETT |kp|
                                (SPADCALL
...
(SDEFUN |FELFUN;kprod;LC;11|
        ...
        (SPROG ((#1=#:G550 NIL) (|k| NIL) (#2=#:G549 NIL))
               (SEQ
                (SPADCALL (ELT % 52)
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FELFUN;sn2;CLC;12|
        ((|z| (|Complex| (|Float|))) (|ll| (|List| (|Complex| (|Float|))))
         (% (|Complex| (|Float|))))
        (SPROG ((|res| (|Complex| (|Float|))) (#1=#:G555 NIL) (|k| NIL))
...
(SDEFUN |FELFUN;zeta2|
        ...
        (SPROG
         ((|snz| (|Float|)) (|res| (|Float|)) (|r| (|Float|))
          ...
          (|p| #2#) (|k1inv| #1#) (|k1| (|Float|)) (#3=#:G644 NIL) (|k| NIL)
...
(SDEFUN |FELFUN;theta0|
        ...
        (SPROG
         ((|t3| #2=(|Complex| (|Float|))) (|t2| (|Complex| (|Float|)))
          (|pp| #3=(|Complex| (|Float|))) (|nt3| #2#) (#4=#:G664 NIL) (|i| NIL)
          (#5=#:G665 NIL) (|iq2| #6=(|Complex| (|Float|)))
          (|liq2| (|List| (|Complex| (|Float|)))) (#7=#:G663 NIL)
...
(SDEFUN |FELFUN;reduce_periods|
        ((|w1| #1=(|Complex| (|Float|))) (|w2| #2=(|Complex| (|Float|)))
         (% (|List| (|Complex| (|Float|)))))
        (SPROG
         ((|aw1| #3=(|Float|)) (#4=#:G677 NIL) (|rit| (|Float|))
                       ...
                       (EXIT
                        (COND
                         ((SPADCALL |rit| (|spadConstant| % 65) (QREFELT % 95))
                          (PROGN (LETT #4# (LIST |w1| |w2|)) (GO #5=#:G676)))
                         ('T
                          (SEQ
                           (LETT |w1|
                                 (SPADCALL |w1|
...
(SDEFUN |FELFUN;ellipticF;3F;37|
        ((|z| (|Float|)) (|m| (|Float|)) (% (|Float|)))
        (SPROG
         ((|res| (|Float|)) (|delta| (|Float|)) (#1=#:G696 NIL) (|k| NIL)
          (|ll| (|List| (|Float|))) (|eps| (|Float|))
...
(SDEFUN |FELFUN;ellipticF_aux|
        ((|z| (|Complex| (|Float|))) (|m| (|Complex| (|Float|)))
         (% (|Complex| (|Float|))))
        (SPROG
         ((|delta| (|Complex| (|Float|))) (#1=#:G710 NIL) (|k| NIL)
          (|sf| (|Float|)) (|nz| (|Float|))
...
(SDEFUN |FELFUN;ellipticE;2F;41| ((|m| (|Float|)) (% (|Float|)))
        (SPROG
         ((|e_val| #1=(|Float|)) (|p| (|Float|)) (|k1inv| (|Float|))
          (|f_val| #1#) (|k1| (|Float|)) (#2=#:G718 NIL) (|k| NIL)
          (|ll| (|List| (|Float|))) (|eps| (|Float|))
          (|prec| (|PositiveInteger|)) (|obits| (|PositiveInteger|)))
         (SEQ
          (COND
...
(SDEFUN |FELFUN;ellipticE;2C;42|
        ...
        (SPROG
         ((|e_val| #1=(|Complex| (|Float|))) (|p| (|Complex| (|Float|)))
          ...
          (|k1| (|Complex| (|Float|))) (#2=#:G726 NIL) (|k| NIL)
          (|ll| (|List| (|Complex| (|Float|)))) (|eps| (|Float|))
          (|prec| (|PositiveInteger|)) (|obits| (|PositiveInteger|)))
         (SEQ
          (COND
...
(SDEFUN |FELFUN;ellipticE;3F;43|
        ...
        (SPROG
         ((|e_val| #1=(|Float|)) (|r| #2=(|Float|)) (|k_z2| #3=(|Float|))
          ...
          (|k1| (|Float|)) (#4=#:G742 NIL) (|k| NIL) (#5=#:G743 NIL)
          (|lz| (|List| (|Float|))) (|delta| #6=(|Float|)) (#7=#:G741 NIL)
...
(SDEFUN |FELFUN;ellipticE_aux|
        ...
        (SPROG
         ((|e_val| #2=(|Complex| (|Float|))) (|r| #3=(|Complex| (|Float|)))
          ...
          (|k1| (|Complex| (|Float|))) (#5=#:G758 NIL) (|k| NIL)
          (#6=#:G759 NIL) (|lz| (|List| (|Complex| (|Float|))))
          (|delta| (|Complex| (|Float|))) (#7=#:G757 NIL)
...
(SDEFUN |FELFUN;ellipticPi_r|
        ...
        (SPROG
         ((|pi_val| (|Float|)) (|p_inv| (|Float|)) (|f_val| (|Float|))
          (|k1| (|Float|)) (#3=#:G792 NIL) (|k| NIL) (#4=#:G793 NIL)
          (#5=#:G794 NIL) (#6=#:G795 NIL) (|p| #7=(|Float|))
          (|lnk| (|List| (|Float|))) (|nk| #2#) (|cc| #8=(|Float|))
          (|lp| (|List| (|Float|))) (#9=#:G791 NIL) (|lz| (|List| (|Float|)))
          (|delta| (|Float|)) (#10=#:G790 NIL) (|z0| #1#)
          (|llr| (|List| (|Float|))) (|ll| (|List| (|Float|)))
...
(SDEFUN |FELFUN;ellipticPi_aux|
        ...
        (SPROG
         ((|pi_val| (|Complex| (|Float|))) (|p_inv| #3=(|Complex| (|Float|)))
          ...
          (#4=#:G820 NIL) (|k| NIL) (#5=#:G821 NIL) (#6=#:G822 NIL)
          (#7=#:G823 NIL) (|p| #8=(|Complex| (|Float|)))
          (|lnk| (|List| (|Complex| (|Float|)))) (|nk| #2#)
          (|cc| #9=(|Complex| (|Float|))) (|lp| (|List| (|Complex| (|Float|))))
          (#10=#:G819 NIL) (|lz| (|List| (|Complex| (|Float|))))
          (|delta| (|Complex| (|Float|))) (#11=#:G818 NIL) (|z0| #1#)
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 133
                                            '(1 6 0 0 7 1 9 0 0 10 1 9 6 0 11 3
                                              ...
                                              0 126 2 9 0 0 28 128 3 0 9 9 9 9
                                              131 3 0 6 6 6 6 133 3 0 9 9 9 9
                                              130 3 0 6 6 6 6 132 2 0 47 9 9
                                              108 2 0 47 9 9 129 2 0 9 9 47 57
                                              2 0 6 6 25 40 1 0 6 6 8 1 0 6 9
                                              12 1 0 9 9 107 3 0 25 6 25 6 31 3
                                              0 47 9 47 6 50 2 0 25 6 25 26 2 0
                                              47 9 47 48 2 0 25 6 6 33 2 0 47 9
                                              6 51 1 0 6 25 37 1 0 9 47 55 2 0
