         ...
         ((|edges|
           (|List|
            (|Record| (|:| |name| (|String|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (#1=#:G503 NIL) (|ar| NIL) (#2=#:G504 NIL) (|arn| NIL)
          (|nodes|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))
          (#3=#:G501 NIL) (|ob| NIL) (#4=#:G502 NIL) (|obn| NIL))
         (SEQ (LETT |nodes| NIL)
         ...
         ((|ars|
           (|List|
            #1=(|Record| (|:| |fromOb| (|NonNegativeInteger|))
                         (|:| |toOb| (|NonNegativeInteger|)))))
          (|z| #1#) (#2=#:G515 NIL) (|y| NIL) (#3=#:G516 NIL) (|yn| NIL)
          (#4=#:G513 NIL) (|x| NIL) (#5=#:G514 NIL) (|xn| NIL)
         ...
         ((|ar|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|a| #1#) (#2=#:G533 NIL) (|j| NIL) (#3=#:G532 NIL) (|i| NIL)
          (|obs|
           (|List|
            #4=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #4#) (|ob| (S)) (#5=#:G531 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL)
         ...
         ((|as|
           (|List|
            (|Record| (|:| |name| (|String|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|revAr| #1#) (#2=#:G565 NIL) (|a| NIL) (|forwAr| #1#)
          (#3=#:G564 NIL))
         (SEQ (LETT |as| NIL)
          ...
          (|ars|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|a| #1#) (#2=#:G616 NIL) (|obm| NIL)
          (|obs|
           (|List|
            #3=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #3#) (|ob| (S)) (#4=#:G615 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL) (LETT |ars| NIL) (LETT |arn| 1)
...
(SDEFUN |UDGRPH;merge;3%;22| ((|a| (%)) (|b| (%)) (% (%)))
        (SPROG
         ((|la|
          ...
          (#3=#:G649 NIL) (|ba| NIL) (|bStart| #4=(|NonNegativeInteger|))
          (|bmap| (|List| (|NonNegativeInteger|))) (#5=#:G636 NIL)
          (|newIndex| #4#)
          (|mergedObjects|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|i| (|Integer|)) (#6=#:G648 NIL) (|bob| NIL) (#7=#:G647 NIL)
          (|x| NIL) (#8=#:G646 NIL))
         (SEQ
          (LETT |bmap|
                (PROGN
...
(SDEFUN |UDGRPH;objProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bi| (S)) (#4=#:G662 NIL) (|boi| NIL) (|ayi| #2#) (|axi| #3#)
          (|ai| (S)) (#5=#:G661 NIL) (|aoi| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G689 NIL) (|bv| NIL)
          (#3=#:G688 NIL) (|bu| NIL) (#4=#:G687 NIL) (|av| NIL) (#5=#:G686 NIL)
          (|au| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G718 NIL) (|bv| NIL)
          (#3=#:G717 NIL) (|bu| NIL) (#4=#:G716 NIL) (|av| NIL) (#5=#:G715 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
...
(SDEFUN |UDGRPH;closedObjProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #1#) (|bi| (S)) (#4=#:G729 NIL) (|boi| NIL) (|ayi| #2#)
          (|axi| #1#) (|ai| (S)) (#5=#:G728 NIL) (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
              (SEQ (LETT |aoi| NIL) (LETT #5# (QCAR |a|)) G190
                   (COND
                    ((OR (ATOM #5#) (PROGN (LETT |aoi| (CAR #5#)) NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G754 NIL) (|bv| NIL)
          (#3=#:G753 NIL) (|bu| NIL) (#4=#:G752 NIL) (|av| NIL) (#5=#:G751 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G784 NIL) (|bv| NIL)
          (#3=#:G783 NIL) (|bu| NIL) (#4=#:G782 NIL) (|av| NIL) (#5=#:G781 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G804 NIL) (|oldArrow| NIL) (#4=#:G791 NIL)
          (#5=#:G790 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G803 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#7=#:G802 NIL) (|o| NIL) (#8=#:G801 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G824 NIL) (|oldArrow| NIL) (#4=#:G811 NIL)
          (#5=#:G810 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G823 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#7=#:G822 NIL) (|o| NIL) (#8=#:G821 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
...
(SDEFUN |UDGRPH;coerce;%Of;33| ((|n| (%)) (% (|OutputForm|)))
        (SPROG
         ((|arrows| #1=(|OutputForm|)) (|laof| (|List| (|OutputForm|)))
          (#2=#:G838 NIL) (|ar| NIL) (#3=#:G837 NIL) (#4=#:G834 NIL)
          (|la|
           (|List|
            (|Record| (|:| |name| (|String|))
                      (|:| |arrType| (|NonNegativeInteger|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|vertices| #1#) (|lvof| (|List| (|OutputForm|))) (#5=#:G836 NIL)
          (|v| NIL) (#6=#:G835 NIL)
          (|lv|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |vertices| (SPADCALL "Vertices: " (QREFELT % 86)))
                ...
                (COND
                 ((NULL |la|) (PROGN (LETT #4# |vertices|) (GO #7=#:G833))))
                (LETT |laof|
                      (PROGN
                       (LETT #3# NIL)
...
(SDEFUN |UDGRPH;subdiagramSvg;S%2BV;34|
        ...
        (SPROG
         ((#2=#:G856 NIL) (|s| (|String|))
          ...
          (|toY| #5=(|NonNegativeInteger|)) (#6=#:G850 NIL) (|fromY| #5#)
          (#7=#:G849 NIL) (|toX| #5#) (#8=#:G848 NIL) (|fromX| #5#)
          (#9=#:G847 NIL) (#10=#:G858 NIL) (|arrow| NIL) (#11=#:G859 NIL)
          (|arrn| NIL)
          (|arrs|
           (|List|
            (|Record| (|:| |name| (|String|))
          ...
          (|indexNodes| (|List| S)) (#12=#:G857 NIL) (|i| NIL)
          (|ls|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (COND
             ((NULL |arrs|)
              (PROGN (LETT #2# (SPADCALL (QREFELT % 104))) (GO #13=#:G855))))
...
(MAKEPROP '|UndirectedGraph| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) '|Rep| (|Boolean|)
              ...
              (|List| (|Loop|)) (|List| 118) (|Tree| 32) (|DirectedGraph| %))
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 119
                                            '(2 0 18 18 18 19 2 0 18 18 18 20 2
                                              ...
                                              118 0 18 1 2 0 118 0 18 1 1 0 117
                                              0 1 1 0 117 0 1 3 0 34 0 18 18 1
                                              3 0 34 0 18 18 1 2 0 18 0 18 1 2
                                              0 34 0 18 1 2 0 34 0 18 1 2 0 34
                                              0 18 1 2 0 34 0 18 1 1 0 18 0 1 2
                                              0 18 0 34 1 2 0 0 0 0 61 2 0 18 0
                                              34 1 1 0 18 0 1 5 0 0 0 34 10 32
                                              32 83 5 0 0 0 34 10 32 32 82 2 0
                                              8 0 0 1 1 0 116 0 1 2 0 116 0 18
                                              1 1 0 116 0 1 1 0 44 0 1 1 0 114
                                              0 1 2 0 0 10 44 55 3 0 8 0 18 18
                                              1 1 0 8 0 1 2 0 8 0 18 1 0 0 8 9
                                              3 0 8 0 18 18 69 1 0 8 0 1 0 0 0
                                              49 1 0 114 0 1 2 0 18 0 18 1 1 0
                                              13 0 47 2 0 18 0 6 1 1 0 16 0 48
                                              3 0 18 0 18 18 1 1 0 0 119 1 1 0
                                              114 0 1 3 0 32 0 18 18 1 3 0 103
                                              44 71 8 1 1 0 18 0 62 3 0 103 44
                                              0 8 113 3 0 103 44 0 8 112 1 0 18
                                              0 63 3 0 103 44 0 8 1 2 0 0 10 44
                                              ...
                                              70 1 0 115 0 1 2 0 0 0 12 42 2 0
                                              0 0 6 41 4 0 0 0 44 6 6 1 5 0 0 0
                                              44 18 18 34 46 2 0 0 0 15 43 4 0
                                              0 0 44 18 18 45 2 0 8 0 0 1 2 0 0
                                              0 0 58 2 0 73 0 0 75)))))
           '|lookupComplete|)) 
