         ...
         ((|edges|
           (|List|
            (|Record| (|:| |name| (|String|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (#1=#:G66 NIL) (|ar| NIL) (#2=#:G67 NIL) (|arn| NIL)
          (|nodes|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))
          (#3=#:G64 NIL) (|ob| NIL) (#4=#:G65 NIL) (|obn| NIL))
         (SEQ (LETT |nodes| NIL)
         ...
         ((|ars|
           (|List|
            #1=(|Record| (|:| |fromOb| (|NonNegativeInteger|))
                         (|:| |toOb| (|NonNegativeInteger|)))))
          (|z| #1#) (#2=#:G78 NIL) (|y| NIL) (#3=#:G79 NIL) (|yn| NIL)
          (#4=#:G76 NIL) (|x| NIL) (#5=#:G77 NIL) (|xn| NIL)
         ...
         ((|ar|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|a| #1#) (#2=#:G106 NIL) (|j| NIL) (#3=#:G105 NIL) (|i| NIL)
          (|obs|
           (|List|
            #4=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #4#) (|ob| (S)) (#5=#:G104 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL)
         ...
         ((|as|
           (|List|
            (|Record| (|:| |name| (|String|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|revAr| #1#) (#2=#:G138 NIL) (|a| NIL) (|forwAr| #1#)
          (#3=#:G137 NIL))
         (SEQ (LETT |as| NIL)
          ...
          (|ars|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|a| #1#) (#2=#:G189 NIL) (|obm| NIL)
          (|obs|
           (|List|
            #3=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #3#) (|ob| (S)) (#4=#:G188 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL) (LETT |ars| NIL) (LETT |arn| 1)
...
(SDEFUN |UDGRPH;merge;3%;22| ((|a| (%)) (|b| (%)) (% (%)))
        (SPROG
         ((|la|
          ...
          (#3=#:G222 NIL) (|ba| NIL) (|bStart| #4=(|NonNegativeInteger|))
          (|bmap| (|List| (|NonNegativeInteger|))) (#5=#:G209 NIL)
          (|newIndex| #4#)
          (|mergedObjects|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|i| (|Integer|)) (#6=#:G221 NIL) (|bob| NIL) (#7=#:G220 NIL)
          (|x| NIL) (#8=#:G219 NIL))
         (SEQ
          (LETT |bmap|
                (PROGN
...
(SDEFUN |UDGRPH;objProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bi| (S)) (#4=#:G236 NIL) (|boi| NIL) (|ayi| #2#) (|axi| #3#)
          (|ai| (S)) (#5=#:G235 NIL) (|aoi| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G263 NIL) (|bv| NIL)
          (#3=#:G262 NIL) (|bu| NIL) (#4=#:G261 NIL) (|av| NIL) (#5=#:G260 NIL)
          (|au| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G292 NIL) (|bv| NIL)
          (#3=#:G291 NIL) (|bu| NIL) (#4=#:G290 NIL) (|av| NIL) (#5=#:G289 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
...
(SDEFUN |UDGRPH;closedObjProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #1#) (|bi| (S)) (#4=#:G303 NIL) (|boi| NIL) (|ayi| #2#)
          (|axi| #1#) (|ai| (S)) (#5=#:G302 NIL) (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
              (SEQ (LETT |aoi| NIL) (LETT #5# (QCAR |a|)) G190
                   (COND
                    ((OR (ATOM #5#) (PROGN (LETT |aoi| (CAR #5#)) NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G328 NIL) (|bv| NIL)
          (#3=#:G327 NIL) (|bu| NIL) (#4=#:G326 NIL) (|av| NIL) (#5=#:G325 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G358 NIL) (|bv| NIL)
          (#3=#:G357 NIL) (|bu| NIL) (#4=#:G356 NIL) (|av| NIL) (#5=#:G355 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G378 NIL) (|oldArrow| NIL) (#4=#:G365 NIL)
          (#5=#:G364 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G377 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#7=#:G376 NIL) (|o| NIL) (#8=#:G375 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G398 NIL) (|oldArrow| NIL) (#4=#:G385 NIL)
          (#5=#:G384 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G397 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#7=#:G396 NIL) (|o| NIL) (#8=#:G395 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
...
(SDEFUN |UDGRPH;coerce;%Of;33| ((|n| (%)) (% (|OutputForm|)))
        (SPROG
         ((|arrows| #1=(|OutputForm|)) (|laof| (|List| (|OutputForm|)))
          (#2=#:G412 NIL) (|ar| NIL) (#3=#:G411 NIL) (#4=#:G408 NIL)
          (|la|
           (|List|
            (|Record| (|:| |name| (|String|))
                      (|:| |arrType| (|NonNegativeInteger|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|vertices| #1#) (|lvof| (|List| (|OutputForm|))) (#5=#:G410 NIL)
          (|v| NIL) (#6=#:G409 NIL)
          (|lv|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |vertices| (SPADCALL "Vertices: " (QREFELT % 86)))
                ...
                (COND
                 ((NULL |la|) (PROGN (LETT #4# |vertices|) (GO #7=#:G407))))
                (LETT |laof|
                      (PROGN
                       (LETT #3# NIL)
...
(SDEFUN |UDGRPH;subdiagramSvg;S%2BV;34|
        ...
        (SPROG
         ((#2=#:G434 NIL) (|s| (|String|))
          ...
          (|toY| #5=(|NonNegativeInteger|)) (#6=#:G428 NIL) (|fromY| #5#)
          (#7=#:G427 NIL) (|toX| #5#) (#8=#:G426 NIL) (|fromX| #5#)
          (#9=#:G425 NIL) (#10=#:G436 NIL) (|arrow| NIL) (#11=#:G437 NIL)
          (|arrn| NIL)
          (|arrs|
           (|List|
            (|Record| (|:| |name| (|String|))
          ...
          (|indexNodes| (|List| S)) (#12=#:G435 NIL) (|i| NIL)
          (|ls|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (COND
             ((NULL |arrs|)
              (PROGN (LETT #2# (SPADCALL (QREFELT % 104))) (GO #13=#:G433))))
...
(MAKEPROP '|UndirectedGraph| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) '|Rep| (|Boolean|)
              ...
              |UDGRPH;diagramSvg2;S%BV;36| (|DirectedGraph| %) (|List| 116)
              (|Tree| 32) (|List| (|Loop|)) (|Matrix| 18) (|Matrix| 32))
           '#(~= 265 |unit| 271 |undirectedGraph| 277 |terminal| 310
              ...
              |initial| 507 |incidenceMatrix| 511 |inDegree| 516 |getVertices|
              522 |getVertexIndex| 527 |getArrows| 533 |getArrowIndex| 538
              |flatten| 545 |distanceMatrix| 550 |distance| 555 |diagramsSvg|
              562 |diagramWidth| 569 |diagramSvg2| 574 |diagramSvg| 581
              |diagramHeight| 588 |deepDiagramSvg| 593 |cycleOpen| 600
              |cycleClosed| 606 |createY| 612 |createX| 618 |createWidth| 624
              |coerce| 629 |closedTensor| 639 |closedCartesian| 646 |cartesian|
              653 |arrowsToNode| 659 |arrowsToArrow| 665 |arrowsFromNode| 671
              |arrowsFromArrow| 677 |arrowName| 683 |adjacencyMatrix| 690
              |addObject!| 695 |addArrow!| 707 = 738 + 744 * 750)
           'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 119
                                            '(2 0 18 18 18 19 2 0 18 18 18 20 2
                                              ...
                                              2 0 0 10 44 53 1 0 0 13 14 1 0 0
                                              10 11 2 0 0 10 24 25 2 0 0 13 16
                                              17 1 0 0 26 31 2 0 0 10 35 39 1 0
                                              0 6 50 4 0 103 95 0 8 8 107 2 0
                                              116 0 18 1 2 0 116 0 18 1 1 0 115
                                              0 1 1 0 115 0 1 3 0 34 0 18 18 1
                                              ...
                                              0 8 0 0 1 1 0 117 0 1 2 0 117 0
                                              18 1 1 0 117 0 1 1 0 44 0 1 1 0
                                              119 0 1 2 0 0 10 44 55 3 0 8 0 18
                                              18 1 1 0 8 0 1 2 0 8 0 18 1 0 0 8
                                              9 3 0 8 0 18 18 69 1 0 8 0 1 0 0
                                              0 49 1 0 119 0 1 2 0 18 0 18 1 1
                                              0 13 0 47 2 0 18 0 6 1 1 0 16 0
                                              48 3 0 18 0 18 18 1 1 0 0 114 1 1
                                              0 119 0 1 3 0 32 0 18 18 1 3 0
                                              103 44 71 8 1 1 0 18 0 62 3 0 103
                                              44 0 8 113 3 0 103 44 0 8 112 1 0
                                              18 0 63 3 0 103 44 0 8 1 2 0 0 10
                                              44 51 2 0 0 10 44 52 2 0 18 18 18
                                              20 2 0 18 18 18 19 1 0 18 18 1 1
                                              0 85 0 93 1 0 0 26 84 3 0 0 0 0
                                              77 78 3 0 0 0 0 77 79 2 0 73 0 0
                                              76 2 0 34 0 18 1 2 0 34 0 18 1 2
                                              0 34 0 18 1 2 0 34 0 18 1 3 0 44
                                              0 18 18 70 1 0 118 0 1 2 0 0 0 6
                                              41 2 0 0 0 12 42 4 0 0 0 44 18 18
                                              45 2 0 0 0 15 43 5 0 0 0 44 18 18
                                              34 46 4 0 0 0 44 6 6 1 2 0 8 0 0
                                              1 2 0 0 0 0 58 2 0 73 0 0 75)))))
           '|lookupComplete|)) 
