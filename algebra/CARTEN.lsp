        ...
        (SPROG
         ((|qr|
           (|Record| (|:| |quotient| (|Integer|))
                     (|:| |remainder| (|Integer|))))
          (#1=#:G481 NIL) (|i| NIL) (|rnk| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |CARTEN;index2int| ((|indv| (|Vector| (|Integer|))) (% (|Integer|)))
        (SPROG ((|n| (|Integer|)) (|ix| (|Integer|)) (#1=#:G488 NIL) (|i| NIL))
               (SEQ (LETT |n| 0)
...
(SDEFUN |CARTEN;mkPerm|
        ((|n| (|NonNegativeInteger|)) (|l| (|List| (|Integer|)))
         (% (|Vector| (|Integer|))))
        (SPROG
         ((#1=#:G505 NIL) (#2=#:G508 NIL) (|e| NIL) (#3=#:G506 NIL) (|i| NIL)
          (#4=#:G507 NIL) (|seen| (|Vector| (|Boolean|)))
          (|p| (|Vector| (|Integer|))))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;permsign!| ((|v| (|Vector| (|Integer|))) (% (|Integer|)))
        (SPROG
         ((#1=#:G532 NIL) (#2=#:G536 NIL) (|i| NIL) (|totTrans| (|Integer|))
          (|e| (|Integer|)) (|nTrans| (|Integer|)) (#3=#:G534 NIL)
          (#4=#:G535 NIL) (|j| NIL) (|n| (|Integer|)) (#5=#:G533 NIL)
          (|psum| (|Integer|)) (#6=#:G515 NIL) (|maxix| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |CARTEN;ravel;%L;8| ((|x| (%)) (% (|List| R)))
        (SPROG ((#1=#:G541 NIL) (|i| NIL) (#2=#:G540 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |i| 0)
...
(SDEFUN |CARTEN;unravel;L%;9| ((|l| (|List| R)) (% (%)))
        (SPROG
         ((#1=#:G546 NIL) (|i| NIL) (#2=#:G547 NIL) (|r| NIL) (|z| (%))
...
(SDEFUN |CARTEN;kroneckerDelta;%;10| ((% (%)))
        (SPROG ((#1=#:G552 NIL) (|i| NIL) (#2=#:G553 NIL) (|zi| NIL) (|z| (%)))
               (SEQ
                (LETT |z|
...
(SDEFUN |CARTEN;leviCivitaSymbol;%;11| ((% (%)))
        (SPROG
         ((#1=#:G558 NIL) (|i| NIL) (|indv| (|Vector| (|Integer|))) (|z| (%))
          (|nz| (|NonNegativeInteger|)))
...
(SDEFUN |CARTEN;elt;%LR;19| ((|x| (%)) (|i| (|List| (|Integer|))) (% (R)))
        (SPROG
         ((|n| (|Integer|)) (|ix| (|Integer|)) (#1=#:G578 NIL) (|ii| NIL))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;coerce;L%;20| ((|lr| (|List| R)) (% (%)))
        (SPROG ((#1=#:G584 NIL) (|r| NIL) (#2=#:G585 NIL) (|i| NIL) (|z| (%)))
               (SEQ
                (COND
...
(SDEFUN |CARTEN;coerce;L%;21| ((|lx| (|List| %)) (% (%)))
        (SPROG
         ((#1=#:G600 NIL) (|i| NIL) (#2=#:G598 NIL) (|x| NIL) (#3=#:G599 NIL)
          (|offz| NIL) (|z| (%)) (|nx| (|NonNegativeInteger|)) (#4=#:G596 NIL)
          (#5=#:G597 NIL) (|rx| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;mkOutf|
        ((|x| (%)) (|i0| (|Integer|)) (|rnk| (|NonNegativeInteger|))
         (% (|OutputForm|)))
        (SPROG
         ((#1=#:G625 NIL) (|j| NIL) (#2=#:G624 NIL) (#3=#:G623 NIL) (|i| NIL)
          (#4=#:G622 NIL) (|nskip| (|NonNegativeInteger|))
          (|rnk1| (|NonNegativeInteger|)) (#5=#:G621 NIL) (#6=#:G620 NIL))
         (SEQ
          (COND
           ((ODDP |rnk|)
            (SEQ (LETT |rnk1| (- |rnk| 1))
...
(SDEFUN |CARTEN;coerce;Dp%;28| ((|v| (|DirectProduct| |dim| R)) (% (%)))
        (SPROG ((#1=#:G634 NIL) (|i| NIL) (#2=#:G635 NIL) (|j| NIL) (|z| (%)))
               (SEQ
                (LETT |z|
                      (SPADCALL (QREFELT % 7) (|spadConstant| % 32)
                                (QREFELT % 33)))
...
(SDEFUN |CARTEN;coerce;Sm%;29| ((|m| (|SquareMatrix| |dim| R)) (% (%)))
        (SPROG
         ((|offz| (|NonNegativeInteger|)) (#1=#:G644 NIL) (|j| NIL)
          (#2=#:G643 NIL) (|i| NIL) (|z| (%)))
         (SEQ
          (LETT |z|
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |x| |i| (QREFELT % 29))
                                       ...
                                       (QREFELT % 74))
                             (PROGN (LETT #1# NIL) (GO #3=#:G650))))))
                         (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL))
                    (EXIT 'T)))))
                #3# (EXIT #1#)))) 

(SDEFUN |CARTEN;+;3%;31| ((|x| (%)) (|y| (%)) (% (%)))
        (SPROG ((#1=#:G658 NIL) (|i| NIL) (|z| (%)))
               (SEQ
                (COND
                 ((SPADCALL (SPADCALL |x| (QREFELT % 28))
                            (SPADCALL |y| (QREFELT % 28)) (QREFELT % 22))
...
(SDEFUN |CARTEN;product;3%;38| ((|x| (%)) (|y| (%)) (% (%)))
        (SPROG
         ((#1=#:G698 NIL) (|j| NIL) (#2=#:G696 NIL) (|i| NIL) (#3=#:G697 NIL)
...
(SDEFUN |CARTEN;contract;%2I%;40|
        ...
        (SPROG
         ((#3=#:G721 NIL) (|k| NIL) (#4=#:G722 NIL) (|xk| NIL) (#5=#:G718 NIL)
          (|l| NIL) (#6=#:G719 NIL) (|xl| NIL) (#7=#:G720 NIL) (|zl| NIL)
          (#8=#:G715 NIL) (|m| NIL) (#9=#:G716 NIL) (|xm| NIL) (#10=#:G717 NIL)
          (|zm| NIL) (#11=#:G712 NIL) (|h| NIL) (#12=#:G713 NIL) (|xh| NIL)
          (#13=#:G714 NIL) (|zh| NIL) (|z| (%))
...
(SDEFUN |CARTEN;contract;%I%I%;41|
        ...
        (SPROG
         ((#1=#:G748 NIL) (|k| NIL) (#2=#:G749 NIL) (|xk| NIL) (#3=#:G750 NIL)
          (|yk| NIL) (#4=#:G745 NIL) (|dyl| NIL) (#5=#:G746 NIL) (|yl| NIL)
          (#6=#:G747 NIL) (|zly| NIL) (#7=#:G742 NIL) (|dyh| NIL)
          (#8=#:G743 NIL) (|yh| NIL) (#9=#:G744 NIL) (|zhy| NIL)
          (#10=#:G739 NIL) (|dxl| NIL) (#11=#:G740 NIL) (|xl| NIL)
          (#12=#:G741 NIL) (|zlx| NIL) (#13=#:G736 NIL) (|dxh| NIL)
          (#14=#:G737 NIL) (|xh| NIL) (#15=#:G738 NIL) (|zhx| NIL) (|z| (%))
...
(SDEFUN |CARTEN;transpose;%2I%;43|
        ((|x| (%)) (|i| #1=(|Integer|)) (|j| #2=(|Integer|)) (% (%)))
        (SPROG
         ((#3=#:G773 NIL) (|q| NIL) (#4=#:G774 NIL) (|zq| NIL) (#5=#:G775 NIL)
          (|xq| NIL) (#6=#:G770 NIL) (|p| NIL) (#7=#:G771 NIL) (|zp| NIL)
          (#8=#:G772 NIL) (|xp| NIL) (#9=#:G768 NIL) (|l| NIL) (#10=#:G769 NIL)
          (|zl| NIL) (#11=#:G766 NIL) (|m| NIL) (#12=#:G767 NIL) (|zm| NIL)
          (#13=#:G764 NIL) (|h| NIL) (#14=#:G765 NIL) (|zh| NIL) (|z| (%))
...
(DEFUN |CartesianTensor| (&REST #1=#:G782)
  (SPROG NIL
         (PROG (#2=#:G783)
           (RETURN
            (COND
