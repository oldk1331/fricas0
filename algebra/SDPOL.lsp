...
(DEFUN |SequentialDifferentialPolynomial| (#1=#:G503)
  (SPROG NIL
         (PROG (#2=#:G504)
           (RETURN
            (COND
...
(DEFUN |SequentialDifferentialPolynomial;| (|#1|)
  (SPROG
   ((#1=#:G502 NIL) (|pv$| NIL) (#2=#:G495 NIL) (#3=#:G496 NIL) (#4=#:G497 NIL)
    (#5=#:G498 NIL) (#6=#:G499 NIL) (#7=#:G500 NIL) (#8=#:G501 NIL) (% NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|SequentialDifferentialPolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|NonNegativeInteger|) (|SequentialDifferentialVariable| 34)
