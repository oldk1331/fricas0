...
(SDEFUN |SIGNEF;sign;FU;3| ((|f| (F)) (% (|Union| (|Integer|) #1="failed")))
        (SPROG
         ((#2=#:G532 NIL) (|r| (|Union| (|Interval| (|Float|)) "failed"))
          (|f2| (|Expression| (|Interval| (|Float|))))
          (|f2u| (|Union| (|Expression| (|Interval| (|Float|))) "failed"))
          (|mapfun| (|Mapping| (|Interval| (|Float|)) R)) (#3=#:G531 NIL)
              ...
              (EXIT
               (COND
                ((|eql_SI| |n| 0)
                 (SEQ
                  (LETT |u|
                        (SPADCALL (SPADCALL |a| (QREFELT % 50))
                                  (QREFELT % 52)))
                  (EXIT
                   (COND ((QEQCAR |u| 1) (CONS 1 "failed"))
                         (#1='T
                          (CONS 0 (SPADCALL (QCDR |u|) (QREFELT % 55))))))))
                ((SPADCALL |n| 0 (QREFELT % 56))
                 (CONS 0 (SPADCALL (QREFELT % 57))))
                (#1# (CONS 0 (SPADCALL (QREFELT % 58))))))))) 
        ...
        (SPROG ((|n| (|Integer|)))
               (COND
                ((SPADCALL (LETT |n| (SPADCALL |a| (QREFELT % 48))) 0
                           (QREFELT % 60))
                 (CONS 0 |n|))
                ('T (SPADCALL (SPADCALL |a| (QREFELT % 50)) (QREFELT % 46)))))) 

(SDEFUN |SIGNEF;insign|
        ((|f| (F)) (|x| (|Symbol|)) (|a| (|OrderedCompletion| F))
         (|m| (|NonNegativeInteger|)) (% (|Union| (|Integer|) #1="failed")))
        (SPROG
         ((|ur| #2=(|Union| (|Integer|) #1#)) (#3=#:G567 NIL) (|ul| #2#)
          ...
          (|u|
           (|Union| (|OrderedCompletion| F)
                    ...
                    "failed"))
          (|eq| (|Equation| (|OrderedCompletion| F))) (#5=#:G576 NIL)
          (|ua|
           (|Union| (|OrderedCompletion| (|Fraction| (|Polynomial| R)))
                    "failed"))
          ...
          (COND ((> |m| 10) (CONS 1 "failed"))
                (#6='T
                 (SEQ
                  (EXIT
                   (SEQ
                    (SEQ (LETT |uf| (SPADCALL |f| (QREFELT % 52)))
                         (EXIT
                          (COND
                           ((QEQCAR |uf| 0)
                    ...
                    (LETT |eq|
                          (SPADCALL
                           (SPADCALL (SPADCALL |x| (QREFELT % 63))
                                     (QREFELT % 64))
                           |a| (QREFELT % 66)))
                    (LETT |u| (SPADCALL |f| |eq| (QREFELT % 71)))
                    (EXIT
                     (COND ((QEQCAR |u| 2) (CONS 1 "failed"))
                           ((QEQCAR |u| 0)
                            (COND
                             ...
                             (#6#
                              (SEQ
                               (LETT |v| (SPADCALL (QCDR |u|) (QREFELT % 50)))
                               (EXIT
                                (COND
                                 ((SPADCALL |v| (|spadConstant| % 72)
                                            (QREFELT % 73))
                                  (SEQ
                                   (LETT |s|
                                         (|SIGNEF;insign|
...
(SDEFUN |SIGNEF;psign|
        ...
        (SPROG
         ((|s| (|Union| (|Integer|) #1#)) (|v| (F)) (|n| (|Integer|))
          ...
          (|eq| (|Equation| F)) (#2=#:G593 NIL)
          (|ua| #3=(|Union| (|Fraction| (|Polynomial| R)) "failed"))
          (|uf| #3#))
         (SEQ
          (COND ((> |m| 10) (CONS 1 "failed"))
                ((SPADCALL |f| (|spadConstant| % 72) (QREFELT % 73))
                 (CONS 0 0))
                (#4='T
                 (SEQ
                  (EXIT
                   (SEQ
                    (SEQ (LETT |uf| (SPADCALL |f| (QREFELT % 52)))
                         (EXIT
                          (COND
                           ((QEQCAR |uf| 0)
                            (SEQ (LETT |ua| (SPADCALL |a| (QREFELT % 52)))
                                 (EXIT
                                  (COND
                                   ((QEQCAR |ua| 0)
                                    (PROGN
...
(SDEFUN |SIGNEF;smpsign2|
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| F)))
         (% (|Union| (|Integer|) "failed")))
        (SPROG
         ((|ans| (|Integer|)) (#1=#:G608 NIL)
          (|u| (|Union| (|Integer|) "failed")) (#2=#:G609 NIL) (|term| NIL)
...
(SDEFUN |SIGNEF;listSign|
        ...
        (SPROG
         ((#2=#:G633 NIL) (#3=#:G634 NIL) (|u| (|Union| (|Integer|) #1#))
          (#4=#:G635 NIL) (|term| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |term| NIL) (LETT #4# |l|) G190
                 ...
                 (SEQ (LETT |u| (|SIGNEF;termSign| |term| %))
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #3# (CONS 1 "failed")) (GO #5=#:G632)))
                        ('T
                         (SEQ
                          (EXIT
                           (COND
...
(SDEFUN |SIGNEF;termSign|
        ((|term| (|SparseMultivariatePolynomial| R (|Kernel| F)))
         (% (|Union| (|Integer|) #1="failed")))
        (SPROG
         ((#2=#:G646 NIL) (#3=#:G647 NIL) (#4=#:G645 NIL)
          (|vs| (|Union| (|Integer|) #1#)) (#5=#:G648 NIL)
...
(DEFUN |ElementaryFunctionSign| (&REST #1=#:G673)
  (SPROG NIL
         (PROG (#2=#:G674)
           (RETURN
            (COND
...
(MAKEPROP '|ElementaryFunctionSign| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) (|Boolean|)
              ...
              (|Union| 59 '#1="failed") (|Symbol|) (|OrderedCompletion| 7)
              ...
              (96 . |Zero|) (100 . |retract|) (|Union| 53 '"failed")
              (105 . |retractIfCan|) (|Fraction| (|Polynomial| 6))
              (|OrderedCompletion| 53) (110 . |coerce|) (115 . >)
              (121 . |plusInfinity|) (125 . |minusInfinity|) (|Integer|)
              (129 . ~=) (|RationalFunctionSign| 6) (135 . |sign|)
              (142 . |coerce|) (147 . |coerce|) (|Equation| 13)
              (152 . |equation|) (|Union| 13 '"failed")
              (|Record| (|:| |leftHandLimit| 67) (|:| |rightHandLimit| 67))
              (|Union| 13 68 '"failed") (|PowerSeriesLimitPackage| 6 7)
              (158 . |limit|) (164 . |Zero|) (168 . =) (174 . |differentiate|)
              (180 . |sign|) (|Equation| 7) (188 . |equation|) (194 . |limit|)
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 129
                                            '(1 9 8 7 10 1 7 17 0 18 1 7 17 0
                                              ...
                                              47 0 48 0 6 0 49 1 13 7 0 50 1 7
                                              51 0 52 1 54 0 53 55 2 47 8 0 0
                                              56 0 54 0 57 0 54 0 58 2 59 8 0 0
                                              60 3 61 11 53 12 54 62 1 7 0 12
                                              63 1 13 0 7 64 2 65 0 13 13 66 2
                                              70 69 7 65 71 0 7 0 72 2 7 8 0 0
                                              73 2 7 0 0 12 74 4 61 11 53 12 53
                                              15 75 2 76 0 7 7 77 3 70 67 7 76
                                              15 78 1 79 59 15 80 1 82 81 0 83
                                              ...
                                              126 1 125 7 0 127 1 7 59 0 128 2
