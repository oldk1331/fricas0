...
(SDEFUN |RDEEFX;top_kernel|
        ...
        (SPROG
         ((|extra_tk| (|Boolean|)) (|tk| (|Kernel| F)) (#1=#:G675 NIL)
          (|htk| #2=(|NonNegativeInteger|)) (|hk| #2#) (#3=#:G676 NIL)
                 ...
                 (SEQ (LETT |hk| (SPADCALL |k| (QREFELT % 19)))
                      (EXIT
                       (COND
                        ...
                        ((< |hk| |htk|)
                         (PROGN (LETT #1# |$NoValue|) (GO #4=#:G648)))
                        ('T
                         (SEQ
                          (COND
...
(SDEFUN |RDEEFX;genus0_if_can|
        ...
        (SPROG
         ((|c1| (|Fraction| (|SparseUnivariatePolynomial| F))) (|d| (F))
          ...
          (|n| (|NonNegativeInteger|)) (#1=#:G682 NIL) (|args| (|List| F)))
         (SEQ
          (COND
...
(SDEFUN |RDEEFX;get_uv0|
        ...
        (SPROG
         ((|kc| #1=(|Integer|)) (#2=#:G723 NIL) (|vi| NIL) (#3=#:G724 NIL)
          (|ki| NIL) (|kf| (F)) (|u| (F)) (#4=#:G721 NIL) (|ui| NIL)
          (#5=#:G722 NIL) (#6=#:G720 NIL) (|ku| #1#) (#7=#:G718 NIL)
          (#8=#:G719 NIL) (|v0| (F)) (#9=#:G716 NIL) (#10=#:G717 NIL)
          (#11=#:G715 NIL))
         (SEQ
          (LETT |v0|
                (SPADCALL |tt|
...
(SDEFUN |RDEEFX;get_uv|
        ...
        (SPROG
         ((|d| #1=(|Integer|))
          ...
          (|dvvec| (|Vector| F)) (#2=#:G738 NIL) (|vi| NIL) (#3=#:G737 NIL))
         (SEQ
          (LETT |dvvec|
                (SPADCALL
                 (PROGN
        ...
        ((|gd| (|SparseUnivariatePolynomial| F))
         ...
         (%
          (|Union|
           ...
           "failed")))
        (SPROG
         ((|ff1| #1=(|SparseUnivariatePolynomial| F)) (#2=#:G759 NIL)
          (|ff3| (|SparseUnivariatePolynomial| F)) (#3=#:G748 NIL) (|ff2| #1#)
           ...
           (SEQ (LETT |deg1| (SPADCALL |f1| (QREFELT % 40)))
                ...
                (COND
                 ((NULL
                  ...
                  (EXIT (PROGN (LETT #2# (CONS 1 "failed")) (GO #6=#:G758)))))
         ...
         ((#1=#:G768 NIL) (#2=#:G789 NIL) (|i| NIL)
          ...
          (|#G54|
           (|Record| (|:| |coef1| #6#) (|:| |coef2| #5#)
                     (|:| |generator| #4#)))
          (|ki1| (|Integer|)) (#7=#:G785 NIL) (|di2| (|Integer|))
          (|di1| (|Integer|)) (#8=#:G786 NIL) (|bi| #9=(|Integer|)) (|ai| #9#)
          (#10=#:G788 NIL) (#11=#:G787 NIL) (|n| (|NonNegativeInteger|))
...
(SDEFUN |RDEEFX;lin_args|
        ...
        (SPROG
         ((|res|
          ...
          (|vecf| (|Vector| F)) (|dv0| (F)) (|dvs| (|List| F)) (#4=#:G829 NIL)
          (|v| NIL) (#5=#:G828 NIL) (|dv1| (F)) (#6=#:G823 NIL)
          ...
          (|deg1| (|NonNegativeInteger|)) (#8=#:G827 NIL) (|fac| NIL)
          (|ulst1| (|List| F)) (|vlst1| (|List| F)) (|u0| (F)) (#9=#:G825 NIL)
          (#10=#:G826 NIL) (|u| NIL) (|v0| (F)) (|a0| (F)) (|a1| (F))
                        ...
                        (EXIT
                         (SEQ (LETT |f1| (QVELT |fac| 1))
                              ...
                              (EXIT
                               (COND
                                ((EQL |deg1| 0)
                                 (PROGN (LETT #2# |$NoValue|) (GO #12=#:G795)))
                                ('T
                                 (SEQ
                                  (LETT |f1|
                                        (SPADCALL |f1|
...
(SDEFUN |RDEEFX;solve_poly_eqs|
        ...
        (SPROG
         ((|res|
          ...
          (|val2eq| (|Polynomial| F)) (#1=#:G870 NIL) (|val1r| NIL)
          (|eq1| (|Equation| (|Fraction| (|Polynomial| F))))
          (|eq0p| (|Polynomial| F))
          (|eq0| (|Equation| (|Fraction| (|Polynomial| F)))) (#2=#:G869 NIL)
          (|sol0| NIL)
          (|lsol0|
           (|List| (|List| (|Equation| (|Fraction| (|Polynomial| F))))))
          (#3=#:G868 NIL) (|ci| NIL) (#4=#:G867 NIL)
          (|eqs0| (|List| (|Polynomial| F))) (#5=#:G866 NIL) (|eqi| NIL)
          (#6=#:G865 NIL) (|k2| #7=(|Kernel| F)) (|k1| #7#))
         (SEQ (LETT |k1| (SPADCALL |s1| (QREFELT % 57)))
         ...
         ((|res|
           (|List|
            (|Record| (|:| |factor| (|SparseUnivariatePolynomial| F))
                      ...
                      (|:| |u_part| F) (|:| |exponent| (|Integer|))
                      (|:| |shift_part| F))))
          (#1=#:G900 NIL) (|dega| (|Integer|))
          (|fac| (|SparseUnivariatePolynomial| F))
          (|ap| (|SparseUnivariatePolynomial| F)) (#2=#:G909 NIL)
          (|res1l|
           (|List|
            (|Record| (|:| |factor| (|SparseUnivariatePolynomial| F))
                      (|:| |ratpart| (|Integer|)) (|:| |v_part| F)
          ...
          (#4=#:G901 NIL) (|ru| (|Union| (|Integer|) "failed")) (#5=#:G908 NIL)
          ...
          (|res1|
           (|Union|
            (|Record| (|:| |factor| (|SparseUnivariatePolynomial| F))
                      ...
                      (|:| |shift_part| F))
            "failed"))
          (#8=#:G907 NIL) (|sol| NIL) (|r_bad| (|Integer|))
          ...
          (|lsol|
           (|List|
            (|Record| (|:| |ratpart| (|Fraction| (|Integer|)))
                      (|:| |alg_part| (|SparseUnivariatePolynomial| F)))))
          (|eqs0| (|List| F)) (#9=#:G906 NIL) (|ci| NIL) (#10=#:G905 NIL)
          (|qq| (|SparseUnivariatePolynomial| F)) (|b| #11=(|Kernel| F))
          (|bs| #12=(|Symbol|)) (|a| #11#) (|as| #12#) (|u0| (F))
          (|ulst| (|List| F)) (|vlst| (|List| F)) (#13=#:G903 NIL) (|v| NIL)
          (#14=#:G904 NIL) (|u| NIL) (|kf| (F)))
                    ...
                    (EXIT
                     (SEQ (LETT |ru| (SPADCALL (QCAR |sol|) (QREFELT % 191)))
                          (EXIT
                           (COND
                            ((QEQCAR |ru| 1)
                             (PROGN (LETT #7# |$NoValue|) (GO #15=#:G885)))
                            ('T
                             (SEQ
                              (COND
                               (|has_r_bad|
                    ...
                    (EXIT
                     (SEQ (LETT |ru| (SPADCALL |r0| (QREFELT % 191)))
                          (EXIT
                           (COND
                            ((QEQCAR |ru| 1)
                             (PROGN (LETT #4# |$NoValue|) (GO #16=#:G891)))
                            ('T
                             (SEQ (LETT |ri| (QCDR |ru|))
                                  (LETT |nn|
                                        (SPADCALL |nf|
          ...
          (|resu|
           (|Union|
            (|Record| (|:| |factor| (|SparseUnivariatePolynomial| F))
                      ...
                      (|:| |shift_part| F))
            "failed"))
          (#1=#:G919 NIL) (|deg1| (|NonNegativeInteger|))
          (|f1| #2=(|SparseUnivariatePolynomial| F)) (#3=#:G920 NIL)
          (|fac| NIL)
          (|rfac|
           (|List|
                    ...
                    (EXIT
                     (SEQ (LETT |f1| (QVELT |fac| 1))
                          ...
                          (EXIT
                           (COND
                            ((EQL |deg1| 0)
                             (PROGN (LETT #1# |$NoValue|) (GO #4=#:G913)))
                            ('T
                             (SEQ
                              (LETT |resu|
                                    (|RDEEFX;handle_factor| |gd| |nf| |denf|
          ...
          (|uvu|
           (|Union|
            (|Record| (|:| |u_part| F) (|:| |v_part| F)
                      (|:| |exponent| (|Integer|)) (|:| |coeff| (|Integer|)))
            "failed"))
          (#3=#:G970 NIL) (#4=#:G990 NIL) (|e1| NIL) (#5=#:G991 NIL)
          (|fac1| NIL) (#6=#:G989 NIL)
          (|lexp1| (|List| (|NonNegativeInteger|))) (#7=#:G964 NIL)
          (#8=#:G988 NIL) (#9=#:G987 NIL) (|l1| (|Integer|))
          (|lexp| (|List| (|Integer|))) (#10=#:G986 NIL) (#11=#:G985 NIL)
          (|nffacs|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| (|SparseUnivariatePolynomial| F))
...
(SDEFUN |RDEEFX;solve_for_ratios| ((|lc| (|List| F)) (% (|List| (|Integer|))))
        (SPROG
         ((|rl| (|List| (|Integer|))) (|li| (|Integer|))
          ...
          (|d| (|Integer|)) (#2=#:G1023 NIL) (#3=#:G1022 NIL)
          ...
          (|res|
           (|Record|
            ...
            (|:| |basis| #4#)))
          (|v0| (|Vector| F)) (#5=#:G1020 NIL) (#6=#:G1021 NIL) (|c| NIL)
          (|m| (|Matrix| F)) (|nn1| (|NonNegativeInteger|)) (#7=#:G1000 NIL)
          (|nlc| (|List| F)) (|c1| (F)) (#8=#:G1019 NIL) (#9=#:G1018 NIL)
          (|n1| #10=(|NonNegativeInteger|)) (#11=#:G1016 NIL) (#12=#:G1017 NIL)
...
(SDEFUN |RDEEFX;possible_sk|
        ...
        (SPROG
         ((|nwu| #1=(|SparseUnivariatePolynomial| F))
          (|dnw| #2=(|NonNegativeInteger|)) (|ss| (|Integer|)) (#3=#:G1053 NIL)
          ...
          (|vq| (|Vector| (|Fraction| (|Integer|)))) (#6=#:G1025 NIL)
...
(SDEFUN |RDEEFX;possible_w|
        ...
        (SPROG
         ((|w2| (F)) (#1=#:G1071 NIL) (|lc_nw1| (F)) (|lc_nf2| (F))
          (|w2u2| (|Union| F "failed"))
         ...
         (%
          (|List|
           (|Record| (|:| |degree| (|Integer|))
                     ...
                     (|:| |shift_part| F) (|:| |a_val| F)))))
        (SPROG
         ((|uu| (F)) (|ai| (F)) (#1=#:G1110 NIL) (|i| NIL) (|tt| (F))
          (#2=#:G1107 NIL) (|li| NIL) (#3=#:G1108 NIL) (|vi| NIL)
          (#4=#:G1109 NIL) (|ui| NIL) (|uu1| (F)) (#5=#:G1105 NIL) (|ki| NIL)
          (#6=#:G1106 NIL) (|gl| (|Integer|)) (|vli| #7=(|List| (|Integer|)))
          (|d| #8=(|Integer|))
          (|cd| (|Record| (|:| |num| #7#) (|:| |den| #8#)))
          (|sv| (|Vector| (|Fraction| (|Integer|))))
          (|su| (|Union| (|Vector| (|Fraction| (|Integer|))) "failed"))
          (|w_cor| (F)) (#9=#:G1101 NIL) (#10=#:G1102 NIL) (|k2i| NIL)
          (#11=#:G1103 NIL) (#12=#:G1104 NIL) (|coeffs2| #7#)
          (|wu| (|Fraction| (|SparseUnivariatePolynomial| F))) (|w| (F))
          (|a1| (F)) (|coeffs| #7#) (|dvvec| (|Vector| F)) (#13=#:G1100 NIL)
          (#14=#:G1099 NIL) (|v'| (F)) (|lw2'| (F)) (|w2| (F))
          (|lw2| (|List| F)))
...
(SDEFUN |RDEEFX;irrational_gamma_candidates|
        ...
        (SPROG
         ((|w1| (F)) (|a| (F)) (|km| #1=(|Integer|)) (|s| #1#) (|kmq| NIL)
          ...
          (|#G211| #2#) (#3=#:G1149 NIL) (|sk| NIL) (|lsk| (|List| #2#))
          (|tk| (|Kernel| F)) (|w0| (F)) (|ak| (F)) (#4=#:G1147 NIL) (|li| NIL)
          (#5=#:G1148 NIL) (|kk| NIL) (|rl| (|List| (|Integer|)))
          (|cl| (|List| F)) (#6=#:G1143 NIL) (|f2| (F)) (|ck| (F))
          (|nf1| (|SparseUnivariatePolynomial| F))
          (|nfr| (|Fraction| (|SparseUnivariatePolynomial| F)))
          (#7=#:G1146 NIL) (|f| (F)) (|nlk| (|List| (|Kernel| F)))
          (#8=#:G1145 NIL) (#9=#:G1144 NIL) (|n1| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |RDEEFX;gammas1|
        ...
        (SPROG
         ((|fnf| (|Factored| (|SparseUnivariatePolynomial| F)))
          ...
          (#1=#:G1167 NIL) (|f2| (|SparseUnivariatePolynomial| F)) (|tt| (F))
          (|deg1| (|NonNegativeInteger|))
          (|f1| #2=(|SparseUnivariatePolynomial| F)) (#3=#:G1168 NIL)
          (|fac| NIL) (|e_tt| (|List| F))
          (|rfacs|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                              ...
                              (EXIT
                               (COND
                                ((< (* 2 (QVELT |fac| 2))
                                 ...
                                 (PROGN (LETT #1# |$NoValue|) (GO #5=#:G1156)))
                                ('T
                                 (SEQ
...
(SDEFUN |RDEEFX;special_candidates|
        ...
        (SPROG
         ((|res1|
          ...
          (#2=#:G1193 NIL) (|ru| (|Union| (|Integer|) "failed"))
          (#3=#:G1196 NIL) (|sol| NIL)
          (|lsol|
           (|List|
            (|Record| (|:| |ratpart| (|Fraction| (|Integer|)))
          ...
          (|bs| #5=(|Symbol|)) (#6=#:G1192 NIL) (#7=#:G1195 NIL) (|r0| NIL)
          ...
          (|n1| #10=(|NonNegativeInteger|)) (|a| (|Integer|)) (#11=#:G1194 NIL)
                      ...
                      ((EQL |n1| (+ |n2| 1))
                       (COND
                        ((NULL (SPADCALL |k| '|log| (QREFELT % 22)))
                         (PROGN (LETT #11# |res1|) (GO #13=#:G1191)))
                        ('T
                         (SEQ (LETT |lc| (SPADCALL |nf| (QREFELT % 103)))
                              (LETT |rcu| (SPADCALL |lc| (QREFELT % 133)))
                              (EXIT
        ...
        ((|rr1f| (F)) (|csol| (|Vector| F)) (|a1p| (F)) (|as| (|Vector| F))
         ...
         (%
          (|Record| (|:| |ans| F) (|:| |right| F) (|:| |primpart| F)
                    (|:| |sol?| (|Boolean|)))))
        (SPROG
         ((|cand_prims| (|List| F)) (|ansp| (F)) (#1=#:G1204 NIL) (|i| NIL))
...
(SDEFUN |RDEEFX;exp_lower_bound|
        ...
        (SPROG
         ((|min_deg| (|Integer|)) (|max_deg| (|Integer|))
          (|c_degs| (|List| (|NonNegativeInteger|))) (#1=#:G1225 NIL)
          (|scoeff| NIL) (#2=#:G1224 NIL)
         ...
         ((|as| (|Vector| F))
          ...
          (|partu|
           (|Union| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))
                    "failed"))
          (|g1| (F)) (|lg1| (|List| F)) (#1=#:G1236 NIL) (|scoeff| NIL)
          (#2=#:G1235 NIL))
         (SEQ
          (LETT |lg1|
                (PROGN
...
(SDEFUN |RDEEFX;special_integrate1|
        ...
        (SPROG
         ((|res3|
          ...
          (|res2|
           (|Record| (|:| |ans| F) (|:| |defect| F) (|:| |sol?| (|Boolean|))))
          (#2=#:G1266 NIL) (|scoeff| NIL) (#3=#:G1267 NIL) (|i| NIL)
          (|as| #4=(|Vector| F)) (|vs| #4#) (|rr1f| (F)) (|a1p| (F))
          (|inv_den1| (F)) (|nfp1| #1#) (|ak| (F)) (#5=#:G1265 NIL)
          (#6=#:G1264 NIL) (|mm| (|SparseUnivariatePolynomial| F))
          (#7=#:G1251 NIL) (|neg_deg| (|Integer|)) (|eta| (F))
          (#8=#:G1247 NIL))
         (SEQ
          (LETT |neg_deg|
                (COND
...
(SDEFUN |RDEEFX;mk_pow|
        ...
        (SPROG
         ((|res2| (F)) (|lp| (|List| F)) (#1=#:G1290 NIL) (|ui| NIL) (|i| NIL)
          (#2=#:G1289 NIL) (|res| (F)))
         (SEQ
          (LETT |res|
        ...
        ((|nf| (|SparseUnivariatePolynomial| F))
         ...
         (%
          (|Record| (|:| |ans| F) (|:| |right| F) (|:| |primpart| F)
                    (|:| |sol?| (|Boolean|)))))
        (SPROG
         ((|as| (|Vector| F)) (|vc| #1=(|Vector| F)) (#2=#:G1435 NIL)
          (|ci| NIL) (#3=#:G1434 NIL)
          (|cndl|
           (|List|
            (|Record| (|:| |degree| (|Integer|))
                      ...
                      (|:| |u_part| F) (|:| |exponent| (|Integer|))
                      (|:| |shift_part| F) (|:| |a_val| F))))
          (|rr| (|Integer|)) (|ii| (|Integer|)) (#4=#:G1433 NIL)
          (|cil| (|List| (|List| F)))
          ...
          (|rcu| (|Union| (|Integer|) #5="failed")) (#6=#:G1420 NIL)
          (|sol0| (|Vector| (|Integer|))) (#7=#:G1385 NIL)
          (|sol_rec|
           (|Record|
          ...
          (|m1| (|Matrix| F)) (#11=#:G1432 NIL) (|v| NIL) (#12=#:G1431 NIL)
          (|lv| (|List| F)) (|c2| (F)) (|c1| (F)) (|c0| (F)) (|r4| (F))
          (|ulst1| (|List| F)) (|vlst1| (|List| F)) (#13=#:G1429 NIL)
          (#14=#:G1430 NIL) (|u| NIL) (|phi| (F)) (|piv| (F)) (|kf| (F))
          (|unG| (R)) (G (F))
          (|G_num| #15=(|SparseMultivariatePolynomial| R (|Kernel| F)))
          (|G_den| #15#)
          (|fl2| (|List| #16=(|SparseMultivariatePolynomial| R (|Kernel| F))))
          (#17=#:G1428 NIL) (|fac| NIL) (#18=#:G1427 NIL) (|fl1| (|List| #16#))
          (#19=#:G1320 NIL) (#20=#:G1426 NIL) (#21=#:G1425 NIL)
          (|uv0|
           (|Record| (|:| |u_part| F) (|:| |v_part| F)
                     (|:| |exponent| (|Integer|)) (|:| |coeff| (|Integer|))))
          (|uvu0|
          ...
          (#22=#:G1424 NIL) (#23=#:G1423 NIL) (#24=#:G1422 NIL)
          (#25=#:G1421 NIL)
          (|f_numr|
...
(SDEFUN |RDEEFX;decompose1|
        ...
        (SPROG
         ((|res| (|List| (|SparseUnivariatePolynomial| F)))
          (|f1| (|SparseUnivariatePolynomial| F)) (#1=#:G1439 NIL))
         (SEQ
          (LETT |f1|
                (PROG2
                    (LETT #1#
...
(SDEFUN |RDEEFX;solve_factor1|
        ...
        (SPROG
         ((|poly_cor| (|SparseUnivariatePolynomial| F))
          ...
          (|lp_cor| #1#) (|ansp| (F)) (#2=#:G1477 NIL) (|zz| NIL)
          ...
          (|denf1| (|SparseUnivariatePolynomial| F)) (#5=#:G1451 NIL)
                ...
                (SEQ G190 NIL
                     (SEQ (LETT |nqu| (SPADCALL |q| |p| (QREFELT % 107)))
                          (EXIT
                           (COND
                            ((QEQCAR |nqu| 1)
                             (PROGN (LETT #1# |$NoValue|) (GO #2=#:G1484)))
                            ('T
                             (SEQ (LETT |q| (QCDR |nqu|))
                                  (EXIT (LETT |nn| (+ |nn| 1))))))))
                     NIL (GO G190) G191 (EXIT NIL)))
...
(SDEFUN |RDEEFX;solve_linear_factor|
        ...
        (SPROG
         ((|dvr2|
          ...
          (|kif| (F)) (#4=#:G1519 NIL) (|ck| NIL) (|zzl| (|List| F))
         ...
         ((|poly_cor| (|SparseUnivariatePolynomial| F))
          ...
          (|ar1|
           (|Record| (|:| |primpart| F)
                     ...
                     (|:| |specpart|
                          (|Fraction| (|SparseUnivariatePolynomial| F)))))
          (#2=#:G1532 NIL) (|einum| NIL) (#3=#:G1533 NIL) (|er| NIL)
          (|einums| (|List| (|SparseUnivariatePolynomial| F)))
          (|eidens| (|List| (|SparseUnivariatePolynomial| F))) (#4=#:G1531 NIL)
          (#5=#:G1530 NIL)
          (|al|
           (|List|
            (|Record| (|:| |factor| (|SparseUnivariatePolynomial| F))
...
(SDEFUN |RDEEFX;handle_nonlinear_log|
        ...
        (SPROG
         ((|ar1|
          ...
          (#1=#:G1567 NIL) (|er| NIL) (#2=#:G1566 NIL) (|r0| (|Integer|))
          (|er1|
           (|Record| (|:| |factor| (|SparseUnivariatePolynomial| F))
                     (|:| |ratpart| (|Integer|)) (|:| |v_part| F)
                     (|:| |alg_part| (|SparseUnivariatePolynomial| F))
          ...
          (|lei1|
           (|List|
            (|Record| (|:| |factor| (|SparseUnivariatePolynomial| F))
                      ...
                      (|:| |u_part| F) (|:| |exponent| (|Integer|))
                      (|:| |shift_part| F))))
          (#3=#:G1564 NIL) (|j| NIL) (#4=#:G1565 NIL)
          (|bpol| (|SparseUnivariatePolynomial| F))
          (|poly_cor| (|SparseUnivariatePolynomial| F))
          (|sp_cor| #5=(|Fraction| (|SparseUnivariatePolynomial| F)))
          (|lp_cor| #5#) (|ansp| (F)) (#6=#:G1561 NIL) (|einum| NIL)
          (#7=#:G1562 NIL) (#8=#:G1563 NIL)
          (|bpols| (|List| (|SparseUnivariatePolynomial| F)))
          (|j0| (|NonNegativeInteger|)) (#9=#:G1558 NIL) (|esum| (|Integer|))
          (#10=#:G1560 NIL) (#11=#:G1559 NIL) (|i| NIL)
         ...
         ((|poly_cor| (|SparseUnivariatePolynomial| F))
          ...
          (|ar1|
           (|Record| (|:| |primpart| F)
                     ...
                     (|:| |specpart|
                          (|Fraction| (|SparseUnivariatePolynomial| F)))))
          (#2=#:G1608 NIL) (|einum| NIL) (#3=#:G1609 NIL) (|er| NIL)
          (|einums| (|List| (|SparseUnivariatePolynomial| F)))
          ...
          (#6=#:G1605 NIL) (|i| NIL) (#7=#:G1606 NIL) (|eiden| NIL)
          (#8=#:G1607 NIL) (|n| (|NonNegativeInteger|))
          (|nidbl| (|List| (|Integer|)))
          (|ndbl| (|List| (|SparseUnivariatePolynomial| F)))
          (|bi| (|SparseUnivariatePolynomial| F)) (#9=#:G1604 NIL)
          (|m| (|NonNegativeInteger|)) (#10=#:G1601 NIL)
          (|lp| (|Fraction| (|SparseUnivariatePolynomial| F)))
          (|dr| (|Record| (|:| |basis| #5#) (|:| |transform| #4#)))
          (#11=#:G1603 NIL) (#12=#:G1602 NIL))
         (SEQ
          (COND
           ((SPADCALL |k| '|log| (QREFELT % 22))
            (COND
        ...
        ((|denf| #1=(|SparseUnivariatePolynomial| F)) (|k| (|Kernel| F))
         (%
          (|Record| (|:| |radicand| (|SparseUnivariatePolynomial| F))
                    (|:| |exponent| (|Integer|)))))
        (SPROG
         ((|gden1| (|SparseUnivariatePolynomial| F)) (#2=#:G1644 NIL)
          (#3=#:G1639 NIL) (#4=#:G1652 NIL) (|fac1| NIL) (#5=#:G1651 NIL)
          (|l1| (|Integer|)) (|lexp| (|List| (|Integer|))) (#6=#:G1650 NIL)
          (#7=#:G1649 NIL)
          (|nffacs|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
          ...
          (#8=#:G1613 NIL) (#9=#:G1611 NIL) (|s_deg| (|Integer|)))
...
(SDEFUN |RDEEFX;special_Hermite|
        ...
        (SPROG
         ((|mult| (|SparseUnivariatePolynomial| F))
          (|denr| #1=(|SparseUnivariatePolynomial| F)) (#2=#:G1660 NIL)
...
(SDEFUN |RDEEFX;ei_int_log|
        ...
        (SPROG
         ((|is_sol| (|Boolean|)) (|rh| (F)) (|r1| (F))
          ...
          (#1=#:G1678 NIL) (|k1| NIL) (#2=#:G1677 NIL) (|ngu| (F)))
         (SEQ
          (LETT |ngu|
...
(SDEFUN |RDEEFX;get_scoeff|
        ...
        (SPROG
         ((|gt| #2=(|Fraction| (|SparseUnivariatePolynomial| F)))
          ...
          (|l1| (|NonNegativeInteger|)) (#4=#:G1692 NIL) (|rf1k| (|Kernel| F))
          (|rfc| (F)) (|coeff1_r| #2#)
...
(SDEFUN |RDEEFX;get_prims|
        ...
        (SPROG
         ((|res| (|List| F)) (|f1| (F)) (#1=#:G1775 NIL) (|zz| NIL) (|f11| (F))
          ...
          (|l1| (|NonNegativeInteger|)) (#3=#:G1761 NIL) (|zzl| (|List| F))
...
(SDEFUN |RDEEFX;ei_int;I2FSR;58|
        ...
        (SPROG
         ((|res3|
          ...
          (|rr1f| (F)) (#4=#:G1869 NIL) (|aa| (F)) (|res7| #1#)
          (#5=#:G1870 NIL) (|ff| (F))
          ...
          (|ar1|
           (|Record| (|:| |primpart| F)
                     ...
                     (|:| |specpart|
                          (|Fraction| (|SparseUnivariatePolynomial| F)))))
          (|ulst| (|List| F)) (#10=#:G1879 NIL) (|kk| NIL) (#11=#:G1878 NIL)
          (|vlst| (|List| F)) (#12=#:G1877 NIL) (#13=#:G1876 NIL)
          (|lk1| (|List| (|Kernel| F))) (#14=#:G1875 NIL) (#15=#:G1874 NIL)
          ...
          (|fpu| #18#) (|lk| (|List| (|Kernel| F))) (#19=#:G1873 NIL)
          (#20=#:G1872 NIL) (|k| (|Kernel| F)) (|fp| (F)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |lk|
...
(DEFUN |ElementaryRischDEX| (&REST #1=#:G1880)
  (SPROG NIL
         (PROG (#2=#:G1881)
           (RETURN
            (COND
