...
(SDEFUN |CCLASS;convert;%L;14| ((|cl| (%)) (% (|List| (|Character|))))
        (SPROG ((#1=#:G466 NIL) (|i| NIL) (#2=#:G465 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |CCLASS;charClass;S%;15| ((|s| (|String|)) (% (%)))
        (SPROG ((|j| (|Integer|)) (#1=#:G472 NIL) (|i| NIL) (|cl| (%)))
...
(SDEFUN |CCLASS;charClass;L%;16| ((|l| (|List| (|Character|))) (% (%)))
        (SPROG ((|j| (|Integer|)) (#1=#:G478 NIL) (|c| NIL) (|cl| (%)))
               (SEQ (LETT |cl| (SPADCALL (QREFELT % 7) NIL (QREFELT % 36)))
...
(SDEFUN |CCLASS;#;%Nni;18| ((|a| (%)) (% (|NonNegativeInteger|)))
        (SPROG ((|n| (|NonNegativeInteger|)) (#1=#:G484 NIL) (|i| NIL))
               (SEQ (LETT |n| 0)
                    (SEQ (LETT |i| 0) (LETT #1# (- (QREFELT % 7) 1)) G190
                         (COND ((|greater_SI| |i| #1#) (GO G191)))
                         (SEQ
...
(SDEFUN |CCLASS;extract!;%C;24| ((|a| (%)) (% (|Character|)))
        (SPROG ((#1=#:G504 NIL) (#2=#:G505 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |i| 0) (LETT #2# (- (QREFELT % 7) 1)) G190
...
(SDEFUN |CCLASS;parts;%L;27| ((|a| (%)) (% (|List| (|Character|))))
        (SPROG ((#1=#:G521 NIL) (|i| NIL) (#2=#:G520 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |i| 0) (LETT #1# (- (QREFELT % 7) 1)) G190
...
(DEFUN |CharacterClass;| ()
  (SPROG ((|dv$| NIL) (% NIL) (#1=#:G528 NIL) (|pv$| NIL) (#2=#:G529 NIL))
         (PROGN
...
(MAKEPROP '|CharacterClass| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL '|Rep| 'N (|String|)
              ...
              (|Mapping| 17 22) (|Mapping| 17 22 22) (|Union| 22 '"failed"))
           ...
           (CONS
            (|makeByteWordVec2| 5
                                '(0 0 0 0 0 0 3 0 2 0 0 5 3 0 0 0 0 0 0 0 0 5
                                  1))
            (CONS
             '#(|FiniteSetAggregate&| |Dictionary&| |DictionaryOperations&|
                ...
                |Evalable&| |Hashable&| NIL NIL |PartialOrder&| |BasicType&|
                NIL NIL NIL NIL |InnerEvalable&| NIL)
             (CONS
              '#((|FiniteSetAggregate| 22) (|Dictionary| 22)
                 ...
                 (|Aggregate|) (|Evalable| 22) (|Hashable|)
                 (|ConvertibleTo| 30) (|finiteAggregate|) (|PartialOrder|)
                 (|BasicType|) (|shallowlyMutable|) (|Type|)
                 (|ConvertibleTo| 8) (|CoercibleTo| 42) (|InnerEvalable| 22 22)
                 (|ConvertibleTo| 62))
              (|makeByteWordVec2| 69
                                  '(2 6 17 0 0 18 2 6 17 0 20 21 2 6 0 0 0 24 2
                                    ...
                                    0 0 30 1 2 9 0 67 0 1 2 9 0 67 0 1 0 0 0 1
                                    1 10 0 0 1 2 10 0 22 0 49 2 9 0 67 0 1 2 10
                                    0 22 0 1 2 9 0 67 0 1 4 10 22 61 0 22 22 1
                                    3 9 22 61 0 22 1 2 9 22 61 0 1 0 3 0 1 1 9
                                    30 0 58 2 0 17 0 35 1 1 11 22 0 1 1 9 30 0
                                    1 2 10 17 22 0 23 1 11 22 0 1 2 9 22 68 0 1
                                    ...
                                    2 3 66 66 0 1 1 3 65 0 1 2 0 69 67 0 1 1 0
                                    22 0 51 2 9 17 67 0 1 2 4 0 0 59 1 2 4 0 0
