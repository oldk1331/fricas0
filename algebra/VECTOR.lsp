...
(DEFUN |Vector;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G2617 NIL) (#2=#:G2618 NIL) (#3=#:G2619 NIL) (% NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|Vector| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|IndexedVector| 6 (NRTEVAL 1))
              ...
              (|List| 28) (|Equation| 6) (|OutputForm|) (|String|)
            ...
            (CONS
             ...
             (CONS
              '#((|VectorCategory| 6) (|OneDimensionalArrayAggregate| 6)
                 ...
                 (|InnerEvalable| 6 6) (|CoercibleTo| 29) (|PartialOrder|)
                 (|BasicType|) (|ConvertibleTo| 14))
              (|makeByteWordVec2| 22
