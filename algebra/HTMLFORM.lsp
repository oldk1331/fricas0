...
(SDEFUN |HTMLFORM;argsToString|
        ...
        (SPROG
         ((|s| (|String|)) (|s1| #1=(|String|)) (#2=#:G564 NIL) (|a| NIL)
          (|sop| #1#))
...
(SDEFUN |HTMLFORM;exprex;OfS;9| ((|expr| (|OutputForm|)) (% (|String|)))
        (SPROG
         ((|s| (|String|)) (|s1| #1=(|String|)) (#2=#:G572 NIL) (|a| NIL)
...
(SDEFUN |HTMLFORM;atomize|
        ...
        (SPROG
         ((|le| (|List| (|OutputForm|))) (#1=#:G579 NIL) (|a| NIL)
...
(SDEFUN |HTMLFORM;outputTree| ((|t| (|Tree| (|String|))) (% (|Void|)))
        (SPROG
         ((#1=#:G612 NIL) (|c1| NIL) (#2=#:G609 NIL) (|s| (|String|))
          (#3=#:G611 NIL) (#4=#:G610 NIL) (|enableGrid| (|Boolean|))
           ...
           (SEQ
            (COND
             ((SPADCALL |t| (QREFELT % 37))
              (PROGN (LETT #2# (SPADCALL (QREFELT % 30))) (GO #5=#:G608))))
            (COND
...
(SDEFUN |HTMLFORM;formatSpecial|
        ...
        (SPROG
         ((|tmp| (|Tree| (|String|))) (#1=#:G660 NIL) (|u| NIL)
          (#2=#:G659 NIL))
         (SEQ
          (COND
           ((QREFELT % 21)
...
(SDEFUN |HTMLFORM;formatPlex|
        ((|op| (|Symbol|)) (|args| (|List| (|OutputForm|)))
         (|prec| (|Integer|)) (% (|Tree| (|String|))))
        (SPROG
         ((#1=#:G685 NIL) (|s| (|Tree| (|String|))) (|n| (|Integer|))
          (|p| (|Integer|)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |HTMLFORM;buildColumnTable|
        ...
        (SPROG
         ((|rows| (|List| (|Tree| (|String|)))) (#1=#:G710 NIL) (|i| NIL)
          (#2=#:G709 NIL) (|cells| (|List| (|Tree| (|String|))))
          (#3=#:G708 NIL) (|j| NIL) (#4=#:G707 NIL))
...
(SDEFUN |HTMLFORM;formatSub|
        ((|expr| (|OutputForm|)) (|args| (|List| (|OutputForm|)))
         (|opPrec| (|Integer|)) (% (|Tree| (|String|))))
        (SPROG
         ((#1=#:G729 NIL) (#2=#:G731 NIL) (|e| NIL) (#3=#:G730 NIL)
...
(SDEFUN |HTMLFORM;formatNaryNoGroup|
        ((|op| (|String|)) (|args| (|List| (|OutputForm|)))
         (|prec| (|Integer|)) (% (|Tree| (|String|))))
        (SPROG
         ((|tags| (|List| (|Tree| (|String|)))) (#1=#:G769 NIL) (|a| NIL)
...
(SDEFUN |HTMLFORM;formatHtml|
        ...
        (SPROG
         ((|op| (|Symbol|)) (|nargs| (|Integer|))
          ...
          (|str| (|String|)) (#1=#:G784 NIL) (|i| (|Integer|)))
         (SEQ
          (EXIT
           (SEQ
            (COND
