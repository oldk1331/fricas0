          ...
          (|List|
           (|Record|
            ...
            (|:| |eigvec|
                 (|List| (|Matrix| (|Fraction| (|Polynomial| R)))))))))
        (SPROG
         ((#1=#:G521 NIL) (|v| NIL) (#2=#:G520 NIL) (#3=#:G519 NIL) (|ri| NIL)
          (#4=#:G518 NIL)
          (|res1|
           (|List|
            (|Record|
          ...
          (|List|
           (|Record|
            ...
            (|:| |geneigvec|
                 (|List| (|Matrix| (|Fraction| (|Polynomial| R)))))))))
        (SPROG
         ((#1=#:G535 NIL) (|v| NIL) (#2=#:G534 NIL) (#3=#:G533 NIL) (|ri| NIL)
          (#4=#:G532 NIL)
          (|res1|
           (|List|
            (|Record|
