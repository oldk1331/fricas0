...
(SDEFUN |EP;AV_to_M|
        ...
        (SPROG ((#1=#:G42 NIL) (|i| NIL) (#2=#:G41 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
          ...
          (|List|
           (|Record|
            ...
            (|:| |eigvec|
                 (|List| (|Matrix| (|Fraction| (|Polynomial| R)))))))))
        (SPROG
         ((#1=#:G98 NIL) (|v| NIL) (#2=#:G97 NIL) (#3=#:G96 NIL) (|ri| NIL)
          (#4=#:G95 NIL)
          (|res1|
           (|List|
            (|Record|
          ...
          (|List|
           (|Record|
            ...
            (|:| |geneigvec|
                 (|List| (|Matrix| (|Fraction| (|Polynomial| R)))))))))
        (SPROG
         ((#1=#:G112 NIL) (|v| NIL) (#2=#:G111 NIL) (#3=#:G110 NIL) (|ri| NIL)
          (#4=#:G109 NIL)
          (|res1|
           (|List|
            (|Record|
