...
(SDEFUN |GDMP;totalDegree;%Nni;2| ((|p| (%)) (% (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G476 NIL) (#2=#:G475 #3=(|NonNegativeInteger|)) (#4=#:G477 #3#)
          (#5=#:G482 NIL) (|t| NIL))
         (SEQ
...
(SDEFUN |GDMP;monomial;%OvlNni%;3|
        ...
        (SPROG
         ((#1=#:G488 NIL) (#2=#:G490 NIL) (|z| NIL) (#3=#:G489 NIL)
...
(SDEFUN |GDMP;listCoef| ((|p| (%)) (% (|List| R)))
        (SPROG ((#1=#:G497 NIL) (|rec| NIL) (#2=#:G496 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GDMP;mainVariable;%U;6|
        ...
        (SPROG
         ((#2=#:G510 NIL) (|vv| (|OrderedVariableList| |vl|)) (#3=#:G499 NIL)
          (#4=#:G511 NIL) (|v| NIL))
         (SEQ
          (EXIT
                         ...
                         (EXIT
                          (COND
                           ((> (SPADCALL |p| |vv| (QREFELT % 35)) 0)
                            (PROGN (LETT #2# (CONS 0 |vv|)) (GO #5=#:G509))))))
...
(SDEFUN |GDMP;degree;%LL;13|
        ...
        (SPROG ((#1=#:G540 NIL) (|v| NIL) (#2=#:G539 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GDMP;minimumDegree;%LL;14|
        ((|p| (%)) (|lv| (|List| (|OrderedVariableList| |vl|)))
         (% (|List| (|NonNegativeInteger|))))
        (SPROG ((#1=#:G545 NIL) (|v| NIL) (#2=#:G544 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |v| NIL) (LETT #1# |lv|) G190
...
(SDEFUN |GDMP;variables;%L;19|
        ...
        (SPROG
         ((#1=#:G568 NIL) (#2=#:G574 NIL) (|i| NIL) (#3=#:G573 NIL)
          (#4=#:G572 NIL) (|tdeg| (E))
...
(SDEFUN |GDMP;reorder;%L%;20| ((|p| (%)) (|perm| (|List| (|Integer|))) (% (%)))
        (SPROG
         ((|q| (%)) (#1=#:G586 NIL) (#2=#:G588 NIL) (|j| NIL) (#3=#:G587 NIL)
          (#4=#:G585 NIL) (|term| NIL) (#5=#:G584 NIL))
         (SEQ
          (COND
...
(SDEFUN |GDMP;univariate;%OvlSup;21|
        ...
        (SPROG
         ((|nexp| (E)) (|deg| (|NonNegativeInteger|)) (#1=#:G596 NIL)
          (#2=#:G598 NIL) (|i| NIL) (#3=#:G597 NIL)
...
(SDEFUN |GDMP;eval;%LL%;26|
        ((|p| (%)) (|Lvar| (|List| (|OrderedVariableList| |vl|)))
         (|Lpval| (|List| %)) (% (%)))
        (SPROG
         ((|nlpval| (|List| %)) (#1=#:G615 NIL) (|mvar| NIL) (#2=#:G614 NIL)
...
(SDEFUN |GDMP;content;%R;30| ((|p| (%)) (% (R)))
        (SPROG
         ((#1=#:G631 NIL) (#2=#:G630 (R)) (#3=#:G632 (R)) (#4=#:G635 NIL)
          (|t| NIL))
         (SEQ
...
(SDEFUN |GDMP;coerce;%Of;34| ((|p| (%)) (% (|OutputForm|)))
        (SPROG
         ((|lt| (|List| #1=(|OutputForm|))) (|l| (|List| #1#)) (#2=#:G675 NIL)
          (|i| NIL) (#3=#:G674 NIL) (|t| NIL) (|vl1| (|List| (|OutputForm|)))
          (#4=#:G673 NIL) (|v| NIL) (#5=#:G672 NIL))
         (SEQ
          (COND
...
(DEFUN |GeneralDistributedMultivariatePolynomial| (&REST #1=#:G715)
  (SPROG NIL
         (PROG (#2=#:G716)
           (RETURN
            (COND
...
(DEFUN |GeneralDistributedMultivariatePolynomial;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G714 NIL) (|pv$| NIL) (#2=#:G705 NIL) (#3=#:G707 NIL) (#4=#:G706 NIL)
    (#5=#:G708 NIL) (#6=#:G709 NIL) (#7=#:G710 NIL) (#8=#:G711 NIL)
    (#9=#:G712 NIL) (#10=#:G713 NIL) (% NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL)
    (DV$1 NIL))
   (PROGN
    (LETT DV$1 |#1|)
...
(MAKEPROP '|GeneralDistributedMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|PolynomialRing| 7 8) (|local| |#1|)
              ...
              |GDMP;coerce;%Of;34| (|Union| 154 '#1="failed") (|Matrix| %)
              (|InputForm|) (|Pattern| (|Float|)) (|Pattern| 43)
              (|SingleInteger|) (|HashState|)
              (|Record| (|:| |mat| 155) (|:| |vec| (|Vector| 43))) (|Vector| %)
              (|Matrix| 43) (|PatternMatchResult| (|Float|) %)
              (|PatternMatchResult| 43 %)
              (|Record| (|:| |unit| %) (|:| |canonical| %) (|:| |associate| %))
              (|Fraction| 43) (|Record| (|:| |k| 8) (|:| |c| 7)) (|List| 160)
              (|Mapping| 7 8)
              (|Record| (|:| |llcm_res| %) (|:| |coeff1| %) (|:| |coeff2| %))
              (|Factored| %) (|Factored| 45) (|Union| 167 '#1#) (|List| 45)
              (|Union| 159 '#2="failed") (|Union| 43 '#2#)
              (|Record| (|:| |quotient| %) (|:| |remainder| %)) (|Matrix| 7)
              (|Record| (|:| |mat| 171) (|:| |vec| (|Vector| 7)))
              (|Equation| %) (|List| 173)
              (|Record| (|:| |var| 23) (|:| |exponent| 17))
              (|Union| 175 '#3="failed") (|Union| 102 '#3#) (|Mapping| 8 8)
              (|List| 8) (|Mapping| 7 7) (|String|))
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 7 8 (|OrderedVariableList| 6))
                 ...
                 (|RetractableTo| 7) (|SetCategory|) (|RetractableTo| 159)
                 (|RetractableTo| 43) (|CommutativeStar|) (|Hashable|)
                 ...
                 (|unitsKnown|) (|CoercibleFrom| 159) (|CoercibleFrom| 43)
              ...
              (|makeByteWordVec2| 181
                                  '(1 8 14 0 15 0 0 0 16 2 17 0 0 0 18 3 14 17
                                    ...
                                    12 0 13 1 0 54 0 72 2 0 45 0 23 46 1 0 111
                                    0 117 1 48 158 0 1 1 48 0 0 1 1 48 12 0 1 2
                                    0 17 0 54 1 1 0 17 0 21 2 0 17 0 54 1 1 0
                                    179 0 1 2 55 32 0 0 1 1 10 165 45 1 1 14 0
                                    0 1 1 14 164 0 1 2 10 166 167 45 1 2 9 12 0
                                    0 1 0 54 0 1 1 52 32 0 1 2 52 0 0 17 1 2 0
                                    0 0 22 1 1 6 168 0 1 1 7 169 0 1 1 12 36 0
                                    1 1 0 41 0 42 1 6 159 0 1 1 7 43 0 1 1 12
                                    23 0 1 1 0 7 0 40 3 5 0 0 0 23 1 2 0 0 0 76
                                    77 1 20 0 0 67 2 37 153 147 154 1 1 37 155
                                    147 1 1 4 171 147 1 2 4 172 147 154 1 1 52
                                    32 0 1 2 14 0 0 23 1 1 14 0 0 1 1 12 102 0
