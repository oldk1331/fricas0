...
(SDEFUN |BRILL;primeEnough?|
        ...
        (SPROG
         ((#1=#:G473 NIL) (#2=#:G474 NIL) (|bb| (|Float|)) (#3=#:G466 NIL)
          (|d| (|Union| (|Integer|) #4="failed")) (#5=#:G475 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |BRILL;brillhartIrreducible?;UP2B;6|
        ...
        (SPROG
         ((#1=#:G493 NIL) (#2=#:G494 NIL) (|small| (|Integer|)) (#3=#:G495 NIL)
