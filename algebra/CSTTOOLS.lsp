...
(SDEFUN |CSTTOOLS;cycleElt;STU;1| ((|x| (ST)) (% (|Union| ST "failed")))
        (SPROG ((#1=#:G468 NIL) (#2=#:G469 NIL) (|y| (ST)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |CSTTOOLS;computeCycleLength;STNni;2|
        ...
        (SPROG ((#1=#:G475 NIL) (#2=#:G476 NIL) (|y| (ST)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |cycElt|)
                      (EXIT
...
(DEFUN |CyclicStreamTools| (&REST #1=#:G484)
  (SPROG NIL
         (PROG (#2=#:G485)
           (RETURN
            (COND
