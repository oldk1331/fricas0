...
(DEFUN |LinearDependence| (&REST #1=#:G513)
  (SPROG NIL
         (PROG (#2=#:G514)
           (RETURN
            (COND
...
(DEFUN |LinearDependence;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G512 NIL) (% NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 59
                                            '(1 9 8 0 10 0 6 0 11 1 13 12 0 14
                                              ...
                                              13 59 2 1 27 13 7 29 2 1 27 18 13
                                              28 2 2 43 18 13 44 2 2 43 13 7 45
                                              2 1 25 13 7 38 2 1 25 18 13 41 2
                                              2 42 13 7 58 2 2 42 18 13 59 1 0
