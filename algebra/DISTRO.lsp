...
(SDEFUN |DISTRO;distributionBySTransform;2FS%;22|
        ...
        (SPROG
         ((|psi| #1=(|Stream| R)) (|psi2| #1#) (|chi2| #2=(|Stream| R))
          (|z1z| #2#) (S2 (|Sequence| R)) (#3=#:G62 NIL) (|chi| (|Stream| R)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |DISTRO;freeMultiplicativeConvolution;3%;24|
        ((|x| (%)) (|y| (%)) (% (%)))
        (SPROG
         ((|Sxyc| (|Stream| R)) (#1=#:G77 NIL) (|Syc| #2=(|Stream| R))
          (|Sxc| #2#)
          (|Sy|
...
(SDEFUN |DISTRO;nth!0| (($$ NIL))
        (PROG (|s| |n| %)
          ...
          (RETURN
           (PROGN
            (SPROG ((|k| NIL) (#1=#:G131 NIL) (|res| NIL))
                   (SEQ (LETT |res| |s|)
...
(MAKEPROP '|Distribution| '|infovec|
          (LIST
           ...
           '#(~= 300 |subordinationConvolution| 306 |orthogonalPolynomials| 312
              ...
              |jacobiParameters| 355 |hankelDeterminants| 365
              |freeMultiplicativeConvolution| 370 |freeCumulants| 376
              |freeCumulant| 381 |freeConvolution| 387
              |distributionBySTransform| 393 |distributionByMonotoneCumulants|
              405 |distributionByMoments| 415 |distributionByJacobiParameters|
              425 |distributionByFreeCumulants| 437 |distributionByEvenMoments|
              447 |distributionByClassicalCumulants| 457
              |distributionByBooleanCumulants| 467 |construct| 477 |coerce| 485
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 122
                                            '(0 6 0 8 1 10 0 9 11 1 12 0 10 13
                                              ...
                                              1 1 2 106 0 109 1 1 92 0 94 1 0
                                              10 0 91 2 3 0 0 0 75 1 0 12 0 86
                                              2 0 6 0 81 83 2 0 0 0 0 115 1 3 0
                                              70 71 3 3 0 57 57 12 69 1 3 0 10
                                              56 1 3 0 12 55 1 0 0 10 20 1 0 0
                                              12 14 2 0 0 12 12 48 2 0 0 10 10
                                              49 1 0 0 10 34 1 0 0 12 33 1 0 0
                                              12 27 1 0 0 10 28 1 0 0 12 30 1 0
                                              0 10 31 1 0 0 10 37 1 0 0 12 36 4
