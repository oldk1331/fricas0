...
(SDEFUN |CYCLOTOM;cyclotomic;ISup;1|
        ...
        (SPROG
         ((|l| (|SparseUnivariatePolynomial| (|Integer|))) (#1=#:G456 NIL)
          (#2=#:G455 NIL) (#3=#:G453 NIL) (#4=#:G461 NIL) (|u| NIL)
          (|g|
           (|List|
...
(SDEFUN |CYCLOTOM;cyclotomicDecomposition;IL;2|
        ...
        (SPROG
         ((|l| (|List| (|SparseUnivariatePolynomial| (|Integer|))))
          ...
          (#1=#:G471 NIL) (#2=#:G484 NIL) (|z| NIL) (#3=#:G483 NIL)
          (#4=#:G482 NIL) (|rr| NIL) (#5=#:G467 NIL) (#6=#:G481 NIL)
          (#7=#:G480 NIL) (#8=#:G479 NIL) (|u| NIL)
          (|g|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| (|Integer|))
