...
(SDEFUN |SPACE3;merge;L%;7| ((|listOfThreeSpaces| (|List| %)) (% (%)))
        (SPROG
         ((#1=#:G70 NIL) (|ts| NIL) (|newspace| (%)) (#2=#:G69 NIL)
          (#3=#:G68 NIL))
         (SEQ
          (LETT |newspace|
                (SPADCALL
...
(SDEFUN |SPACE3;composite;L%;9| ((|listOfThreeSpaces| (|List| %)) (% (%)))
        (SPROG ((#1=#:G77 NIL) (|s| NIL) (#2=#:G76 NIL) (|space| (%)))
...
(SDEFUN |SPACE3;components;%L;10| ((|space| (%)) (% (|List| %)))
        (SPROG ((#1=#:G82 NIL) (|s| NIL) (#2=#:G81 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |s| NIL)
...
(SDEFUN |SPACE3;composites;%L;11| ((|space| (%)) (% (|List| %)))
        (SPROG ((#1=#:G87 NIL) (|s| NIL) (#2=#:G86 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SPACE3;copy;2%;12| ((|space| (%)) (% (%)))
        (SPROG ((#1=#:G93 NIL) (|s| NIL) (#2=#:G92 NIL) (|spc| (%)))
               (SEQ
                (LETT |spc|
...
(SDEFUN |SPACE3;curve;%L;22| ((|space| (%)) (% (|List| (|Point| R))))
        (SPROG
         ((#1=#:G123 NIL) (|s| NIL) (#2=#:G122 NIL) (|spc| (|SubSpace| 3 R)))
         (SEQ
          (COND
...
(SDEFUN |SPACE3;curve;%L%;24|
        ((|space| (%)) (|points| (|List| (|Point| R))) (% (%)))
        (SPROG
         ((#1=#:G129 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|))))
         (SEQ
...
(SDEFUN |SPACE3;closedCurve;%L;27| ((|space| (%)) (% (|List| (|Point| R))))
        (SPROG
         ((#1=#:G144 NIL) (|s| NIL) (#2=#:G143 NIL) (|spc| (|SubSpace| 3 R)))
         (SEQ
          (COND
...
(SDEFUN |SPACE3;closedCurve;%L%;29|
        ((|space| (%)) (|points| (|List| (|Point| R))) (% (%)))
        (SPROG
         ((#1=#:G150 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|))))
         (SEQ
          (SPADCALL (QVELT |space| 0) NIL (|SPADfirst| |points|)
                    (QREFELT % 50))
          (LETT |path|
...
(SDEFUN |SPACE3;mesh;%L;36| ((|space| (%)) (% (|List| (|List| (|Point| R)))))
        (SPROG
         ((|llp| (|List| (|List| (|Point| R)))) (#1=#:G189 NIL) (|s| NIL)
          (#2=#:G188 NIL) (#3=#:G187 NIL) (|lpSpace| NIL))
         (SEQ
          (COND
...
(SDEFUN |SPACE3;mesh;%LLSscp%;39|
        ((|space| (%)) (|llpoints| (|List| (|List| (|List| R))))
         ...
         (% (%)))
        (SPROG
         ((|pts| (|List| (|List| (|Point| R)))) (#2=#:G199 NIL) (|points| NIL)
          (#3=#:G198 NIL))
         (SEQ
          (LETT |pts|
                (PROGN
...
(SDEFUN |SPACE3;mesh;%LLSscp%;40|
        ((|space| (%)) (|llp| (|List| (|List| (|Point| R))))
         ...
         (% (%)))
        (SPROG
         ((#2=#:G212 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|)))
          (#3=#:G210 NIL) (|lp| NIL) (#4=#:G211 NIL) (|aProp| NIL)
          (|count| NIL) (#5=#:G209 NIL))
         (SEQ
...
(SDEFUN |SPACE3;mesh;%L2B%;41|
        ...
        (SPROG
         ((|pts| (|List| (|List| (|Point| R)))) (#2=#:G220 NIL) (|points| NIL)
          (#3=#:G219 NIL))
         (SEQ
          (LETT |pts|
                (PROGN
...
(SDEFUN |SPACE3;mesh;%L2B%;42|
        ((|space| (%)) (|llp| (|List| (|List| (|Point| R))))
         (|prop1| #1=(|Boolean|)) (|prop2| #1#) (% (%)))
        (SPROG
         ((#2=#:G232 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|)))
          (#3=#:G231 NIL) (|lp| NIL) (|count| NIL) (#4=#:G230 NIL)
