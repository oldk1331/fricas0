...
(SDEFUN |UPXS;approximateLaurent|
        ((|x| (|UnivariateLaurentSeries| |Coef| |var| |cen|)) (|term| (|Coef|))
         (|n| (|Integer|)) (% (|Coef|)))
        (SPROG
         ((|app| (|Coef|)) (#1=#:G492 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
...
(SDEFUN |UPXS;termsToOutputForm|
        ...
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|uu1| (|Stream| |Coef|)) (|n| NIL)
          (#1=#:G526 NIL) (|count| (|NonNegativeInteger|)))
         (SEQ (LETT |l| NIL)
              (EXIT
               (COND
...
(DEFUN |UnivariatePuiseuxSeries| (&REST #1=#:G557)
  (SPROG NIL
         (PROG (#2=#:G558)
           (RETURN
            (COND
...
(DEFUN |UnivariatePuiseuxSeries;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G550 NIL) (#2=#:G551 NIL) (#3=#:G552 NIL) (#4=#:G553 NIL)
    (#5=#:G555 NIL) (% NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|UnivariatePuiseuxSeries| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|UnivariatePuiseuxSeriesConstructor| 6 14)
              ...
              |UPXS;coerce;%Of;16| (|List| 10) (|List| 46) (|PositiveInteger|)
              (|Union| % '"failed")
              (|Record| (|:| |unit| %) (|:| |canonical| %) (|:| |associate| %))
              (|Record| (|:| |k| 27) (|:| |c| 6)) (|List| 93)
              ...
              (|Record| (|:| |coef1| %) (|:| |coef2| %))
              (|Union| 101 '"failed") (|Factored| %) (|Stream| 93)
              (|Mapping| 6 6) (|String|))
            ...
            (CONS
             ...
             (CONS
              '#((|UnivariatePuiseuxSeriesConstructorCategory| 6
                 ...
                 (|NonAssociativeAlgebra| 27) (|SemiRng|) (|Module| 6)
                 (|Module| $$) (|Module| 27) (|IndexedProductCategory| 6 27)
                 (|BiModule| 6 6) (|BiModule| $$ $$) (|NonAssociativeRing|)
                 (|BiModule| 27 27) (|AbelianProductCategory| 6)
                 (|LeftModule| 6) (|RightModule| 6) (|RightModule| $$)
                 (|LeftModule| $$) (|NonAssociativeRng|) (|LeftModule| 27)
                 (|RightModule| 27) (|AbelianGroup|)
              ...
              (|makeByteWordVec2| 87
                                  '(1 14 0 13 15 1 0 0 14 16 1 0 18 0 19 1 14
                                    ...
                                    12 2 12 6 0 27 61 0 34 0 31 0 32 0 26 2 0 0
                                    0 0 33)))))
           '|lookupIncomplete|)) 
