...
(SDEFUN |POLYROOT;zroot|
        ...
        (SPROG
         ((#1=#:G457 NIL) (#2=#:G456 #3=(|Integer|)) (#4=#:G458 #3#)
          (#5=#:G461 NIL) (#6=#:G448 NIL)
          (|s|
           (|Record| (|:| |exponent| (|NonNegativeInteger|))
        ...
        ((|x| (|Fraction| (|Integer|))) (|n| (|NonNegativeInteger|))
         (%
          (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                    (|:| |radicand| F))))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G469 NIL)
          (|sd|
        ...
        ((|x| (|Fraction| (|Integer|))) (|n| (|NonNegativeInteger|))
         (%
          (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                    (|:| |radicand| F))))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G475 NIL)
          (|sd|
...
(SDEFUN |POLYROOT;rsplit|
        ...
        (SPROG
         ((|r| (R)) (|p| (P)) (|u| (|Union| R "failed")) (#1=#:G501 NIL)
          (|q| NIL))
        ...
        ((|x| (F)) (|n| (|NonNegativeInteger|))
         (%
          (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                    (|:| |radicand| F))))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G516 NIL)
          (|rd|
           #2=(|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                        (|:| |radicand| F)))
...
(DEFUN |PolynomialRoots| (&REST #1=#:G519)
  (SPROG NIL
         (PROG (#2=#:G520)
           (RETURN
            (COND
