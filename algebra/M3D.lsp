...
(SDEFUN |M3D;matrixConcat3D;S3%;1|
        ...
        (SPROG
         ((|retVal| (%)) (#1=#:G479 NIL) (|j| NIL)
          (|temp| (|PrimitiveArray| (|PrimitiveArray| R))) (#2=#:G478 NIL)
          (|i| NIL) (#3=#:G477 NIL)
          (|matRep2|
...
(SDEFUN |M3D;identityMatrix;Nni%;8|
        ...
        (SPROG
         ((|row2| (|PrimitiveArray| (|PrimitiveArray| R)))
          (|row1| (|PrimitiveArray| R)) (#1=#:G494 NIL) (|count| NIL)
...
(SDEFUN |M3D;plus;3%;9| ((|mat1| (%)) (|mat2| (%)) (% (%)))
        (SPROG
         ((|resultMatrix| (%)) (|sum| (R)) (#1=#:G508 NIL) (|k| NIL)
          (#2=#:G507 NIL) (|j| NIL) (#3=#:G506 NIL) (|i| NIL)
...
(SDEFUN |M3D;construct;L%;10|
        ...
        (SPROG
         ((|resultMatrix| (%)) (|element| (R)) (#1=#:G535 NIL) (|k| NIL)
          (#2=#:G534 NIL) (|j| NIL) (#3=#:G533 NIL) (|i| NIL)
          (|row3| (|PrimitiveArray| (|PrimitiveArray| (|PrimitiveArray| R))))
          (|row2| (|PrimitiveArray| (|PrimitiveArray| R)))
          (|row1| (|PrimitiveArray| R)) (#4=#:G530 NIL) (#5=#:G532 NIL)
          (|subSubList| NIL) (#6=#:G531 NIL) (|subList| NIL)
...
(DEFUN |ThreeDimensionalMatrix| (#1=#:G541)
  (SPROG NIL
         (PROG (#2=#:G542)
           (RETURN
            (COND
...
(DEFUN |ThreeDimensionalMatrix;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G539 NIL) (#2=#:G540 NIL) (% NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|ThreeDimensionalMatrix| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|PrimitiveArray| 16) (|local| |#1|)
              ...
              (96 . |elt|) |M3D;construct;L%;10| (|Boolean|) (|Equation| 6)
              (|List| 42) (|Mapping| 41 6 6) (|Mapping| 41 6) (|Mapping| 6 6)
              (|OutputForm|) (|String|))
                  ...
                  (CONS
                   ...
                   (|makeByteWordVec2| 48
                                       '(2 7 9 0 10 11 1 5 0 0 13 2 5 0 0 0 14
                                         ...
                                         41 45 0 1 3 4 0 0 6 6 1 3 4 0 0 37 37
                                         1 2 4 0 0 42 1 2 4 0 0 43 1 2 0 41 0 0
                                         1 1 0 41 0 1 0 0 0 1 4 0 6 0 9 9 9 25
                                         2 12 9 6 0 1 2 10 9 45 0 1 1 0 0 0 1 1
                                         0 0 35 40 1 5 47 0 1 1 0 0 5 15 1 0 5
                                         0 12 2 10 41 45 0 1 2 13 41 0 0 1 1 10
                                         9 0 1)))))
           '|lookupComplete|)) 
