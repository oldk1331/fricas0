...
(SDEFUN |PDRING-;differentiate;ALLA;3|
        ((|r| (A)) (|ls| (|List| S)) (|ln| (|List| (|NonNegativeInteger|)))
         (% (A)))
        (SPROG ((#1=#:G36 NIL) (|s| NIL) (#2=#:G37 NIL) (|n| NIL))
               (SEQ
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 21
                                            '(2 6 0 0 7 8 3 6 0 0 7 11 13 2 6 0
                                              0 9 17 3 6 0 0 9 14 20 2 0 0 0 9
                                              10 3 0 0 0 9 14 15 3 0 0 0 7 11
                                              12 2 0 0 0 9 18 2 0 0 0 7 16 3 0
                                              0 0 9 14 21 3 0 0 0 7 11 19)))))
           '|lookupComplete|)) 
