...
(DEFUN |PatternMatch;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G25 NIL) (% NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL)
    (DV$1 NIL))
   (PROGN
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 42
                                            '(1 8 9 0 10 0 11 0 12 3 7 13 0 9
                                              ...
                                              41 2 0 11 7 8 42 2 0 15 19 8 22 2
                                              0 15 7 8 17 2 0 18 19 8 20 2 3 40
                                              7 8 41 2 2 11 7 8 42 2 1 33 7 8
                                              34)))))
           '|lookupComplete|)) 
