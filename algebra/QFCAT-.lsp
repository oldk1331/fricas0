...
(SDEFUN |QFCAT-;reducedSystem;MM;6| ((|m| (|Matrix| A)) (% (|Matrix| S)))
        (SPROG
         ((#1=#:G36 NIL) (|ell| (A)) (#2=#:G45 NIL) (|j| NIL) (|d| (S))
          (#3=#:G44 NIL) (|i| NIL) (|ans| (|Matrix| S))
...
(MAKEPROP '|QuotientFieldCategory&| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              |QFCAT-;reducedSystem;MVR;25| (|OutputForm|) (|List| 62)
              (|List| 36) (|Matrix| 26)
              (|Record| (|:| |mat| 116) (|:| |vec| (|Vector| 26)))
              (|Union| 91 '#2#))
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 112
                                            '(1 6 7 0 8 1 6 0 7 9 1 6 7 0 11 0
                                              ...
                                              0 70 0 72 1 0 99 0 101 1 0 62 0
                                              67 1 0 26 0 98 1 0 33 34 35 2 0
                                              110 34 111 112 3 0 80 0 73 80 81
                                              3 0 89 0 82 89 90 1 0 0 0 10 1 0
                                              17 0 20 2 0 0 21 0 22 0 0 0 16 1
                                              0 0 0 61 2 0 0 0 21 42 1 0 0 0 12
                                              1 0 82 0 85 1 0 73 0 76 1 0 43 0
                                              46 1 0 51 0 53 1 0 47 0 50 1 0 0
                                              91 96 1 0 0 62 64 0 0 36 38 2 0
                                              54 0 0 56)))))
           '|lookupComplete|)) 
