        ...
        (SPROG
         ...
         (SEQ
          ...
          (SEQ G190 (COND ((NULL (NULL (NULL |Pol1|))) (GO G191)))
               (SEQ (LETT |h| (SPADCALL (|SPADfirst| |Pol1|) (QREFELT % 27)))
                    ...
                    (LETT D1
                          (PROGN
                           (LETT #11# NIL)
                           (SEQ (LETT |x| NIL) (LETT #10# |basPols|) G190
                                (COND
                                 ((OR (ATOM #10#)
                                      (PROGN (LETT |x| (CAR #10#)) NIL))
                                  (GO G191)))
                                (SEQ
                                 (EXIT
                                  (LETT #11#
          ...
          (LETT |redPols|
                (PROGN
                 (LETT #9# NIL)
                 (SEQ (LETT |x| NIL) (LETT #8# |basPols|) G190
                      (COND
                       ((OR (ATOM #8#) (PROGN (LETT |x| (CAR #8#)) NIL))
                        (GO G191)))
                      (SEQ (EXIT (LETT #9# (CONS (QCDR |x|) #9#))))
