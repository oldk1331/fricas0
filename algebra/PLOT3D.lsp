...
(SDEFUN |PLOT3D;join|
        ...
        (SPROG
         ((|u| (|Segment| (|DoubleFloat|))) (#1=#:G30 NIL) (|r| NIL)
          (|rr|
           (|Record|
            (|:| |source|
                 (|Mapping| (|Point| (|DoubleFloat|)) (|DoubleFloat|)))
...
(SDEFUN |PLOT3D;tValues;%L;22|
        ...
        (SPROG
         ((|outList| (|List| (|List| (|DoubleFloat|)))) (#1=#:G54 NIL)
          (|curve| NIL))
...
(SDEFUN |PLOT3D;select|
        ((|l| (|List| (|Point| (|DoubleFloat|))))
         ...
         (% (|DoubleFloat|)))
        (SPROG ((|m| #1#) (|fp| #1#) (#2=#:G60 NIL) (|p| NIL))
...
(SDEFUN |PLOT3D;rangeRefine|
        ...
        (SPROG
         ((|zRange| #4=(|Segment| (|DoubleFloat|))) (|yRange| #4#)
          ...
          (#5=#:G106 NIL) (|i| NIL) (|d| #6=(|DoubleFloat|)) (|n| (|Integer|))
          (|q| (|List| (|Point| (|DoubleFloat|))))
          (|c| (|List| (|DoubleFloat|))) (|s| #6#) (#7=#:G105 NIL) (|f| #1#)
...
(SDEFUN |PLOT3D;adaptivePlot|
        ...
        (SPROG
         ((|p| #3#) (|t| #2#) (|tj| #4=(|DoubleFloat|)) (|n| (|Integer|))
          (#5=#:G150 NIL) (|sp| #6=(|List| (|Point| (|DoubleFloat|))))
...
(SDEFUN |PLOT3D;basicPlot|
        ...
        (SPROG
         ((|zRange| #1=(|Segment| (|DoubleFloat|))) (|yRange| #1#)
          ...
          (|t| (|List| (|DoubleFloat|))) (|l| (|DoubleFloat|)) (#2=#:G176 NIL)
          ...
          (|curves|
           (|List|
            (|Record|
             ...
             (|:| |knots| (|List| (|DoubleFloat|)))
             (|:| |points| (|List| (|Point| (|DoubleFloat|)))))))
          (|scrres| (|Integer|)) (#2=#:G220 NIL) (|c| NIL) (#3=#:G219 NIL)
          (|tlimit| (|PositiveInteger|)) (#4=#:G218 NIL) (#5=#:G217 NIL)
          (|tRange| (|Segment| (|DoubleFloat|))))
          ...
          (|curves|
           (|List|
            (|Record|
             ...
             (|:| |knots| (|List| (|DoubleFloat|)))
             (|:| |points| (|List| (|Point| (|DoubleFloat|)))))))
          (#2=#:G232 NIL) (|c| NIL) (#3=#:G231 NIL)
          (|tlimit| (|PositiveInteger|)) (#4=#:G230 NIL) (#5=#:G229 NIL))
         (SEQ (SETELT % 10 0)
              (LETT |curves|
                    (PROGN
                     (LETT #5# NIL)
...
(SDEFUN |PLOT3D;coerce;%Of;37| ((|r| (%)) (% (|OutputForm|)))
        (SPROG
         ((|f| (|List| (|OutputForm|))) (|l| (|List| #1=(|OutputForm|)))
          (#2=#:G271 NIL) (|p| NIL) (#3=#:G270 NIL) (|h| (|OutputForm|))
          (|zRange| #1#) (|yRange| #1#) (|xRange| #1#) (#4=#:G269 NIL)
