...
(SDEFUN |PLOT3D;join|
        ...
        (SPROG
         ((|u| (|Segment| (|DoubleFloat|))) (#1=#:G478 NIL) (|r| NIL)
          (|rr|
           (|Record|
            (|:| |source|
                 (|Mapping| (|Point| (|DoubleFloat|)) (|DoubleFloat|)))
...
(SDEFUN |PLOT3D;tValues;%L;22|
        ...
        (SPROG
         ((|outList| (|List| (|List| (|DoubleFloat|)))) (#1=#:G502 NIL)
          (|curve| NIL))
...
(SDEFUN |PLOT3D;select|
        ((|l| (|List| (|Point| (|DoubleFloat|))))
         ...
         (% (|DoubleFloat|)))
        (SPROG ((|m| #1#) (|fp| #1#) (#2=#:G508 NIL) (|p| NIL))
...
(SDEFUN |PLOT3D;rangeRefine|
        ...
        (SPROG
         ((|zRange| #4=(|Segment| (|DoubleFloat|))) (|yRange| #4#)
          ...
          (#5=#:G554 NIL) (|i| NIL) (|d| #6=(|DoubleFloat|)) (|n| (|Integer|))
          (|q| (|List| (|Point| (|DoubleFloat|))))
          (|c| (|List| (|DoubleFloat|))) (|s| #6#) (#7=#:G553 NIL) (|f| #1#)
...
(SDEFUN |PLOT3D;adaptivePlot|
        ...
        (SPROG
         ((|p| #3#) (|t| #2#) (|tj| #4=(|DoubleFloat|)) (|n| (|Integer|))
          (#5=#:G598 NIL) (|sp| #6=(|List| (|Point| (|DoubleFloat|))))
...
(SDEFUN |PLOT3D;basicPlot|
        ...
        (SPROG
         ((|zRange| #1=(|Segment| (|DoubleFloat|))) (|yRange| #1#)
          ...
          (|t| (|List| (|DoubleFloat|))) (|l| (|DoubleFloat|)) (#2=#:G624 NIL)
          ...
          (|curves|
           (|List|
            (|Record|
             ...
             (|:| |knots| (|List| (|DoubleFloat|)))
             (|:| |points| (|List| (|Point| (|DoubleFloat|)))))))
          (|scrres| (|Integer|)) (#2=#:G668 NIL) (|c| NIL) (#3=#:G667 NIL)
          (|tlimit| (|PositiveInteger|)) (#4=#:G666 NIL) (#5=#:G665 NIL)
          (|tRange| (|Segment| (|DoubleFloat|))))
          ...
          (|curves|
           (|List|
            (|Record|
             ...
             (|:| |knots| (|List| (|DoubleFloat|)))
             (|:| |points| (|List| (|Point| (|DoubleFloat|)))))))
          (#2=#:G680 NIL) (|c| NIL) (#3=#:G679 NIL)
          (|tlimit| (|PositiveInteger|)) (#4=#:G678 NIL) (#5=#:G677 NIL))
         (SEQ (SETELT % 10 0)
              (LETT |curves|
                    (PROGN
                     (LETT #5# NIL)
...
(SDEFUN |PLOT3D;coerce;%Of;37| ((|r| (%)) (% (|OutputForm|)))
        (SPROG
         ((|f| (|List| (|OutputForm|))) (|l| (|List| #1=(|OutputForm|)))
          (#2=#:G719 NIL) (|p| NIL) (#3=#:G718 NIL) (|h| (|OutputForm|))
          (|zRange| #1#) (|yRange| #1#) (|xRange| #1#) (#4=#:G717 NIL)
