...
(SDEFUN |DJBP;lookup| ((|jv| (JB)) (% (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G485 NIL) (#2=#:G486 NIL) (|i| NIL) (#3=#:G487 NIL)
          (|ljv| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |DJBP;mainVariable;%U;8| ((|p| (%)) (% (|Union| JB "failed")))
        (SPROG
         ((#1=#:G510 NIL) (#2=#:G511 NIL) (|i| NIL) (#3=#:G512 NIL) (|jv| NIL)
          (|tdeg| (E)))
         (SEQ
          (EXIT
...
(SDEFUN |DJBP;variables;%L;9| ((|p| (%)) (% (|List| JB)))
        (SPROG
         ((#1=#:G528 NIL) (|jv| NIL) (#2=#:G529 NIL) (|i| NIL) (#3=#:G527 NIL)
          (#4=#:G526 NIL) (|tdeg| (E))
...
(SDEFUN |DJBP;coerce;%Of;10| ((|p| (%)) (% (|OutputForm|)))
        (SPROG
         ((|lt| (|List| (|OutputForm|))) (|l| (|List| (|OutputForm|)))
          (#1=#:G548 NIL) (|i| NIL) (#2=#:G547 NIL) (|t| NIL))
         (SEQ
          (COND
...
(SDEFUN |DJBP;univariate;%JBSup;16|
        ...
        (SPROG
         ((|nexp| (E)) (|deg| (|NonNegativeInteger|)) (#1=#:G590 NIL)
          (#2=#:G592 NIL) (|i| NIL) (#3=#:G591 NIL)
...
(SDEFUN |DJBP;totalDegree;%Nni;20| ((|p| (%)) (% (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G609 NIL) (#2=#:G608 #3=(|NonNegativeInteger|)) (#4=#:G610 #3#)
          (#5=#:G615 NIL) (|t| NIL))
         (SEQ
...
(SDEFUN |DJBP;degree;%LL;22|
        ...
        (SPROG ((#1=#:G621 NIL) (|jv| NIL) (#2=#:G620 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |DJBP;minimumDegree;%LL;24|
        ((|p| (%)) (|ljv| (|List| JB)) (% (|List| (|NonNegativeInteger|))))
        (SPROG ((#1=#:G627 NIL) (|jv| NIL) (#2=#:G626 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |jv| NIL) (LETT #1# |ljv|) G190
...
(SDEFUN |DJBP;eval;%LL%;29|
        ((|p| (%)) (|Ljvar| (|List| JB)) (|Lpval| (|List| %)) (% (%)))
        (SPROG
         ((|nlpval| (|List| %)) (#1=#:G648 NIL) (|mvar| NIL) (#2=#:G647 NIL)
          (|nljvar| (|List| JB)))
         (SEQ
          (LETT |nljvar|
...
(SDEFUN |DJBP;content;%R;32| ((|p| (%)) (% (R)))
        (SPROG
         ((#1=#:G652 NIL) (#2=#:G651 (R)) (#3=#:G653 (R)) (#4=#:G656 NIL)
          (|t| NIL))
         (SEQ
...
(DEFUN |DistributedJetBundlePolynomial| (&REST #1=#:G720)
  (SPROG NIL
         (PROG (#2=#:G721)
           (RETURN
            (COND
...
(DEFUN |DistributedJetBundlePolynomial;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((#1=#:G719 NIL) (|jv| NIL) (#2=#:G718 NIL) (#3=#:G717 NIL) (|pv$| NIL)
    (#4=#:G708 NIL) (#5=#:G710 NIL) (#6=#:G709 NIL) (#7=#:G711 NIL)
    (#8=#:G712 NIL) (#9=#:G713 NIL) (#10=#:G714 NIL) (#11=#:G715 NIL)
    (#12=#:G716 NIL) (% NIL) (|dv$| NIL) (DV$4 NIL) (DV$3 NIL) (DV$2 NIL)
    (DV$1 NIL))
   (SEQ
    (PROGN
...
(MAKEPROP '|DistributedJetBundlePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|PolynomialRing| 6 9) (|local| |#1|)
              ...
              (|Union| 167 '#1="failed") (|Matrix| %) (|InputForm|)
              (|Pattern| (|Float|)) (|Pattern| 36) (|SingleInteger|)
              (|HashState|) (|PatternMatchResult| (|Float|) %)
              (|PatternMatchResult| 36 %)
              (|Record| (|:| |mat| 168) (|:| |vec| (|Vector| 36))) (|Vector| %)
              (|Matrix| 36) (|Union| % '#1#) (|PositiveInteger|)
              (|Record| (|:| |unit| %) (|:| |canonical| %) (|:| |associate| %))
              (|Fraction| 36) (|Record| (|:| |k| 9) (|:| |c| 6)) (|List| 173)
              (|Mapping| 6 9)
              (|Record| (|:| |llcm_res| %) (|:| |coeff1| %) (|:| |coeff2| %))
              (|Factored| %) (|Factored| 63) (|Union| 180 '#1#) (|List| 63)
              (|Union| 172 '#2="failed") (|Union| 36 '#2#)
              (|Record| (|:| |quotient| %) (|:| |remainder| %))
              (|Record| (|:| |mat| 185) (|:| |vec| (|Vector| 6))) (|Matrix| 6)
              (|List| 187) (|Equation| %)
              (|Record| (|:| |var| 7) (|:| |exponent| 18))
              (|Union| 188 '#3="failed") (|Union| 135 '#3#) (|Mapping| 9 9)
              (|List| 9) (|Mapping| 6 6))
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 6 9 7)
                 ...
                 (|RetractableTo| 6) (|SetCategory|) (|RetractableTo| 172)
                 (|RetractableTo| 36) (|CommutativeStar|) (|Hashable|)
                 (|Evalable| $$) (|RetractableTo| 7)
                 (|VariablesCommuteWithCoefficients|) (|InnerEvalable| 7 $$)
                 (|InnerEvalable| 7 6) (|CoercibleFrom| 6) (|BasicType|)
                 (|CoercibleTo| 10) (|unitsKnown|) (|CoercibleFrom| 172)
              ...
              (|makeByteWordVec2| 193
                                  '(1 7 10 0 11 2 7 16 0 0 17 1 19 0 18 20 0 7
                                    ...
                                    54 16 0 29 1 0 45 0 46 1 0 91 0 95 2 0 63 0
                                    7 74 1 48 171 0 1 1 48 0 0 1 1 48 16 0 1 2
                                    0 18 0 45 1 2 0 18 0 45 1 1 0 18 0 108 1 0
                                    192 0 1 2 55 169 0 0 1 1 10 178 63 1 1 14 0
                                    0 1 1 14 177 0 1 2 10 179 180 63 1 2 9 16 0
                                    0 1 0 54 0 1 1 52 169 0 1 2 52 0 0 18 1 2 0
                                    0 0 170 1 1 6 181 0 1 1 7 182 0 1 1 12 30 0
                                    1 1 0 86 0 87 1 6 172 0 1 1 7 36 0 1 1 12 7
                                    0 1 1 0 6 0 72 3 5 0 0 0 7 1 1 20 0 0 41 2
                                    37 166 158 167 1 1 37 168 158 1 2 4 184 158
                                    167 1 1 4 185 158 1 1 52 169 0 1 2 14 0 0 7
                                    1 1 14 0 0 1 1 12 135 0 1 1 10 16 0 1 4 0 0
                                    0 6 9 0 1 2 49 0 0 170 1 3 28 164 0 160 164
                                    1 3 30 165 0 161 165 1 2 54 16 0 0 1 1 52
                                    16 0 1 1 0 18 0 34 2 0 0 63 7 97 2 0 0 91 7
