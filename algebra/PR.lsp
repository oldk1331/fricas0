...
(SDEFUN |PR;coefficient;%ER;9| ((|p| (%)) (|e| (E)) (% (R)))
        (SPROG
         ((#1=#:G559 NIL) (#2=#:G560 NIL) (#3=#:G562 NIL) (|tm| NIL)
          (|ks| (|SingleInteger|)) (#4=#:G561 NIL) (|tms| NIL)
          (|es| (|SingleInteger|))
...
(SDEFUN |PR;coefficient;%ER;10| ((|p| (%)) (|e| (E)) (% (R)))
        (SPROG ((#1=#:G570 NIL) (#2=#:G571 NIL) (#3=#:G572 NIL) (|tm| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |tm| NIL) (LETT #3# |p|) G190
                        ...
                        (EXIT
                         (COND
                          ((SPADCALL (QCAR |tm|) |e| (QREFELT % 30))
                           (PROGN (LETT #2# (QCDR |tm|)) (GO #4=#:G569)))
                          ('T
                           (SEQ
                            (EXIT
                             (COND
...
(SDEFUN |PR;times| ((|tco| (R)) (|tex| (E)) (|rx| (%)) (% (%)))
        (SPROG ((|r| (R)) (#1=#:G601 NIL) (|tx| NIL) (#2=#:G600 NIL))
               (SEQ
                (COND
                 ((QREFELT % 42)
...
(SDEFUN |PR;*;3%;20| ((|p1| (%)) (|p2| (%)) (% (%)))
        (SPROG
         ((|res| (|Rep|)) (#1=#:G664 NIL) (|tx| NIL) (#2=#:G663 NIL)
...
(SDEFUN |PR;*;3%;21| ((|p1| (%)) (|p2| (%)) (% (%)))
        (SPROG
         ((|res| (|Rep|)) (#1=#:G673 NIL) (|tx| NIL) (|xx| (|Rep|))
          (|yy| (|Rep|)))
         (SEQ (LETT |xx| |p1|)
              (EXIT
               (COND ((NULL |xx|) |p1|)
...
(SDEFUN |PR;unitNormal;%R;25|
        ...
        (SPROG ((|a| (R)) (#1=#:G687 NIL) (|lcf| (R)) (|#G1| (R)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
...
(SDEFUN |PR;unitCanonical;2%;26| ((|p| (%)) (% (%)))
        (SPROG ((|a| (R)) (#1=#:G692 NIL) (|lcf| (R)) (|#G2| (R)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((NULL |p|) (EXIT |p|))
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |c2| (|spadConstant| % 20)
                                       (QREFELT % 60))
                             (PROGN (LETT #1# |$NoValue|) (GO #3=#:G704)))
                            ('T
                             (SEQ
                              (LETT |e2|
...
(SDEFUN |PR;exquo;%RU;31| ((|p| (%)) (|r| (R)) (% (|Union| % "failed")))
        (SPROG
         ((#1=#:G737 NIL) (|a| (|Union| R "failed")) (#2=#:G739 NIL) (|tm| NIL)
          (#3=#:G738 NIL))
         (SEQ
          (EXIT
           (CONS 0
...
(SDEFUN |PR;exquo;2%U;32| ((|p1| (%)) (|p2| (%)) (% (|Union| % #1="failed")))
        (SPROG
         ((|rout| (%)) (#2=#:G758 NIL) (|ee| (|Union| E "failed"))
          (|a| (|Union| R #1#)))
         (SEQ
          (EXIT
...
(SDEFUN |PR;exquo;2%U;33| ((|p1| (%)) (|p2| (%)) (% (|Union| % #1="failed")))
        (SPROG
         ((|rout| (%)) (#2=#:G777 NIL) (|ee| (|Union| E "failed"))
          (|a| (|Union| R #1#)))
         (SEQ
          (EXIT
           (COND ((NULL |p2|) (|error| "Division by 0"))
...
(DEFUN |PolynomialRing| (&REST #1=#:G791)
  (SPROG NIL
         (PROG (#2=#:G792)
           (RETURN
            (COND
...
(DEFUN |PolynomialRing;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G788 NIL) (#2=#:G789 NIL) (#3=#:G790 NIL) (% NIL)
