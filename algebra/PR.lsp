...
(SDEFUN |PR;coefficient;%ER;9| ((|p| (%)) (|e| (E)) (% (R)))
        (SPROG
         ((#1=#:G125 NIL) (#2=#:G126 NIL) (#3=#:G128 NIL) (|tm| NIL)
          (|ks| (|SingleInteger|)) (#4=#:G127 NIL) (|tms| NIL)
          (|es| (|SingleInteger|))
...
(SDEFUN |PR;coefficient;%ER;10| ((|p| (%)) (|e| (E)) (% (R)))
        (SPROG ((#1=#:G136 NIL) (#2=#:G137 NIL) (#3=#:G138 NIL) (|tm| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |tm| NIL) (LETT #3# |p|) G190
                        ...
                        (EXIT
                         (COND
                          ((SPADCALL (QCAR |tm|) |e| (QREFELT % 30))
                           (PROGN (LETT #2# (QCDR |tm|)) (GO #4=#:G135)))
                          ('T
                           (SEQ
                            (EXIT
                             (COND
...
(SDEFUN |PR;times| ((|tco| (R)) (|tex| (E)) (|rx| (%)) (% (%)))
        (SPROG ((|r| (R)) (#1=#:G167 NIL) (|tx| NIL) (#2=#:G166 NIL))
               (SEQ
                (COND
                 ((QREFELT % 42)
...
(SDEFUN |PR;*;3%;20| ((|p1| (%)) (|p2| (%)) (% (%)))
        (SPROG
         ((|res| (|Rep|)) (#1=#:G230 NIL) (|tx| NIL) (#2=#:G229 NIL)
...
(SDEFUN |PR;*;3%;21| ((|p1| (%)) (|p2| (%)) (% (%)))
        (SPROG
         ((|res| (|Rep|)) (#1=#:G239 NIL) (|tx| NIL) (|xx| (|Rep|))
          (|yy| (|Rep|)))
         (SEQ (LETT |xx| |p1|)
              (EXIT
               (COND ((NULL |xx|) |p1|)
...
(SDEFUN |PR;unitNormal;%R;25|
        ...
        (SPROG ((|a| (R)) (#1=#:G253 NIL) (|lcf| (R)) (|#G1| (R)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
...
(SDEFUN |PR;unitCanonical;2%;26| ((|p| (%)) (% (%)))
        (SPROG ((|a| (R)) (#1=#:G258 NIL) (|lcf| (R)) (|#G2| (R)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((NULL |p|) (EXIT |p|))
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |c2| (|spadConstant| % 20)
                                       (QREFELT % 60))
                             (PROGN (LETT #1# |$NoValue|) (GO #3=#:G270)))
                            ('T
                             (SEQ
                              (LETT |e2|
...
(SDEFUN |PR;exquo;%RU;31| ((|p| (%)) (|r| (R)) (% (|Union| % "failed")))
        (SPROG
         ((#1=#:G303 NIL) (|a| (|Union| R "failed")) (#2=#:G305 NIL) (|tm| NIL)
          (#3=#:G304 NIL))
         (SEQ
          (EXIT
           (CONS 0
...
(SDEFUN |PR;exquo;2%U;32| ((|p1| (%)) (|p2| (%)) (% (|Union| % #1="failed")))
        (SPROG
         ((|rout| (%)) (#2=#:G324 NIL) (|ee| (|Union| E "failed"))
          (|a| (|Union| R #1#)))
         (SEQ
          (EXIT
...
(SDEFUN |PR;exquo;2%U;33| ((|p1| (%)) (|p2| (%)) (% (|Union| % #1="failed")))
        (SPROG
         ((|rout| (%)) (#2=#:G343 NIL) (|ee| (|Union| E "failed"))
          (|a| (|Union| R #1#)))
         (SEQ
          (EXIT
           (COND ((NULL |p2|) (|error| "Division by 0"))
...
(DEFUN |PolynomialRing| (&REST #1=#:G361)
  (SPROG NIL
         (PROG (#2=#:G362)
           (RETURN
            (COND
...
(DEFUN |PolynomialRing;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G358 NIL) (#2=#:G359 NIL) (#3=#:G360 NIL) (% NIL)
...
(MAKEPROP '|PolynomialRing| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|FreeModule| 6 7) (|local| |#1|)
              ...
              (248 . |exquo|) (|HashState|) (|SingleInteger|) (|Fraction| 38)
              (|List| 17) (|Mapping| 6 7) (|Union| 78 '#1="failed")
              (|Union| 38 '#1#) (|Mapping| 7 7) (|List| 7) (|List| 6)
           ...
           '#(~= 254 |zero?| 260 |unitNormal| 265 |unitCanonical| 270 |unit?|
              ...
              |charthRoot| 582 |characteristic| 587 |binomThmExpt| 591
              |associator| 598 |associates?| 605 |antiCommutator| 611
              |annihilate?| 617 ^ 623 |Zero| 635 |One| 639 = 643 / 649 - 655 +
              666 * 672)
           'NIL
           (CONS
            (|makeByteWordVec2| 24
             ...
             (CONS
              ...
              (|makeByteWordVec2| 89
                                  '(0 7 0 10 0 6 0 11 0 0 0 12 0 6 13 14 0 0 13
                                    ...
                                    28 61 0 62 1 28 0 0 63 1 28 25 0 1 1 0 84 0
                                    1 2 33 33 0 0 1 2 14 25 0 0 1 0 32 0 1 1 30
                                    33 0 1 2 30 0 0 13 1 2 0 0 0 53 1 1 12 81 0
                                    1 1 13 82 0 1 1 0 27 0 28 1 12 78 0 1 1 13
                                    38 0 1 1 0 6 0 1 1 17 0 0 24 1 30 33 0 36 1
                                    20 0 0 1 4 0 0 0 6 7 0 48 2 25 0 0 53 1 2
                                    32 25 0 0 1 1 30 25 0 1 1 0 13 0 1 1 0 86 0
                                    1 1 0 25 0 1 2 0 0 6 7 1 1 0 7 0 19 2 0 0
                                    83 0 1 2 0 0 87 0 1 1 0 79 0 1 2 6 6 80 0 1
                                    1 30 33 0 1 2 30 0 0 13 1 2 0 0 0 53 1 1 17
                                    17 0 1 1 17 7 0 1 1 17 0 0 23 1 17 6 0 21 1
                                    0 88 0 1 2 15 76 76 0 1 1 15 77 0 1 1 0 25
                                    0 41 1 0 6 0 1 4 10 0 0 7 6 0 68 2 28 33 0
                                    0 75 2 8 33 0 6 73 1 0 7 0 16 1 20 6 0 1 1
                                    17 0 79 1 1 0 0 79 1 2 31 0 0 0 1 1 29 0 38
                                    40 1 26 0 0 1 1 19 0 78 1 1 0 0 6 35 1 0 89
                                    0 1 1 0 85 0 1 2 0 6 0 7 29 1 4 33 0 1 0 31
                                    13 15 3 27 0 0 0 13 57 3 31 0 0 0 0 1 2 28
                                    25 0 0 72 2 0 0 0 0 1 2 31 25 0 0 1 2 30 0
                                    0 13 52 2 0 0 0 53 54 0 32 0 22 0 30 0 12 2
                                    0 25 0 0 71 2 18 0 0 6 59 2 34 0 0 0 1 1 34
                                    0 0 1 2 0 0 0 0 1 2 34 0 38 0 1 2 32 0 13 0
                                    1 2 1 0 78 0 1 2 1 0 0 78 1 2 0 0 0 6 50 2
                                    0 0 6 0 49 2 0 0 0 0 51 2 0 0 53 0 1)))))
           '|lookupComplete|)) 
