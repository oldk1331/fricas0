...
(SDEFUN |FC;getfortarrayexp1|
        ((|name| (|Symbol|)) (|of| (|OutputForm|))
         (|int_to_floats?| (|Boolean|)) (% (|List| (|String|))))
        (SPROG ((#1=#:G491 NIL) (|l| (|List| (|String|))))
               (SEQ
                (LETT |l|
...
(SDEFUN |FC;addCommas| ((|l| (|List| (|Symbol|))) (% (|List| (|String|))))
        (SPROG ((|r| (|List| (|String|))) (#1=#:G507 NIL) (|e| NIL))
               (SEQ
                (COND ((NULL |l|) NIL)
                      ('T
                       (SEQ
...
(SDEFUN |FC;commaSep| ((|l| (|List| (|String|))) (% (|List| (|String|))))
        (SPROG
         ((#1=#:G514 NIL) (#2=#:G513 #3=(|List| (|String|))) (#4=#:G515 #3#)
          (#5=#:G517 NIL) (|u| NIL))
         (SEQ
...
(SDEFUN |FC;getPrint| ((|l| (|List| (|OutputForm|))) (% (|List| (|String|))))
        (SPROG ((|ll| (|List| (|String|))) (#1=#:G530 NIL) (|i| NIL))
...
(SDEFUN |FC;getBlock| ((|rec| (|List| %)) (% (|List| (|String|))))
        (SPROG ((|expr| (|List| (|String|))) (#1=#:G535 NIL) (|u| NIL))
...
(SDEFUN |FC;getElseIf| ((|f| (%)) (% (|List| (|String|))))
        (SPROG
         ((|expr| (|List| (|String|))) (|elseBranch| (%)) (#1=#:G563 NIL)
          (|rec|
...
(SDEFUN |FC;getComment| ((|rec| (|List| (|String|))) (% (|List| (|String|))))
        (SPROG ((#1=#:G636 NIL) (|c| NIL) (#2=#:G635 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |FC;getCode;%L;36| ((|f| (%)) (% (|List| (|String|))))
        (SPROG
         ((#1=#:G674 NIL) (#2=#:G675 NIL) (#3=#:G673 NIL) (#4=#:G672 NIL)
          (#5=#:G671 NIL) (#6=#:G670 NIL) (#7=#:G669 NIL) (#8=#:G668 NIL)
          (#9=#:G667 NIL) (#10=#:G666 NIL) (#11=#:G665 NIL) (#12=#:G664 NIL)
          (|rec|
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 189
                                            '(1 7 6 0 8 2 6 0 0 9 10 2 13 11 6
                                              ...
                                              0 84 1 0 0 107 109 1 0 0 113 115
                                              1 0 0 104 106 1 0 0 110 112 1 0 0
                                              101 103 1 0 0 98 100 0 0 0 97 2 0
                                              0 55 0 95 1 0 0 63 85 1 0 16 0 80
                                              1 0 43 0 44 1 0 25 0 1 1 0 0 35
                                              60 1 0 11 0 42 2 0 0 68 0 91 3 0
                                              0 68 37 0 92 1 0 0 35 93 2 0 0 55
                                              0 117 3 0 0 55 0 0 118 2 0 0 7 81
                                              82 1 0 0 25 88 1 0 0 11 86 1 0 6
                                              0 120 1 0 53 0 54 1 0 0 25 189 1
                                              0 0 9 116 3 0 0 7 65 113 185 3 0
                                              0 7 65 107 183 3 0 0 7 65 110 184
                                              2 0 0 7 177 179 2 0 0 7 180 182 2
                                              0 0 7 171 173 2 0 0 7 174 176 2 0
                                              0 7 165 167 2 0 0 7 168 170 2 0 0
                                              7 110 187 2 0 0 7 113 188 3 0 0 7
                                              65 104 161 2 0 0 7 107 186 3 0 0
                                              7 65 98 159 3 0 0 7 65 101 160 2
                                              ...
                                              123 125 2 0 0 7 126 128 2 0 0 7
                                              101 163 2 0 0 7 104 164 2 0 0 7
                                              25 122 2 0 0 7 98 162 2 0 12 0 0
                                              1)))))
           '|lookupComplete|)) 
