...
(SDEFUN |SIGNRF;psign|
        ...
        (SPROG
         ((|ans| (|Integer|)) (#1=#:G499 NIL)
          (|u| (|Union| (|Integer|) "failed")) (#2=#:G500 NIL) (|term| NIL)
...
(SDEFUN |SIGNRF;listSign|
        ((|l| (|List| (|Polynomial| R))) (|s| (|Integer|))
         (% (|Union| (|Integer|) #1="failed")))
        (SPROG
         ((#2=#:G515 NIL) (#3=#:G516 NIL) (|u| (|Union| (|Integer|) #1#))
          (#4=#:G517 NIL) (|term| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |term| NIL) (LETT #4# |l|) G190
                 ...
                 (SEQ (LETT |u| (|SIGNRF;termSign| |term| %))
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #3# (CONS 1 "failed")) (GO #5=#:G514)))
                        ('T
                         (SEQ
                          (EXIT
                           (COND
...
(SDEFUN |SIGNRF;termSign|
        ...
        (SPROG ((#1=#:G526 NIL) (#2=#:G527 NIL) (#3=#:G528 NIL) (|var| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(DEFUN |RationalFunctionSign| (#1=#:G529)
  (SPROG NIL
         (PROG (#2=#:G530)
           (RETURN
            (COND
