...
(SDEFUN |SMP;numberOfMonomials;%Nni;6| ((|p| (%)) (% (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G129 NIL) (#2=#:G128 #3=(|NonNegativeInteger|)) (#4=#:G130 #3#)
          (#5=#:G132 NIL) (|q| NIL))
         (SEQ
          (COND
           ((QEQCAR |p| 0)
...
(SDEFUN |SMP;multivariate;SupVarSet%;17|
        ((|u| (|SparseUnivariatePolynomial| %)) (|mvar| (|VarSet|)) (% (%)))
        (SPROG
         ((#1=#:G173 NIL) (|uu| (|SparseUnivariatePolynomial| %)) (|cc| (%)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |SMP;triage| ((|p| (%)) (|q| (%)) (% #1=(|SingleInteger|)))
        (SPROG
         ((|qu| (D)) (|pu| (D)) (#2=#:G308 NIL) (|tr1| #1#) (|lcq| (%))
...
(SDEFUN |SMP;gcdPolynomial;3Sup;57|
        ...
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| %)) (#2=#:G399 NIL)
...
(SDEFUN |SMP;gcdPolynomial;3Sup;64|
        ((|a| #1=(|SparseUnivariatePolynomial| %)) (|b| #1#)
         (% (|SparseUnivariatePolynomial| %)))
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| %)) (#2=#:G431 NIL)
          (|monb| (|SparseUnivariatePolynomial| %)) (|contb| (%))
          (|mona| (|SparseUnivariatePolynomial| %)) (|conta| (%)))
         (SEQ
          (COND
...
(SDEFUN |SMP;gcdPolynomial;3Sup;67|
        ((|a| #1=(|SparseUnivariatePolynomial| %)) (|b| #1#)
         (% (|SparseUnivariatePolynomial| %)))
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| %)) (#2=#:G459 NIL)
          (|monb| (|SparseUnivariatePolynomial| %)) (|contb| (%))
          (|mona| (|SparseUnivariatePolynomial| %)) (|conta| (%)))
         (SEQ
          (COND
...
(SDEFUN |SMP;coefficients;%L;69| ((|p| (%)) (% (|List| R)))
        (SPROG
         ((#1=#:G476 NIL) (#2=#:G475 #3=(|List| R)) (#4=#:G477 #3#)
          (#5=#:G479 NIL) (|p1| NIL))
         (SEQ
...
(SDEFUN |SMP;eval;%LL%;78|
        ((|p| (%)) (|Lvar| (|List| |VarSet|)) (|Lpval| (|List| %)) (% (%)))
        (SPROG
         ((|nlpval| (|List| %)) (#1=#:G548 NIL) (|mvar| NIL) (#2=#:G547 NIL)
          (|nlvar| (|List| |VarSet|)))
         (SEQ
          (COND
           ((OR (NULL (CDR |Lvar|))
...
(SDEFUN |SMP;eval;%LL%;79|
        ...
        (SPROG ((#1=#:G553 NIL) (|val| NIL) (#2=#:G552 NIL))
               (SEQ
                (SPADCALL |p| |Lvar|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |SMP;minimumDegree;%LL;85|
        ((|p| (%)) (|Lvar| (|List| |VarSet|))
         (% (|List| (|NonNegativeInteger|))))
        (SPROG ((#1=#:G584 NIL) (|mvar| NIL) (#2=#:G583 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |mvar| NIL) (LETT #1# |Lvar|) G190
...
(SDEFUN |SMP;monomials1|
        ...
        (SPROG
         ((|degs1| #2#) (|vars1| #1#) (|mon| (%))
          ...
          (#5=#:G621 NIL) (|var| NIL) (#6=#:G622 NIL) (|deg| NIL) (|k1| #4#)
          (|p1| (%)) (#7=#:G620 NIL) (|t| NIL) (|v1| (|VarSet|))
          (|tl| (|List| #3#)))
...
(DEFUN |SparseMultivariatePolynomial| (&REST #1=#:G670)
  (SPROG NIL
         (PROG (#2=#:G671)
           (RETURN
            (COND
...
(DEFUN |SparseMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G669 NIL) (|pv$| NIL) (#2=#:G660 NIL) (#3=#:G662 NIL) (#4=#:G661 NIL)
    (#5=#:G663 NIL) (#6=#:G664 NIL) (#7=#:G665 NIL) (#8=#:G666 NIL)
    (#9=#:G667 NIL) (#10=#:G668 NIL) (% NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|SparseMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'D '|VPoly|
              ...
              (695 . |reverse!|) |SMP;monomials;%L;91|
              (|Union| 226 '#1="failed") (|Matrix| %) (|InputForm|)
              (|Pattern| (|Float|)) (|Pattern| 93) (|SingleInteger|)
              (|Record| (|:| |mat| 227) (|:| |vec| (|Vector| 93))) (|Vector| %)
              (|Matrix| 93) (|PatternMatchResult| (|Float|) %)
              (|PatternMatchResult| 93 %) (|Fraction| 93)
              (|Record| (|:| |llcm_res| %) (|:| |coeff1| %) (|:| |coeff2| %))
              (|Factored| %) (|Factored| 55) (|Union| 235 '#1#) (|List| 55)
              (|Union| 230 '#2="failed") (|Union| 93 '#2#)
              (|Record| (|:| |quotient| %) (|:| |remainder| %)) (|Matrix| 6)
              (|Record| (|:| |mat| 239) (|:| |vec| (|Vector| 6)))
              (|Equation| %) (|List| 241)
              (|Record| (|:| |var| 7) (|:| |exponent| 27))
              (|Union| 243 '#3="failed") (|Union| 166 '#3#) (|Mapping| 70 70)
              (|String|))
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 6 (|IndexedExponents| 7) 7)
                 ...
                 (|LeftModule| $$) (|LeftModule| 230) (|RightModule| 230)
                 ...
                 (|RetractableTo| 6) (|SetCategory|) (|RetractableTo| 230)
                 ...
                 (|CoercibleTo| 169) (|unitsKnown|) (|CoercibleFrom| 230)
                 (|CoercibleFrom| 93) (|canonicalUnitNormal|) (|TwoSidedRecip|)
                 (|noZeroDivisors|) (|ConvertibleTo| 222) (|ConvertibleTo| 223)
                 (|ConvertibleTo| 221) (|InnerEvalable| $$ $$)
                 (|CoercibleFrom| 7))
              (|makeByteWordVec2| 247
                                  '(0 6 0 11 0 6 0 13 0 0 0 14 1 6 16 0 17 0 8
                                    ...
                                    2 0 55 0 7 56 1 0 38 0 46 1 48 132 0 134 1
                                    48 0 0 136 1 48 16 0 138 2 0 27 0 181 1 1 0
                                    27 0 1 2 0 27 0 181 1 1 0 84 0 85 2 55 99 0
                                    0 1 1 10 233 55 1 1 14 0 0 1 1 14 232 0 1 2
                                    10 234 235 55 1 2 9 16 0 0 131 0 54 0 1 1
                                    52 99 0 1 2 52 0 0 27 1 2 0 0 0 123 1 1 6
                                    236 0 1 1 7 237 0 1 1 12 184 0 1 1 0 179 0
                                    180 1 6 230 0 1 1 7 93 0 1 1 12 7 0 1 1 0 6
