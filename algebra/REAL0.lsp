...
(SDEFUN |REAL0;makeSqfr| ((F (|Pol|)) (% (|Pol|)))
        (SPROG
         ((#1=#:G467 NIL) (#2=#:G466 (|Pol|)) (#3=#:G468 (|Pol|))
          (#4=#:G471 NIL) (|s| NIL) (|sqfr| (|Factored| |Pol|)))
        ...
        ((F (|Pol|)) (|rn| (|Fraction| (|Integer|)))
         (%
          (|List|
           (|Record| (|:| |left| (|Fraction| (|Integer|)))
                     (|:| |right| (|Fraction| (|Integer|)))))))
        (SPROG ((#1=#:G478 NIL) (|int| NIL) (#2=#:G477 NIL))
        ...
        ((F (|Pol|))
         ...
         (%
          (|List|
           (|Record| (|:| |left| (|Fraction| (|Integer|)))
                     (|:| |right| (|Fraction| (|Integer|)))))))
        (SPROG ((#1=#:G493 NIL) (|int| NIL) (#2=#:G492 NIL))
               (SEQ (LETT F (|REAL0;makeSqfr| F %))
                    (EXIT
                     (PROGN
                      (LETT #2# NIL)
        ...
        (SPROG
         ((L
           (|List|
            (|Record| (|:| |left| (|Fraction| (|Integer|)))
                      (|:| |right| (|Fraction| (|Integer|))))))
          (#1=#:G512 NIL) (|int| NIL) (#2=#:G511 NIL) (|b| (|Integer|)))
        ...
        (SPROG
         ((K
           (|List|
            (|Record| (|:| |left| (|Fraction| (|Integer|)))
                      (|:| |right| (|Fraction| (|Integer|))))))
          (#1=#:G528 NIL) (|int| NIL) (#2=#:G527 NIL)
          (J
           (|List|
            (|Record| (|:| |left| (|Fraction| (|Integer|)))
                      (|:| |right| (|Fraction| (|Integer|))))))
          (#3=#:G526 NIL) (#4=#:G525 NIL) (G (|Pol|))
...
(SDEFUN |REAL0;transAdd1| ((F (|Pol|)) (% (|Pol|)))
        (SPROG
         ((|ans| (|Pol|)) (#1=#:G560 NIL) (|i| NIL) (#2=#:G559 NIL) (|j| NIL)
          (#3=#:G558 NIL) (|v| (|Vector| (|Integer|)))
...
(SDEFUN |REAL0;invert| ((F (|Pol|)) (% (|Pol|)))
        (SPROG ((G (|Pol|)) (#1=#:G569 NIL) (|n| (|NonNegativeInteger|)))
               (SEQ (LETT G (|spadConstant| % 35))
...
(SDEFUN |REAL0;refine;PolRFR;20|
        ...
        (SPROG
         ((|xfl| (|Boolean|)) (|ad| #1=(|Integer|)) (|an| #2=(|Integer|))
          ...
          (|mid| (|Fraction| (|Integer|))) (|u| #3#) (#4=#:G591 NIL))
