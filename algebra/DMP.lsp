...
(DEFUN |DistributedMultivariatePolynomial| (&REST #1=#:G79)
  (SPROG NIL
         (PROG (#2=#:G80)
           (RETURN
            (COND
...
(DEFUN |DistributedMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G78 NIL) (|pv$| NIL) (#2=#:G69 NIL) (#3=#:G71 NIL) (#4=#:G70 NIL)
    (#5=#:G72 NIL) (#6=#:G73 NIL) (#7=#:G74 NIL) (#8=#:G75 NIL) (#9=#:G76 NIL)
    (#10=#:G77 NIL) (% NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
    (LETT DV$1 |#1|)
...
(MAKEPROP '|DistributedMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|Fraction| 18)
              (|DirectProduct| (NRTEVAL (LENGTH (QREFELT % 6))) 24)
           ...
           (CONS
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 7 (|DirectProduct| (LENGTH 6) 24)
                                       (|OrderedVariableList| 6))
                 (|MaybeSkewPolynomialCategory| 7
                                                (|DirectProduct| (LENGTH 6) 24)
                                                (|OrderedVariableList| 6))
                 (|PolynomialFactorizationExplicit|)
                 (|FiniteAbelianMonoidRing| 7 (|DirectProduct| (LENGTH 6) 24))
                 (|UniqueFactorizationDomain|)
                 (|AbelianMonoidRing| 7 (|DirectProduct| (LENGTH 6) 24))
