...
(SDEFUN |SET;subset?;2%B;25| ((|s| (%)) (|t| (%)) (% (|Boolean|)))
        (SPROG
         ((#1=#:G563 NIL) (|j| #2=(|Integer|)) (|i| #2#) (|n| #3=(|Integer|))
          (|m| #3#))
         (SEQ
          (EXIT
           (SEQ (LETT |m| (SPADCALL |s| (QREFELT % 22)))
...
(SDEFUN |SET;insert!;S2%;27| ((|x| (S)) (|s| (%)) (% (%)))
        (SPROG ((#1=#:G584 NIL) (#2=#:G585 NIL) (#3=#:G586 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |s| |k| (QREFELT % 23)) |x|
                                       (QREFELT % 60))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# |s|) (GO #4=#:G583)))
                              (GO #5=#:G581))))))
...
(SDEFUN |SET;remove!;S2%;28| ((|x| (S)) (|s| (%)) (% (%)))
        (SPROG ((|k| (|Integer|)) (#1=#:G592 NIL) (|n| (|Integer|)))
               (SEQ
                (EXIT
                 (SEQ (LETT |n| (+ (SPADCALL |s| (QREFELT % 22)) 1))
                      (LETT |k| (SPADCALL |s| (QREFELT % 51)))
...
(DEFUN |Set;| (|#1|)
  (SPROG ((#1=#:G598 NIL) (|pv$| NIL) (% NIL) (|dv$| NIL) (DV$1 NIL))
         (PROGN
...
(MAKEPROP '|Set| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) '|Rep|
              ...
              (|List| 74) (|Equation| 6) (|Mapping| 19 6 6) (|SingleInteger|)
              (|HashState|) (|PositiveInteger|) (|OutputForm|) (|String|))
           ...
           'NIL
           (CONS
            (|makeByteWordVec2| 6 '(0 0 0 0 0 0 3 0 2 0 0 6 3 0 0 0 0 0 0 6 1))
            (CONS
             ...
             (CONS
              '#((|FiniteSetAggregate| 6) (|Dictionary| 6)
                 ...
                 (|SetCategory|) (|Evalable| 6) (|Hashable|) (|Type|)
                 (|finiteAggregate|) (|PartialOrder|) (|BasicType|)
                 (|CoercibleTo| 79) (|shallowlyMutable|) (|InnerEvalable| 6 6)
                 (|ConvertibleTo| 42))
              (|makeByteWordVec2| 80
                                  '(1 7 8 0 9 0 7 0 13 1 7 0 0 14 1 7 16 0 17 1
                                    ...
                                    0 33 1 3 78 0 1 2 0 19 0 8 1 1 0 80 0 1 2 0
                                    0 0 0 67 1 0 6 0 24 2 0 0 6 0 62 1 3 0 78 1
                                    2 3 77 77 0 1 1 3 76 0 1 2 0 27 28 0 30 1 0
                                    ...
                                    0 16 58 1 3 0 0 1 1 0 79 0 1 1 0 8 0 1 2 9
